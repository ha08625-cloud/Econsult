...
logger.warning("DIST CONTENTS: %s", os.listdir(_FRONTEND_DIST))
...
if os.path.isdir(_FRONTEND_DIST):
    ...
    logger.info("Frontend dist not found - static file serving disabled (local dev mode)")    validate_finish_payload,
)
from app.core.errors import APIError, INVALID_PAYLOAD, UNKNOWN_RUNTIME_ID, VERSION_CONFLICT, SESSION_CLOSED
from app.services.engine_adapters import (
    init_runtime_state,
