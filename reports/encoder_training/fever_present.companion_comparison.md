...
*Generated 2026-08-19T20:32:15+00:00.*
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune@Arm0_control` | finetune | 7015 | **418** | 94.0% [91.6%, 96.1%] | 93.5% [90.9%, 95.9%] | 95.6% | 95.6% +/- 1.9% |
| `arm_b_finetune@ArmC_remargined` | finetune | 7015 | **418** | 94.3% [92.0%, 96.3%] | 93.8% [91.3%, 96.1%] | 95.9% | 95.9% +/- 1.5% |
| `arm_b_finetune@ArmP_companions` | finetune | 7015 | **418** | 93.7% [91.5%, 95.8%] | 93.4% [90.9%, 95.5%] | 95.4% | 95.4% +/- 2.5% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune@Arm0_control` | -- | 88.1% [78.3%, 95.5%] (eff n 43) | 93.4% [86.4%, 98.7%] (eff n 63) | 97.6% [92.9%, 100.0%] (eff n 36) | 99.7% [99.1%, 100.0%] (eff n 47) | 99.5% [98.9%, 100.0%] (eff n 35) |
| `arm_b_finetune@ArmC_remargined` | -- | 90.5% [81.9%, 96.8%] (eff n 43) | 94.2% [87.9%, 99.1%] (eff n 63) | 97.6% [92.9%, 100.0%] (eff n 36) | 99.7% [99.1%, 100.0%] (eff n 47) | 99.5% [98.9%, 100.0%] (eff n 35) |
| `arm_b_finetune@ArmP_companions` | -- | 92.3% [85.9%, 97.5%] (eff n 43) | 92.9% [85.8%, 98.3%] (eff n 63) | 97.6% [92.8%, 100.0%] (eff n 36) | 99.5% [98.9%, 100.0%] (eff n 47) | 99.6% [99.1%, 100.0%] (eff n 35) |
...
`arm_b_finetune@Arm0_control` ahead on 0 folds, `arm_b_finetune@ArmC_remargined` on 4. `null -> true` mean: 84.1% against 77.6% -- **+6.5 points** in favour of `arm_b_finetune@ArmC_remargined`.
...
`arm_b_finetune@Arm0_control` ahead on 0 folds, `arm_b_finetune@ArmP_companions` on 5. `null -> true` mean: 84.1% against 4.5% -- **+79.6 points** in favour of `arm_b_finetune@ArmP_companions`.
...
`arm_b_finetune@ArmC_remargined` ahead on 0 folds, `arm_b_finetune@ArmP_companions` on 5. `null -> true` mean: 77.6% against 4.5% -- **+73.1 points** in favour of `arm_b_finetune@ArmP_companions`.
...
|---|---|---|---|---|
| `arm_b_finetune@Arm0_control` | finetune | 3000 | **224** | 95.4% [92.7%, 97.7%] |
| `arm_b_finetune@ArmC_remargined` | finetune | 3000 | **224** | 96.1% [93.7%, 98.1%] |
| `arm_b_finetune@ArmP_companions` | finetune | 3000 | **224** | 96.1% [93.7%, 98.1%] |
...
* `arm_b_finetune@Arm0_control`: 422 errors across 48 of 463 decisive fragments. Half of them fall on **10** fragments (an even spread would be 24.0); the worst ten carry 50.7% of all errors.
* `arm_b_finetune@ArmC_remargined`: 402 errors across 49 of 463 decisive fragments. Half of them fall on **10** fragments (an even spread would be 24.5); the worst ten carry 53.2% of all errors.
* `arm_b_finetune@ArmP_companions`: 440 errors across 55 of 463 decisive fragments. Half of them fall on **11** fragments (an even spread would be 27.5); the worst ten carry 48.6% of all errors.
...
|---|---|---|---|---|---|
| `fever_null_attribution` | 575 | 88.1% | 90.5% | 92.3% | 4.3pp |
| `fever_true` | 1620 | 89.5% | 89.3% | 89.6% | 0.4pp |
| `fever_null_hedged` | 803 | 93.4% | 94.2% | 92.9% | 1.3pp |
| `fever_false` | 2395 | 95.2% | 95.4% | 93.5% | 1.8pp |
| `fever_null_historical` | 460 | 97.6% | 97.6% | 97.6% | 0.0pp |
| `(none)` | 2985 | 99.5% | 99.6% | 99.3% | 0.3pp |
| `fever_null_thirdparty` | 561 | 99.5% | 99.5% | 99.6% | 0.2pp |
| `fever_null_metaphor` | 601 | 99.7% | 99.7% | 99.5% | 0.2pp |
...
|---|---|---|---|---|---|---|
| `fever_false:3a3043ff` | `fever_false` | false | 29 | 29 | 29 | 0 |
| `fever_false:3de7ecac` | `fever_false` | false | 0 | 0 | 29 | 29 |
| `fever_true:f3ee0d07` | `fever_true` | true | 28 | 28 | 1 | 27 |
| `fever_false:5c2a065d` | `fever_false` | false | 24 | 24 | 24 | 0 |
| `fever_true:0e369d96` | `fever_true` | true | 24 | 24 | 5 | 19 |
| `fever_true:97087dd7` | `fever_true` | true | 24 | 24 | 23 | 1 |
| `fever_false:990bcf31` | `fever_false` | false | 0 | 0 | 20 | 20 |
| `fever_true:0ddb8a11` | `fever_true` | true | 18 | 18 | 19 | 1 |
| `fever_true:391fb2ce` | `fever_true` | true | 0 | 0 | 19 | 19 |
| `fever_false:e8c514ff` | `fever_false` | false | 17 | 17 | 17 | 0 |
| `fever_null_attribution:14ca1148` | `fever_null_attribution` | null | 17 | 17 | 0 | 17 |
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | null | 16 | 12 | 17 | 5 |
| `fever_true:7844c66b` | `fever_true` | true | 17 | 17 | 17 | 0 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | null | 16 | 13 | 0 | 16 |
| `fever_true:ef344ff7` | `fever_true` | true | 16 | 16 | 16 | 0 |
| `fever_false:b9076eff` | `fever_false` | false | 14 | 14 | 4 | 10 |
| `fever_false:e70e24b6` | `fever_false` | false | 14 | 11 | 10 | 4 |
| `fever_false:cdf2609b` | `fever_false` | false | 0 | 0 | 13 | 13 |
| `fever_null_attribution:dba8c443` | `fever_null_attribution` | null | 1 | 1 | 13 | 12 |
| `fever_true:5ce7adbd` | `fever_true` | true | 13 | 13 | 0 | 13 |
| `fever_true:5e4f1da7` | `fever_true` | true | 13 | 13 | 13 | 0 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | null | 11 | 11 | 11 | 0 |
| `fever_false:5935e477` | `fever_false` | false | 10 | 10 | 0 | 10 |
| `fever_null_historical:feadcb2c` | `fever_null_historical` | null | 10 | 10 | 10 | 0 |
| `fever_true:5441ccb2` | `fever_true` | true | 0 | 0 | 10 | 10 |
| `fever_true:c5d3e4a0` | `fever_true` | true | 0 | 0 | 10 | 10 |
| `fever_false:44cd09fd` | `fever_false` | false | 0 | 0 | 9 | 9 |
| `fever_null_attribution:41d25c3a` | `fever_null_attribution` | null | 9 | 8 | 0 | 9 |
| `fever_null_hedged:081a5883` | `fever_null_hedged` | null | 9 | 9 | 9 | 0 |
| `fever_true:ed36ef0f` | `fever_true` | true | 0 | 0 | 9 | 9 |
| `fever_null_attribution:6229b129` | `fever_null_attribution` | null | 8 | 1 | 0 | 8 |
| `fever_null_attribution:ff259a4b` | `fever_null_attribution` | null | 0 | 0 | 8 | 8 |
| `fever_null_attribution:b03cf8b0` | `fever_null_attribution` | null | 0 | 0 | 7 | 7 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | null | 7 | 7 | 7 | 0 |
| `fever_false:afdc7129` | `fever_false` | false | 6 | 6 | 0 | 6 |
| `fever_null_attribution:1f21724c` | `fever_null_attribution` | null | 2 | 2 | 5 | 3 |
| `fever_null_attribution:7830c8db` | `fever_null_attribution` | null | 4 | 3 | 5 | 2 |
| `fever_null_hedged:fafa0b56` | `fever_null_hedged` | null | 5 | 4 | 0 | 5 |
| `fever_true:781b30e3` | `fever_true` | true | 5 | 5 | 0 | 5 |
| `fever_true:872e3af9` | `fever_true` | true | 0 | 0 | 5 | 5 |

*38 further fragments erred on at least one model; the JSON holds them all.*
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.4, 0.85, 0.9.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2277 | 67 | 51 | 2395 |
| **truth true** | 15 | 1465 | 140 | 1620 |
| **truth null** | 50 | 108 | 5827 | 5985 |
| **total** | 2342 | 1640 | 6018 | 10000 |

`null -> true`: 108 of 5985 truly-null examples (1.80%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2281 | 57 | 57 | 2395 |
| **truth true** | 15 | 1450 | 155 | 1620 |
| **truth null** | 50 | 102 | 5833 | 5985 |
| **total** | 2346 | 1609 | 6045 | 10000 |

`null -> true`: 102 of 5985 truly-null examples (1.70%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2395 | 2346 | 97.2% | 95.2% | 96.2% |
| `true` | 1620 | 1609 | 90.1% | 89.5% | 89.8% |
| `null` | 5985 | 6045 | 96.5% | 97.5% | 97.0% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2395 | **98** | 95.2% [91.0%, 98.7%] |
| null_ambiguous | 3000 | **224** | 95.4% [92.7%, 97.7%] |
| null_structural | 2985 | **1** | 99.5% [99.5%, 99.5%] |
| true | 1620 | **96** | 89.5% [82.7%, 95.5%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 578 | **43** | 88.1% [78.3%, 95.5%] |
| hedged | 797 | **63** | 93.4% [86.4%, 98.7%] |
| historical | 463 | **36** | 97.6% [92.9%, 100.0%] |
| metaphor | 600 | **47** | 99.7% [99.1%, 100.0%] |
| third_party | 562 | **35** | 99.5% [98.9%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2395 | **98** | 95.2% [91.0%, 98.7%] |
| fever_null_attribution | 578 | **43** | 88.1% [78.3%, 95.5%] |
| fever_null_hedged | 797 | **63** | 93.4% [86.4%, 98.7%] |
| fever_null_historical | 463 | **36** | 97.6% [92.9%, 100.0%] |
| fever_null_metaphor | 600 | **47** | 99.7% [99.1%, 100.0%] |
| fever_null_thirdparty | 562 | **35** | 99.5% [98.9%, 100.0%] |
| fever_true | 1620 | **96** | 89.5% [82.7%, 95.5%] |
...
48 of 463 decisive fragments were got wrong at least once.

`arm_b_finetune@Arm0_control`: 422 errors across 48 of 463 decisive fragments. Half of them fall on **10** fragments (an even spread would be 24.0); the worst ten carry 50.7% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:3a3043ff` | `fever_false` | -- | false | 0/29 | 0.0% | true 29 |
| `fever_true:f3ee0d07` | `fever_true` | -- | true | 0/28 | 0.0% | null 28 |
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/24 | 0.0% | null 24 |
| `fever_true:0e369d96` | `fever_true` | -- | true | 0/24 | 0.0% | null 24 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 0/24 | 0.0% | null 24 |
| `fever_true:0ddb8a11` | `fever_true` | -- | true | 0/18 | 0.0% | null 18 |
| `fever_false:e8c514ff` | `fever_false` | -- | false | 0/17 | 0.0% | true 4, null 13 |
| `fever_null_attribution:14ca1148` | `fever_null_attribution` | attribution | null | 0/17 | 0.0% | true 17 |
| `fever_true:7844c66b` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 0/16 | 0.0% | true 16 |
| `fever_true:5ce7adbd` | `fever_true` | -- | true | 0/13 | 0.0% | false 13 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 0/11 | 0.0% | false 11 |
| `fever_null_historical:feadcb2c` | `fever_null_historical` | historical | null | 0/10 | 0.0% | true 10 |
| `fever_null_attribution:41d25c3a` | `fever_null_attribution` | attribution | null | 0/9 | 0.0% | true 9 |
| `fever_null_hedged:081a5883` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | false 9 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 0/7 | 0.0% | false 7 |
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | hedged | null | 1/17 | 5.9% | true 16, null 1 |
| `fever_true:ef344ff7` | `fever_true` | -- | true | 1/17 | 5.9% | true 1, null 16 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 1/14 | 7.1% | true 1, null 13 |
| `fever_false:e70e24b6` | `fever_false` | -- | false | 2/16 | 12.5% | false 2, true 14 |
| `fever_null_attribution:6229b129` | `fever_null_attribution` | attribution | null | 2/10 | 20.0% | true 8, null 2 |
| `fever_false:5935e477` | `fever_false` | -- | false | 8/18 | 44.4% | false 8, true 10 |
| `fever_null_hedged:fafa0b56` | `fever_null_hedged` | hedged | null | 4/9 | 44.4% | true 5, null 4 |
| `fever_false:b9076eff` | `fever_false` | -- | false | 17/31 | 54.8% | false 17, null 14 |
| `fever_null_attribution:7830c8db` | `fever_null_attribution` | attribution | null | 5/9 | 55.6% | true 4, null 5 |
| `fever_null_attribution:91db2240` | `fever_null_attribution` | attribution | null | 6/10 | 60.0% | true 4, null 6 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 6/10 | 60.0% | true 6, null 4 |
| `fever_true:781b30e3` | `fever_true` | -- | true | 10/15 | 66.7% | true 10, null 5 |
| `fever_null_attribution:689da703` | `fever_null_attribution` | attribution | null | 8/12 | 66.7% | false 4, null 8 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 6/9 | 66.7% | false 2, true 6, null 1 |
| `fever_true:511ef08b` | `fever_true` | -- | true | 10/14 | 71.4% | true 10, null 4 |
| `fever_false:afdc7129` | `fever_false` | -- | false | 16/22 | 72.7% | false 16, null 6 |
| `fever_null_attribution:3540f0cb` | `fever_null_attribution` | attribution | null | 8/10 | 80.0% | true 2, null 8 |
| `fever_null_hedged:cf95d564` | `fever_null_hedged` | hedged | null | 8/10 | 80.0% | true 2, null 8 |
| `fever_null_attribution:1f21724c` | `fever_null_attribution` | attribution | null | 14/16 | 87.5% | true 2, null 14 |
| `fever_null_hedged:0de4380d` | `fever_null_hedged` | hedged | null | 8/9 | 88.9% | true 1, null 8 |
| `fever_null_metaphor:15ab0c24` | `fever_null_metaphor` | metaphor | null | 9/10 | 90.0% | false 1, null 9 |
| `fever_null_hedged:9cd32605` | `fever_null_hedged` | hedged | null | 10/11 | 90.9% | false 1, null 10 |
| `fever_null_historical:805a05cb` | `fever_null_historical` | historical | null | 10/11 | 90.9% | false 1, null 10 |
| `fever_null_thirdparty:0fbaa4f5` | `fever_null_thirdparty` | third_party | null | 11/12 | 91.7% | true 1, null 11 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2284 | 52 | 59 | 2395 |
| **truth true** | 18 | 1446 | 156 | 1620 |
| **truth null** | 50 | 78 | 5857 | 5985 |
| **total** | 2352 | 1576 | 6072 | 10000 |

`null -> true`: 78 of 5985 truly-null examples (1.30%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2395 | 2352 | 97.1% | 95.4% | 96.2% |
| `true` | 1620 | 1576 | 91.8% | 89.3% | 90.5% |
| `null` | 5985 | 6072 | 96.5% | 97.9% | 97.2% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2395 | **98** | 95.4% [91.2%, 98.8%] |
| null_ambiguous | 3000 | **224** | 96.1% [93.7%, 98.1%] |
| null_structural | 2985 | **1** | 99.6% [99.6%, 99.6%] |
| true | 1620 | **96** | 89.3% [82.3%, 95.3%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 578 | **43** | 90.5% [81.9%, 96.8%] |
| hedged | 797 | **63** | 94.2% [87.9%, 99.1%] |
| historical | 463 | **36** | 97.6% [92.9%, 100.0%] |
| metaphor | 600 | **47** | 99.7% [99.1%, 100.0%] |
| third_party | 562 | **35** | 99.5% [98.9%, 100.0%] |
...
| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2395 | **98** | 95.4% [91.2%, 98.8%] |
| fever_null_attribution | 578 | **43** | 90.5% [81.9%, 96.8%] |
| fever_null_hedged | 797 | **63** | 94.2% [87.9%, 99.1%] |
| fever_null_historical | 463 | **36** | 97.6% [92.9%, 100.0%] |
| fever_null_metaphor | 600 | **47** | 99.7% [99.1%, 100.0%] |
| fever_null_thirdparty | 562 | **35** | 99.5% [98.9%, 100.0%] |
| fever_true | 1620 | **96** | 89.3% [82.3%, 95.3%] |
...
49 of 463 decisive fragments were got wrong at least once.
...
| `fever_true:97087dd7` | `fever_true` | -- | true | 0/24 | 0.0% | null 24 |
| `fever_true:0ddb8a11` | `fever_true` | -- | true | 0/18 | 0.0% | null 18 |
| `fever_false:e8c514ff` | `fever_false` | -- | false | 0/17 | 0.0% | true 2, null 15 |
| `fever_null_attribution:14ca1148` | `fever_null_attribution` | attribution | null | 0/17 | 0.0% | true 17 |
| `fever_true:7844c66b` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_true:5ce7adbd` | `fever_true` | -- | true | 0/13 | 0.0% | false 13 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 0/11 | 0.0% | false 11 |
...
| `fever_true:ef344ff7` | `fever_true` | -- | true | 1/17 | 5.9% | true 1, null 16 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 1/14 | 7.1% | true 1, null 13 |
| `fever_null_attribution:41d25c3a` | `fever_null_attribution` | attribution | null | 1/9 | 11.1% | true 8, null 1 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 3/16 | 18.8% | true 13, null 3 |
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | hedged | null | 5/17 | 29.4% | true 12, null 5 |
| `fever_false:e70e24b6` | `fever_false` | -- | false | 5/16 | 31.2% | false 5, true 11 |
| `fever_false:5935e477` | `fever_false` | -- | false | 8/18 | 44.4% | false 8, true 10 |
| `fever_false:b9076eff` | `fever_false` | -- | false | 17/31 | 54.8% | false 17, null 14 |
| `fever_null_hedged:fafa0b56` | `fever_null_hedged` | hedged | null | 5/9 | 55.6% | true 4, null 5 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 6/10 | 60.0% | true 6, null 4 |
| `fever_true:781b30e3` | `fever_true` | -- | true | 10/15 | 66.7% | true 10, null 5 |
| `fever_null_attribution:689da703` | `fever_null_attribution` | attribution | null | 8/12 | 66.7% | false 4, null 8 |
| `fever_null_attribution:7830c8db` | `fever_null_attribution` | attribution | null | 6/9 | 66.7% | true 3, null 6 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 6/9 | 66.7% | false 2, true 6, null 1 |
| `fever_null_attribution:91db2240` | `fever_null_attribution` | attribution | null | 7/10 | 70.0% | true 3, null 7 |
| `fever_true:511ef08b` | `fever_true` | -- | true | 10/14 | 71.4% | true 10, null 4 |
| `fever_false:afdc7129` | `fever_false` | -- | false | 16/22 | 72.7% | false 16, null 6 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 9/12 | 75.0% | false 3, true 9 |
| `fever_null_attribution:1f21724c` | `fever_null_attribution` | attribution | null | 14/16 | 87.5% | true 2, null 14 |
| `fever_null_hedged:0de4380d` | `fever_null_hedged` | hedged | null | 8/9 | 88.9% | true 1, null 8 |
| `fever_null_attribution:3540f0cb` | `fever_null_attribution` | attribution | null | 9/10 | 90.0% | true 1, null 9 |
| `fever_null_attribution:6229b129` | `fever_null_attribution` | attribution | null | 9/10 | 90.0% | true 1, null 9 |
| `fever_null_metaphor:15ab0c24` | `fever_null_metaphor` | metaphor | null | 9/10 | 90.0% | false 1, null 9 |
| `fever_true:f32f1ddb` | `fever_true` | -- | true | 9/10 | 90.0% | true 9, null 1 |
| `fever_null_hedged:9cd32605` | `fever_null_hedged` | hedged | null | 10/11 | 90.9% | false 1, null 10 |
| `fever_null_historical:805a05cb` | `fever_null_historical` | historical | null | 10/11 | 90.9% | false 1, null 10 |

*9 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*

## `arm_b_finetune@ArmP_companions`

`roberta-base` with **every layer unfrozen**, mean-pooled, with the same `Linear(768, 3)` head -- 110M trainable parameters against Arm A's 2,307. Three epochs at batch 32, learning rate 2e-5, 10% linear warmup, AdamW, fp32. No gradient checkpointing, no 8-bit optimiser, no LoRA, no gradient accumulation: the full model fits in 12GB with room to spare, so anything that reads like a compute compromise would be a mistake rather than a saving. This is the arm that separates "the fragment libraries are the bottleneck" from "the method is too weak": if a fully fine-tuned encoder still cannot read third-party attribution, tense or metaphor, the limit is in the ideas the libraries contain and the fix is library work, not model work. **Joint multi-head training**: 6 heads sharing one encoder (dysuria_present, fever_present, flank_pain_present, haematuria_present, nocturia_present, urinary_frequency_present). Epoch selection uses DD6's unweighted mean of every head's own validation macro-F1, so this signal's stopping point may differ from a single-signal run's own best epoch. Each head's margin is chosen independently on its own validation split -- no cross-head trade.

Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.15, 0.8, 0.85.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2233 | 67 | 95 | 2395 |
| **truth true** | 12 | 1469 | 139 | 1620 |
| **truth null** | 48 | 115 | 5822 | 5985 |
| **total** | 2293 | 1651 | 6056 | 10000 |

`null -> true`: 115 of 5985 truly-null examples (1.92%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2240 | 55 | 100 | 2395 |
| **truth true** | 13 | 1452 | 155 | 1620 |
| **truth null** | 50 | 87 | 5848 | 5985 |
| **total** | 2303 | 1594 | 6103 | 10000 |

`null -> true`: 87 of 5985 truly-null examples (1.45%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2395 | 2303 | 97.3% | 93.5% | 95.4% |
| `true` | 1620 | 1594 | 91.1% | 89.6% | 90.4% |
| `null` | 5985 | 6103 | 95.8% | 97.7% | 96.8% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2395 | **98** | 93.5% [88.4%, 97.7%] |
| null_ambiguous | 3000 | **224** | 96.1% [93.7%, 98.1%] |
| null_structural | 2985 | **1** | 99.3% [99.3%, 99.3%] |
| true | 1620 | **96** | 89.6% [83.9%, 94.8%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 575 | **43** | 92.3% [85.9%, 97.5%] |
| hedged | 803 | **63** | 92.9% [85.8%, 98.3%] |
| historical | 460 | **36** | 97.6% [92.8%, 100.0%] |
| metaphor | 601 | **47** | 99.5% [98.9%, 100.0%] |
| third_party | 561 | **35** | 99.6% [99.1%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2395 | **98** | 93.5% [88.4%, 97.7%] |
| fever_null_attribution | 575 | **43** | 92.3% [85.9%, 97.5%] |
| fever_null_hedged | 803 | **63** | 92.9% [85.8%, 98.3%] |
| fever_null_historical | 460 | **36** | 97.6% [92.8%, 100.0%] |
| fever_null_metaphor | 601 | **47** | 99.5% [98.9%, 100.0%] |
| fever_null_thirdparty | 561 | **35** | 99.6% [99.1%, 100.0%] |
| fever_true | 1620 | **96** | 89.6% [83.9%, 94.8%] |
| (none) | 2985 | **1** | 99.3% [99.3%, 99.3%] |
...
55 of 463 decisive fragments were got wrong at least once.

`arm_b_finetune@ArmP_companions`: 440 errors across 55 of 463 decisive fragments. Half of them fall on **11** fragments (an even spread would be 27.5); the worst ten carry 48.6% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:3a3043ff` | `fever_false` | -- | false | 0/29 | 0.0% | true 22, null 7 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 0/29 | 0.0% | null 29 |
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/24 | 0.0% | true 20, null 4 |
| `fever_false:990bcf31` | `fever_false` | -- | false | 0/20 | 0.0% | null 20 |
| `fever_true:0ddb8a11` | `fever_true` | -- | true | 0/19 | 0.0% | null 19 |
| `fever_false:e8c514ff` | `fever_false` | -- | false | 0/17 | 0.0% | true 1, null 16 |
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | hedged | null | 0/17 | 0.0% | true 17 |
| `fever_true:7844c66b` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 0/13 | 0.0% | null 13 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 0/11 | 0.0% | false 11 |
| `fever_null_historical:feadcb2c` | `fever_null_historical` | historical | null | 0/10 | 0.0% | true 10 |
| `fever_true:c5d3e4a0` | `fever_true` | -- | true | 0/10 | 0.0% | false 10 |
| `fever_null_hedged:081a5883` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | false 9 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 0/7 | 0.0% | false 7 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 1/24 | 4.2% | true 1, null 23 |
| `fever_true:ef344ff7` | `fever_true` | -- | true | 1/17 | 5.9% | false 1, true 1, null 15 |
| `fever_null_attribution:dba8c443` | `fever_null_attribution` | attribution | null | 1/14 | 7.1% | false 13, null 1 |
| `fever_true:391fb2ce` | `fever_true` | -- | true | 4/23 | 17.4% | true 4, null 19 |
| `fever_true:ed36ef0f` | `fever_true` | -- | true | 2/11 | 18.2% | true 2, null 9 |
| `fever_true:5441ccb2` | `fever_true` | -- | true | 3/13 | 23.1% | true 3, null 10 |
| `fever_null_attribution:ff259a4b` | `fever_null_attribution` | attribution | null | 4/12 | 33.3% | true 8, null 4 |
| `fever_false:e70e24b6` | `fever_false` | -- | false | 7/17 | 41.2% | false 7, true 10 |
| `fever_null_attribution:eb9e8ecd` | `fever_null_attribution` | attribution | null | 3/7 | 42.9% | true 4, null 3 |
| `fever_null_hedged:17a3f60a` | `fever_null_hedged` | hedged | null | 3/7 | 42.9% | false 2, true 2, null 3 |
| `fever_null_attribution:7830c8db` | `fever_null_attribution` | attribution | null | 4/9 | 44.4% | true 5, null 4 |
| `fever_null_attribution:b03cf8b0` | `fever_null_attribution` | attribution | null | 7/14 | 50.0% | false 1, true 6, null 7 |
| `fever_false:cdf2609b` | `fever_false` | -- | false | 14/27 | 51.9% | false 14, true 2, null 11 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 6/11 | 54.5% | true 6, null 5 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 5/9 | 55.6% | true 5, null 4 |
| `fever_false:44cd09fd` | `fever_false` | -- | false | 17/26 | 65.4% | false 17, null 9 |
| `fever_null_hedged:60bffa1a` | `fever_null_hedged` | hedged | null | 4/6 | 66.7% | true 2, null 4 |
| `fever_null_attribution:1f21724c` | `fever_null_attribution` | attribution | null | 11/16 | 68.8% | true 5, null 11 |
| `fever_true:872e3af9` | `fever_true` | -- | true | 11/16 | 68.8% | true 11, null 5 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 7/10 | 70.0% | true 7, null 3 |
| `fever_null_hedged:89a2ef71` | `fever_null_hedged` | hedged | null | 11/14 | 78.6% | false 1, true 2, null 11 |
| `fever_true:0e369d96` | `fever_true` | -- | true | 20/25 | 80.0% | true 20, null 5 |
| `fever_true:dd7a11e2` | `fever_true` | -- | true | 14/17 | 82.4% | true 14, null 3 |
| `fever_false:b9076eff` | `fever_false` | -- | false | 27/31 | 87.1% | false 27, null 4 |
| `fever_null_attribution:c32d59d3` | `fever_null_attribution` | attribution | null | 14/16 | 87.5% | true 2, null 14 |
| `fever_null_hedged:0de4380d` | `fever_null_hedged` | hedged | null | 8/9 | 88.9% | true 1, null 8 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 44680 | 2000 | 2000 | 0.9 | 98.2% | 97.5% | 96.2% | 0.00% |
| 1 | 44680 | 2000 | 2000 | 0.85 | 96.6% | 96.6% | 95.9% | 0.00% |
| 2 | 44680 | 2000 | 2000 | 0.0 | 92.7% | 92.7% | 90.1% | 4.18% |
| 3 | 44680 | 2000 | 2000 | 0.85 | 96.0% | 96.3% | 95.4% | 1.34% |
| 4 | 44680 | 2000 | 2000 | 0.4 | 95.1% | 95.2% | 94.3% | 3.01% |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 44680 | 2000 | 2000 | 0.9 | 98.2% | 97.5% | 96.2% | 0.00% |
| 1 | 44680 | 2000 | 2000 | 0.9 | 96.6% | 96.6% | 95.9% | 0.00% |
| 2 | 44680 | 2000 | 2000 | 0.9 | 92.7% | 93.5% | 91.0% | 2.67% |
| 3 | 44680 | 2000 | 2000 | 0.9 | 96.0% | 96.4% | 95.6% | 1.25% |
| 4 | 44680 | 2000 | 2000 | 0.9 | 95.1% | 95.5% | 94.6% | 2.59% |

### `arm_b_finetune@ArmP_companions`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 54410 | 2000 | 2000 | 0.15 | 97.2% | 97.1% | 96.8% | 0.67% |
| 1 | 54415 | 2000 | 2000 | 0.0 | 94.2% | 94.2% | 91.9% | 0.25% |
| 2 | 54410 | 2000 | 2000 | 0.8 | 92.1% | 92.3% | 90.0% | 1.75% |
| 3 | 54410 | 2000 | 2000 | 0.85 | 94.5% | 94.7% | 93.4% | 3.09% |
| 4 | 54405 | 2000 | 2000 | 0.85 | 98.2% | 98.7% | 98.4% | 1.50% |
