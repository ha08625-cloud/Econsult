...
*Generated 2026-09-02T15:53:21+00:00.*
...
| selected epochs | `c0.0-d0.0 2, 1, 1, 3, 3, c0.0-d0.3 2, 2, 2, 1, 3, c0.5-d0.0 2, 1, 2, 1, 3, c0.5-d0.3 1, 1, 3, 3, 3` |
| arm | `arm_b_finetune` |
...
* **c0.0-d0.0** (`data/synthetic/generated/decl/c0.0-d0.0`): 10000 examples per epoch, **10000** labelled positions for `dysuria_present`
* **c0.0-d0.3** (`data/synthetic/generated/decl/c0.0-d0.3`): 10000 examples per epoch, **10000** labelled positions for `dysuria_present`
...
| `length_only` | baseline | 7022 | **182** | 46.8% [39.9%, 54.1%] | 26.6% [23.5%, 29.6%] | 62.0% | 62.0% +/- 0.8% |
| `tfidf_logreg` | baseline | 7022 | **182** | 70.4% [64.8%, 75.8%] | 63.3% [57.8%, 68.3%] | 79.2% | 79.2% +/- 2.0% |
| `length_only__shuffled` | negative control | 7022 | **182** | 43.6% [36.5%, 51.4%] | 20.2% [17.8%, 22.6%] | 60.4% | 60.4% +/- 0.2% |
| `tfidf_logreg__shuffled` | negative control | 7022 | **182** | 43.6% [36.4%, 51.4%] | 20.3% [17.8%, 22.7%] | 60.4% | 60.4% +/- 0.3% |
| `arm_b_finetune@c0.0-d0.0` | finetune | 7022 | **182** | 95.4% [92.8%, 97.6%] | 94.9% [92.0%, 97.2%] | 96.8% | 96.8% +/- 1.6% |
| `arm_b_finetune@c0.0-d0.3` | finetune | 7022 | **342** | 96.0% [93.8%, 98.1%] | 95.6% [93.1%, 97.8%] | 97.2% | 97.2% +/- 1.1% |
...
| `length_only` | -- | -- | 100.0% [100.0%, 100.0%] (eff n 20) | 98.1% [94.5%, 100.0%] (eff n 19) | 99.3% [98.6%, 99.9%] (eff n 28) | 99.3% [98.6%, 99.9%] (eff n 23) |
| `tfidf_logreg` | -- | -- | 83.9% [74.7%, 93.3%] (eff n 20) | 99.2% [98.0%, 100.0%] (eff n 19) | 98.9% [97.8%, 99.9%] (eff n 28) | 95.4% [89.7%, 99.7%] (eff n 23) |
...
| `tfidf_logreg__shuffled` | -- | -- | 100.0% [100.0%, 100.0%] (eff n 20) | 99.8% [99.5%, 100.0%] (eff n 19) | 99.7% [99.2%, 100.0%] (eff n 28) | 100.0% [100.0%, 100.0%] (eff n 23) |
| `arm_b_finetune@c0.0-d0.0` | -- | -- | 86.8% [76.4%, 95.6%] (eff n 20) | 99.8% [99.5%, 100.0%] (eff n 19) | 93.5% [82.8%, 100.0%] (eff n 28) | 96.4% [89.4%, 100.0%] (eff n 23) |
| `arm_b_finetune@c0.0-d0.3` | -- | -- | 89.7% [80.1%, 97.4%] (eff n 20) | 97.8% [94.6%, 100.0%] (eff n 19) | 94.3% [83.8%, 100.0%] (eff n 28) | 94.6% [84.6%, 99.9%] (eff n 23) |
...
|---|---|---|---|---|---|
| `dysuria_present` | 11 | 52.7% | 54.5% | 3.6% | 12.7% |

### `arm_b_finetune@c0.0-d0.0`

Recombination test slice: **n 7022**, **eff n 182** clusters, accuracy 95.4% [92.8%, 97.6%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.0, 0.9, 0.8, 0.8, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `dysuria_present` | 56/0/11 | 0 | 56 | 78.6% +/- 12.0% | +/-13.1% | 67 | 71.0% +/- 8.5% | 32.7% +/- 12.2% |
...
`null -> true` on real text, per fold: `dysuria_present` 8, 9, 2, 5, 5 of 11. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.

### `arm_b_finetune@c0.0-d0.3`

Recombination test slice: **n 7022**, **eff n 342** clusters, accuracy 96.0% [93.8%, 98.1%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.9, 0.9, 0.85, 0.05. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `dysuria_present` | 56/0/11 | 0 | 56 | 93.9% +/- 2.0% | +/-13.1% | 67 | 85.1% +/- 1.5% | 40.0% +/- 8.1% |

* `dysuria_present`: no `false` examples in this set, so its number is very nearly a recall-only measurement: nothing here tests whether an explicit denial is read correctly, which was the largest error family in the synthetic evaluation.

`null -> true` on real text, per fold: `dysuria_present` 8, 6, 5, 4, 7 of 11. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
`arm_b_finetune@c0.0-d0.0` ahead on 0 folds, `arm_b_finetune@c0.0-d0.3` on 5. `null -> true` mean: 52.7% against 54.5% -- **1.8 points higher** for `arm_b_finetune@c0.0-d0.3` -- more invented symptoms.
...
`arm_b_finetune@c0.0-d0.0` ahead on 0 folds, `arm_b_finetune@c0.5-d0.0` on 5. `null -> true` mean: 52.7% against 3.6% -- **49.1 points lower** for `arm_b_finetune@c0.5-d0.0` -- fewer invented symptoms.
...
`arm_b_finetune@c0.0-d0.0` ahead on 0 folds, `arm_b_finetune@c0.5-d0.3` on 5. `null -> true` mean: 52.7% against 12.7% -- **40.0 points lower** for `arm_b_finetune@c0.5-d0.3` -- fewer invented symptoms.
...
`arm_b_finetune@c0.0-d0.3` ahead on 3 folds, `arm_b_finetune@c0.5-d0.0` on 1. `null -> true` mean: 54.5% against 3.6% -- **50.9 points lower** for `arm_b_finetune@c0.5-d0.0` -- fewer invented symptoms.
...
`arm_b_finetune@c0.0-d0.3` ahead on 1 folds, `arm_b_finetune@c0.5-d0.3` on 4. `null -> true` mean: 54.5% against 12.7% -- **41.8 points lower** for `arm_b_finetune@c0.5-d0.3` -- fewer invented symptoms.
...
| `length_only` | baseline | 3062 | **90** | 99.2% [98.4%, 99.8%] |
| `tfidf_logreg` | baseline | 3062 | **90** | 94.1% [90.7%, 97.0%] |
| `arm_b_finetune@c0.0-d0.0` | finetune | 3062 | **90** | 94.0% [89.7%, 97.5%] |
| `arm_b_finetune@c0.0-d0.3` | finetune | 3062 | **90** | 94.0% [89.2%, 97.6%] |
...
|---|---|---|---|---|
| `majority_class` vs `length_only` | 3062 | 23 | 0 | 2.38e-07 |
| `majority_class` vs `tfidf_logreg` | 3062 | 181 | 0 | 6.53e-55 |
| `majority_class` vs `arm_b_finetune@c0.0-d0.0` | 3062 | 195 | 0 | 3.98e-59 |
| `length_only` vs `tfidf_logreg` | 3062 | 181 | 23 | 1.25e-31 |
| `length_only` vs `arm_b_finetune@c0.0-d0.0` | 3062 | 195 | 23 | 3.8e-35 |
| `tfidf_logreg` vs `arm_b_finetune@c0.0-d0.0` | 3062 | 121 | 107 | 0.389 |
...
* `length_only`: 3739 errors across 103 of 256 decisive fragments. Half of them fall on **36** fragments (an even spread would be 51.5); the worst ten carry 16.0% of all errors.
* `tfidf_logreg`: 2079 errors across 106 of 256 decisive fragments. Half of them fall on **27** fragments (an even spread would be 53.0); the worst ten carry 23.7% of all errors.
* `arm_b_finetune@c0.0-d0.0`: 322 errors across 26 of 256 decisive fragments. Half of them fall on **6** fragments (an even spread would be 13.0); the worst ten carry 69.3% of all errors.
* `arm_b_finetune@c0.0-d0.3`: 280 errors across 24 of 643 decisive fragments. Half of them fall on **5** fragments (an even spread would be 12.0); the worst ten carry 77.1% of all errors.
...
|---|---|---|
| `length_only__shuffled` | 60.4% [38.1%, 77.2%] | 25.1% [18.4%, 29.0%] |
...
|---|---|---|---|---|---|
| `majority_class` vs `length_only` | overall | 10000 | 84 | 244 | 3.09e-19 |
| `majority_class` vs `length_only` | null_ambiguous | 3062 | 23 | 0 | 2.38e-07 |
| `majority_class` vs `tfidf_logreg` | overall | 10000 | 184 | 2070 | 0 |
| `majority_class` vs `tfidf_logreg` | null_ambiguous | 3062 | 181 | 0 | 6.53e-55 |
| `majority_class` vs `arm_b_finetune@c0.0-d0.0` | overall | 10000 | 195 | 3835 | 0 |
| `majority_class` vs `arm_b_finetune@c0.0-d0.0` | null_ambiguous | 3062 | 195 | 0 | 3.98e-59 |
| `length_only` vs `tfidf_logreg` | overall | 10000 | 221 | 1947 | 0 |
| `length_only` vs `tfidf_logreg` | null_ambiguous | 3062 | 181 | 23 | 1.25e-31 |
| `length_only` vs `arm_b_finetune@c0.0-d0.0` | overall | 10000 | 199 | 3679 | 0 |
| `length_only` vs `arm_b_finetune@c0.0-d0.0` | null_ambiguous | 3062 | 195 | 23 | 3.8e-35 |
| `tfidf_logreg` vs `arm_b_finetune@c0.0-d0.0` | overall | 10000 | 127 | 1881 | 0 |
| `tfidf_logreg` vs `arm_b_finetune@c0.0-d0.0` | null_ambiguous | 3062 | 121 | 107 | 0.389 |
...
|---|---|---|---|---|---|---|---|---|---|
| `dysuria_false` | 1724 | 0.0% | 9.8% | 67.8% | 98.4% | 98.1% | 91.6% | 92.5% | 98.4pp |
| `dysuria_true` | 1025 | 0.0% | 0.0% | 25.7% | 93.5% | 93.9% | 93.6% | 88.1% | 93.9pp |
| `dysuria_null_hedged` | 789 | 100.0% | 100.0% | 83.9% | 86.8% | 89.7% | 86.8% | 89.0% | 16.1pp |
| `dysuria_null_thirdparty` | 865 | 100.0% | 99.3% | 95.4% | 96.4% | 94.6% | 95.6% | 93.2% | 6.8pp |
| `dysuria_null_metaphor` | 757 | 100.0% | 99.3% | 98.9% | 93.5% | 94.3% | 99.7% | 99.5% | 6.5pp |
| `dysuria_null_historical` | 651 | 100.0% | 98.1% | 99.2% | 99.8% | 97.8% | 99.1% | 98.2% | 2.2pp |
| `(none)` | 2978 | 100.0% | 98.0% | 99.9% | 100.0% | 100.0% | 99.8% | 99.9% | 2.0pp |
...
|---|---|---|---|---|---|---|---|---|---|---|
| `dysuria_false:85e13aca` | `dysuria_false` | false | 73 | 58 | 0 | 0 | 0 | 0 | 0 | 73 |
| `dysuria_false:2508af9f` | `dysuria_false` | false | 68 | 58 | 4 | 0 | 0 | 0 | 0 | 68 |
| `dysuria_false:41c43f99` | `dysuria_false` | false | 68 | 66 | 23 | 0 | 0 | 0 | 0 | 68 |
| `dysuria_false:5837e4e6` | `dysuria_false` | false | 66 | 51 | 45 | 0 | 0 | 0 | 0 | 66 |
| `dysuria_false:82438593` | `dysuria_false` | false | 65 | 58 | 21 | 0 | 0 | 0 | 2 | 65 |
| `dysuria_false:1fa9bf6a` | `dysuria_false` | false | 64 | 57 | 14 | 0 | 0 | 0 | 10 | 64 |
| `dysuria_false:90277b2d` | `dysuria_false` | false | 64 | 61 | 0 | 0 | 0 | 0 | 0 | 64 |
| `dysuria_false:202255a3` | `dysuria_false` | false | 62 | 60 | 62 | 0 | 0 | 0 | 0 | 62 |
| `dysuria_false:52998403` | `dysuria_false` | false | 62 | 62 | 0 | 0 | 0 | 0 | 0 | 62 |
| `dysuria_false:e75c2521` | `dysuria_false` | false | 62 | 55 | 26 | 0 | 0 | 0 | 0 | 62 |
| `dysuria_false:62636499` | `dysuria_false` | false | 60 | 59 | 6 | 0 | 0 | 0 | 0 | 60 |
| `dysuria_false:47348026` | `dysuria_false` | false | 59 | 53 | 21 | 0 | 0 | 21 | 18 | 59 |
| `dysuria_false:915a7bf7` | `dysuria_false` | false | 59 | 51 | 15 | 0 | 0 | 0 | 0 | 59 |
| `dysuria_false:78c1ede4` | `dysuria_false` | false | 58 | 58 | 1 | 0 | 0 | 0 | 0 | 58 |
| `dysuria_false:d46403bb` | `dysuria_false` | false | 58 | 56 | 0 | 0 | 0 | 0 | 0 | 58 |
| `dysuria_false:4299d111` | `dysuria_false` | false | 57 | 57 | 1 | 0 | 0 | 0 | 0 | 57 |
| `dysuria_false:9b29601b` | `dysuria_false` | false | 57 | 57 | 33 | 0 | 0 | 0 | 0 | 57 |
| `dysuria_false:f3a29d90` | `dysuria_false` | false | 57 | 55 | 10 | 0 | 0 | 0 | 0 | 57 |
| `dysuria_false:18791ae3` | `dysuria_false` | false | 56 | 56 | 0 | 0 | 0 | 0 | 0 | 56 |
| `dysuria_false:43aa9d18` | `dysuria_false` | false | 56 | 53 | 28 | 0 | 0 | 48 | 15 | 56 |
| `dysuria_false:70ff0f9d` | `dysuria_false` | false | 56 | 56 | 0 | 0 | 0 | 0 | 0 | 56 |
| `dysuria_false:9a3ed060` | `dysuria_false` | false | 55 | 52 | 55 | 0 | 0 | 12 | 0 | 55 |
| `dysuria_false:1548b49b` | `dysuria_false` | false | 54 | 40 | 54 | 0 | 0 | 0 | 0 | 54 |
| `dysuria_false:502574f5` | `dysuria_false` | false | 53 | 47 | 2 | 0 | 0 | 1 | 0 | 53 |
| `dysuria_false:90df50ee` | `dysuria_false` | false | 53 | 44 | 1 | 0 | 0 | 0 | 0 | 53 |
| `dysuria_false:1c30e825` | `dysuria_false` | false | 52 | 48 | 20 | 0 | 0 | 0 | 0 | 52 |
| `dysuria_false:7fcddee5` | `dysuria_false` | false | 52 | 52 | 22 | 0 | 0 | 0 | 0 | 52 |
| `dysuria_false:d3769665` | `dysuria_false` | false | 52 | 50 | 52 | 0 | 0 | 0 | 0 | 52 |
| `dysuria_false:ab9389ac` | `dysuria_false` | false | 50 | 39 | 1 | 0 | 0 | 0 | 0 | 50 |
| `dysuria_false:b2d71275` | `dysuria_false` | false | 50 | 50 | 50 | 0 | 0 | 0 | 0 | 50 |
| `dysuria_true:93845aa6` | `dysuria_true` | true | 49 | 49 | 49 | 1 | 0 | 0 | 0 | 49 |
| `dysuria_false:1c5be177` | `dysuria_false` | false | 48 | 35 | 0 | 0 | 0 | 0 | 0 | 48 |
| `dysuria_false:3ce959c2` | `dysuria_false` | false | 47 | 43 | 28 | 0 | 0 | 32 | 13 | 47 |
| `dysuria_false:dad80d87` | `dysuria_false` | false | 46 | 43 | 1 | 0 | 0 | 0 | 0 | 46 |
| `dysuria_false:e122d65e` | `dysuria_false` | false | 44 | 39 | 28 | 0 | 1 | 45 | 39 | 45 |
| `dysuria_false:64f15eeb` | `dysuria_false` | false | 44 | 44 | 44 | 0 | 0 | 0 | 0 | 44 |
| `dysuria_false:79a25459` | `dysuria_false` | false | 44 | 43 | 8 | 0 | 0 | 0 | 0 | 44 |
| `dysuria_false:ca382087` | `dysuria_false` | false | 44 | 44 | 2 | 0 | 0 | 0 | 0 | 44 |
| `dysuria_true:8ee469c9` | `dysuria_true` | true | 44 | 44 | 15 | 0 | 0 | 0 | 0 | 44 |
| `dysuria_false:b58ab061` | `dysuria_false` | false | 43 | 31 | 8 | 0 | 0 | 0 | 0 | 43 |

*103 further fragments erred on at least one model; the JSON holds them all.*
...
| historical | 647 | **19** | 100.0% [100.0%, 100.0%] |
| metaphor | 759 | **28** | 100.0% [100.0%, 100.0%] |
| third_party | 867 | **23** | 100.0% [100.0%, 100.0%] |
...
| dysuria_null_historical | 647 | **19** | 100.0% [100.0%, 100.0%] |
| dysuria_null_metaphor | 759 | **28** | 100.0% [100.0%, 100.0%] |
| dysuria_null_thirdparty | 867 | **23** | 100.0% [100.0%, 100.0%] |
...
|---|---|---|---|---|---|---|
| `dysuria_false:85e13aca` | `dysuria_false` | -- | false | 0/73 | 0.0% | null 73 |
| `dysuria_false:2508af9f` | `dysuria_false` | -- | false | 0/68 | 0.0% | null 68 |
| `dysuria_false:41c43f99` | `dysuria_false` | -- | false | 0/68 | 0.0% | null 68 |
| `dysuria_false:5837e4e6` | `dysuria_false` | -- | false | 0/66 | 0.0% | null 66 |
| `dysuria_false:82438593` | `dysuria_false` | -- | false | 0/65 | 0.0% | null 65 |
| `dysuria_false:1fa9bf6a` | `dysuria_false` | -- | false | 0/64 | 0.0% | null 64 |
| `dysuria_false:90277b2d` | `dysuria_false` | -- | false | 0/64 | 0.0% | null 64 |
| `dysuria_false:202255a3` | `dysuria_false` | -- | false | 0/62 | 0.0% | null 62 |
| `dysuria_false:52998403` | `dysuria_false` | -- | false | 0/62 | 0.0% | null 62 |
| `dysuria_false:e75c2521` | `dysuria_false` | -- | false | 0/62 | 0.0% | null 62 |
| `dysuria_false:62636499` | `dysuria_false` | -- | false | 0/60 | 0.0% | null 60 |
| `dysuria_false:47348026` | `dysuria_false` | -- | false | 0/59 | 0.0% | null 59 |
| `dysuria_false:915a7bf7` | `dysuria_false` | -- | false | 0/59 | 0.0% | null 59 |
| `dysuria_false:78c1ede4` | `dysuria_false` | -- | false | 0/58 | 0.0% | null 58 |
| `dysuria_false:d46403bb` | `dysuria_false` | -- | false | 0/58 | 0.0% | null 58 |
| `dysuria_false:4299d111` | `dysuria_false` | -- | false | 0/57 | 0.0% | null 57 |
| `dysuria_false:9b29601b` | `dysuria_false` | -- | false | 0/57 | 0.0% | null 57 |
| `dysuria_false:f3a29d90` | `dysuria_false` | -- | false | 0/57 | 0.0% | null 57 |
| `dysuria_false:18791ae3` | `dysuria_false` | -- | false | 0/56 | 0.0% | null 56 |
| `dysuria_false:43aa9d18` | `dysuria_false` | -- | false | 0/56 | 0.0% | null 56 |
| `dysuria_false:70ff0f9d` | `dysuria_false` | -- | false | 0/56 | 0.0% | null 56 |
| `dysuria_false:9a3ed060` | `dysuria_false` | -- | false | 0/55 | 0.0% | null 55 |
| `dysuria_false:1548b49b` | `dysuria_false` | -- | false | 0/54 | 0.0% | null 54 |
| `dysuria_false:502574f5` | `dysuria_false` | -- | false | 0/53 | 0.0% | null 53 |
| `dysuria_false:90df50ee` | `dysuria_false` | -- | false | 0/53 | 0.0% | null 53 |
| `dysuria_false:1c30e825` | `dysuria_false` | -- | false | 0/52 | 0.0% | null 52 |
| `dysuria_false:7fcddee5` | `dysuria_false` | -- | false | 0/52 | 0.0% | null 52 |
| `dysuria_false:d3769665` | `dysuria_false` | -- | false | 0/52 | 0.0% | null 52 |
...
| `dysuria_false:3ce959c2` | `dysuria_false` | -- | false | 0/47 | 0.0% | null 47 |
| `dysuria_false:dad80d87` | `dysuria_false` | -- | false | 0/46 | 0.0% | null 46 |
| `dysuria_false:64f15eeb` | `dysuria_false` | -- | false | 0/44 | 0.0% | null 44 |
| `dysuria_false:79a25459` | `dysuria_false` | -- | false | 0/44 | 0.0% | null 44 |
| `dysuria_false:ca382087` | `dysuria_false` | -- | false | 0/44 | 0.0% | null 44 |
| `dysuria_false:e122d65e` | `dysuria_false` | -- | false | 0/44 | 0.0% | null 44 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 244 | 0 | 2235 | 2479 |
| **truth true** | 80 | 0 | 1401 | 1481 |
| **truth null** | 84 | 0 | 5956 | 6040 |
| **total** | 408 | 0 | 9592 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 408 | 59.8% | 9.8% | 16.9% |
| `true` | 1481 | 0 | -- | 0.0% | 0.0% |
| `null` | 6040 | 9592 | 62.1% | 98.6% | 76.2% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **47** | 9.8% [7.1%, 13.0%] |
| null_ambiguous | 3062 | **90** | 99.2% [98.4%, 99.8%] |
| null_structural | 2978 | **1** | 98.0% [98.0%, 98.0%] |
| true | 1481 | **45** | 0.0% [0.0%, 0.0%] |
...
|---|---|---|---|
| hedged | 789 | **20** | 100.0% [100.0%, 100.0%] |
| historical | 647 | **19** | 98.1% [94.5%, 100.0%] |
| metaphor | 759 | **28** | 99.3% [98.6%, 99.9%] |
| third_party | 867 | **23** | 99.3% [98.6%, 99.9%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| dysuria_false | 2479 | **47** | 9.8% [7.1%, 13.0%] |
| dysuria_null_hedged | 789 | **20** | 100.0% [100.0%, 100.0%] |
| dysuria_null_historical | 647 | **19** | 98.1% [94.5%, 100.0%] |
| dysuria_null_metaphor | 759 | **28** | 99.3% [98.6%, 99.9%] |
| dysuria_null_thirdparty | 867 | **23** | 99.3% [98.6%, 99.9%] |
| dysuria_true | 1481 | **45** | 0.0% [0.0%, 0.0%] |
| (none) | 2978 | **1** | 98.0% [98.0%, 98.0%] |
...
| `dysuria_true:81b6882e` | `dysuria_true` | -- | true | 0/43 | 0.0% | null 43 |
| `dysuria_true:f02ba872` | `dysuria_true` | -- | true | 0/42 | 0.0% | null 42 |
| `dysuria_false:5f0bc325` | `dysuria_false` | -- | false | 0/41 | 0.0% | null 41 |
| `dysuria_true:28c7bf7e` | `dysuria_true` | -- | true | 0/41 | 0.0% | null 41 |
| `dysuria_true:4c214872` | `dysuria_true` | -- | true | 0/41 | 0.0% | null 41 |
| `dysuria_false:756e426c` | `dysuria_false` | -- | false | 0/38 | 0.0% | null 38 |
| `dysuria_true:8f0ade4e` | `dysuria_true` | -- | true | 0/38 | 0.0% | null 38 |
| `dysuria_true:a2448219` | `dysuria_true` | -- | true | 0/38 | 0.0% | null 38 |
| `dysuria_true:f5df5754` | `dysuria_true` | -- | true | 0/38 | 0.0% | null 38 |
| `dysuria_true:5fefaac6` | `dysuria_true` | -- | true | 0/37 | 0.0% | false 3, null 34 |
| `dysuria_true:9c2b1e02` | `dysuria_true` | -- | true | 0/37 | 0.0% | false 4, null 33 |
| `dysuria_true:d39be0eb` | `dysuria_true` | -- | true | 0/35 | 0.0% | null 35 |
| `dysuria_true:0d7321c0` | `dysuria_true` | -- | true | 0/34 | 0.0% | false 10, null 24 |
| `dysuria_true:146d5e49` | `dysuria_true` | -- | true | 0/34 | 0.0% | false 11, null 23 |
| `dysuria_true:73d25d0c` | `dysuria_true` | -- | true | 0/34 | 0.0% | false 8, null 26 |
| `dysuria_true:7c711665` | `dysuria_true` | -- | true | 0/34 | 0.0% | null 34 |
| `dysuria_true:933cf995` | `dysuria_true` | -- | true | 0/34 | 0.0% | null 34 |
| `dysuria_true:985d61a2` | `dysuria_true` | -- | true | 0/34 | 0.0% | null 34 |
| `dysuria_true:abed15dd` | `dysuria_true` | -- | true | 0/34 | 0.0% | null 34 |
| `dysuria_true:b898c2de` | `dysuria_true` | -- | true | 0/34 | 0.0% | false 3, null 31 |
| `dysuria_true:3888fc9f` | `dysuria_true` | -- | true | 0/33 | 0.0% | null 33 |
| `dysuria_true:71544e46` | `dysuria_true` | -- | true | 0/33 | 0.0% | false 11, null 22 |
| `dysuria_true:02037108` | `dysuria_true` | -- | true | 0/32 | 0.0% | null 32 |
| `dysuria_true:83eb7cdc` | `dysuria_true` | -- | true | 0/32 | 0.0% | null 32 |
| `dysuria_true:aadce996` | `dysuria_true` | -- | true | 0/32 | 0.0% | null 32 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1677 | 100 | 702 | 2479 |
| **truth true** | 96 | 393 | 992 | 1481 |
| **truth null** | 63 | 121 | 5856 | 6040 |
| **total** | 1836 | 614 | 7550 | 10000 |

`null -> true`: 121 of 6040 truly-null examples (2.00%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1681 | 93 | 705 | 2479 |
| **truth true** | 97 | 380 | 1004 | 1481 |
| **truth null** | 63 | 120 | 5857 | 6040 |
| **total** | 1841 | 593 | 7566 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 1841 | 91.3% | 67.8% | 77.8% |
| `true` | 1481 | 593 | 64.1% | 25.7% | 36.6% |
| `null` | 6040 | 7566 | 77.4% | 97.0% | 86.1% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **47** | 67.8% [57.8%, 76.8%] |
| null_ambiguous | 3062 | **90** | 94.1% [90.7%, 97.0%] |
| null_structural | 2978 | **1** | 99.9% [99.9%, 99.9%] |
| true | 1481 | **45** | 25.7% [17.4%, 34.8%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| hedged | 789 | **20** | 83.9% [74.7%, 93.3%] |
| historical | 647 | **19** | 99.2% [98.0%, 100.0%] |
| metaphor | 759 | **28** | 98.9% [97.8%, 99.9%] |
| third_party | 867 | **23** | 95.4% [89.7%, 99.7%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| dysuria_false | 2479 | **47** | 67.8% [57.8%, 76.8%] |
| dysuria_null_hedged | 789 | **20** | 83.9% [74.7%, 93.3%] |
| dysuria_null_historical | 647 | **19** | 99.2% [98.0%, 100.0%] |
| dysuria_null_metaphor | 759 | **28** | 98.9% [97.8%, 99.9%] |
| dysuria_null_thirdparty | 867 | **23** | 95.4% [89.7%, 99.7%] |
| dysuria_true | 1481 | **45** | 25.7% [17.4%, 34.8%] |
...
106 of 256 decisive fragments were got wrong at least once.

`tfidf_logreg`: 2079 errors across 106 of 256 decisive fragments. Half of them fall on **27** fragments (an even spread would be 53.0); the worst ten carry 23.7% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `dysuria_false:202255a3` | `dysuria_false` | -- | false | 0/62 | 0.0% | true 1, null 61 |
| `dysuria_false:9a3ed060` | `dysuria_false` | -- | false | 0/55 | 0.0% | null 55 |
| `dysuria_false:1548b49b` | `dysuria_false` | -- | false | 0/54 | 0.0% | true 46, null 8 |
| `dysuria_false:d3769665` | `dysuria_false` | -- | false | 0/52 | 0.0% | true 31, null 21 |
| `dysuria_false:b2d71275` | `dysuria_false` | -- | false | 0/50 | 0.0% | true 4, null 46 |
| `dysuria_true:93845aa6` | `dysuria_true` | -- | true | 0/49 | 0.0% | null 49 |
| `dysuria_false:64f15eeb` | `dysuria_false` | -- | false | 0/44 | 0.0% | null 44 |
| `dysuria_true:28c7bf7e` | `dysuria_true` | -- | true | 0/41 | 0.0% | false 12, null 29 |
| `dysuria_false:ffc68e8d` | `dysuria_false` | -- | false | 0/40 | 0.0% | null 40 |
| `dysuria_true:a2448219` | `dysuria_true` | -- | true | 0/38 | 0.0% | null 38 |
...
| `dysuria_true:83eb7cdc` | `dysuria_true` | -- | true | 0/32 | 0.0% | null 32 |
| `dysuria_true:c3f7adf1` | `dysuria_true` | -- | true | 0/32 | 0.0% | null 32 |
| `dysuria_true:09689dd1` | `dysuria_true` | -- | true | 0/30 | 0.0% | false 5, null 25 |
| `dysuria_true:36a17090` | `dysuria_true` | -- | true | 0/27 | 0.0% | false 1, null 26 |
| `dysuria_true:2e98f278` | `dysuria_true` | -- | true | 0/24 | 0.0% | null 24 |
| `dysuria_true:bc3a15bf` | `dysuria_true` | -- | true | 0/24 | 0.0% | false 2, null 22 |
| `dysuria_null_thirdparty:4e732310` | `dysuria_null_thirdparty` | third_party | null | 0/16 | 0.0% | false 12, true 4 |
| `dysuria_null_thirdparty:2db889fa` | `dysuria_null_thirdparty` | third_party | null | 0/14 | 0.0% | true 14 |
| `dysuria_true:f5df5754` | `dysuria_true` | -- | true | 1/38 | 2.6% | false 1, true 1, null 36 |
| `dysuria_true:5fefaac6` | `dysuria_true` | -- | true | 1/37 | 2.7% | true 1, null 36 |
| `dysuria_true:71544e46` | `dysuria_true` | -- | true | 1/33 | 3.0% | true 1, null 32 |
| `dysuria_true:37c0a85e` | `dysuria_true` | -- | true | 1/29 | 3.4% | false 1, true 1, null 27 |
| `dysuria_true:6cadf930` | `dysuria_true` | -- | true | 1/28 | 3.6% | false 1, true 1, null 26 |
| `dysuria_null_hedged:249a7342` | `dysuria_null_hedged` | hedged | null | 1/27 | 3.7% | true 26, null 1 |
| `dysuria_true:63f5b24c` | `dysuria_true` | -- | true | 1/24 | 4.2% | true 1, null 23 |
| `dysuria_true:0d7321c0` | `dysuria_true` | -- | true | 2/34 | 5.9% | true 2, null 32 |
| `dysuria_true:985d61a2` | `dysuria_true` | -- | true | 2/34 | 5.9% | true 2, null 32 |
| `dysuria_null_hedged:b1ae1f9d` | `dysuria_null_hedged` | hedged | null | 2/32 | 6.2% | true 30, null 2 |
| `dysuria_true:f02ba872` | `dysuria_true` | -- | true | 3/42 | 7.1% | false 8, true 3, null 31 |
| `dysuria_true:c17c33dd` | `dysuria_true` | -- | true | 2/26 | 7.7% | false 1, true 2, null 23 |
| `dysuria_null_thirdparty:ddfe9a7b` | `dysuria_null_thirdparty` | third_party | null | 1/8 | 12.5% | false 1, true 6, null 1 |
| `dysuria_null_hedged:471c638b` | `dysuria_null_hedged` | hedged | null | 2/15 | 13.3% | true 13, null 2 |
| `dysuria_true:81b6882e` | `dysuria_true` | -- | true | 8/43 | 18.6% | false 27, true 8, null 8 |
| `dysuria_true:aadce996` | `dysuria_true` | -- | true | 6/32 | 18.8% | false 1, true 6, null 25 |
| `dysuria_true:89e28e2d` | `dysuria_true` | -- | true | 5/26 | 19.2% | true 5, null 21 |
| `dysuria_true:02037108` | `dysuria_true` | -- | true | 7/32 | 21.9% | false 1, true 7, null 24 |

*66 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
| null_ambiguous | 3062 | **90** | 99.9% [99.7%, 100.0%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **45** | 0.0% [0.0%, 0.0%] |
...
|---|---|---|---|
| hedged | 789 | **20** | 100.0% [100.0%, 100.0%] |
| historical | 647 | **19** | 99.8% [99.5%, 100.0%] |
| metaphor | 759 | **28** | 99.7% [99.2%, 100.0%] |
| third_party | 867 | **23** | 100.0% [100.0%, 100.0%] |
...
| dysuria_null_hedged | 789 | **20** | 100.0% [100.0%, 100.0%] |
| dysuria_null_historical | 647 | **19** | 99.8% [99.5%, 100.0%] |
| dysuria_null_metaphor | 759 | **28** | 99.7% [99.2%, 100.0%] |
| dysuria_null_thirdparty | 867 | **23** | 100.0% [100.0%, 100.0%] |
| dysuria_true | 1481 | **45** | 0.0% [0.0%, 0.0%] |
| (none) | 2978 | **1** | 100.0% [100.0%, 100.0%] |
...
`tfidf_logreg__shuffled`: 3962 errors across 94 of 256 decisive fragments. Half of them fall on **35** fragments (an even spread would be 47.0); the worst ten carry 16.5% of all errors.
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.8, 0.9.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2439 | 0 | 40 | 2479 |
| **truth true** | 12 | 1396 | 73 | 1481 |
| **truth null** | 17 | 178 | 5845 | 6040 |
| **total** | 2468 | 1574 | 5958 | 10000 |

`null -> true`: 178 of 6040 truly-null examples (2.95%).
...
|---|---|---|---|---|
| **truth false** | 2439 | 0 | 40 | 2479 |
| **truth true** | 12 | 1384 | 85 | 1481 |
| **truth null** | 18 | 167 | 5855 | 6040 |
| **total** | 2469 | 1551 | 5980 | 10000 |

`null -> true`: 167 of 6040 truly-null examples (2.76%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2469 | 98.8% | 98.4% | 98.6% |
| `true` | 1481 | 1551 | 89.2% | 93.5% | 91.3% |
| `null` | 6040 | 5980 | 97.9% | 96.9% | 97.4% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **47** | 98.4% [95.0%, 100.0%] |
| null_ambiguous | 3062 | **90** | 94.0% [89.7%, 97.5%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **45** | 93.5% [87.8%, 97.7%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| hedged | 789 | **20** | 86.8% [76.4%, 95.6%] |
| historical | 647 | **19** | 99.8% [99.5%, 100.0%] |
| metaphor | 759 | **28** | 93.5% [82.8%, 100.0%] |
| third_party | 867 | **23** | 96.4% [89.4%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| dysuria_false | 2479 | **47** | 98.4% [95.0%, 100.0%] |
| dysuria_null_hedged | 789 | **20** | 86.8% [76.4%, 95.6%] |
| dysuria_null_historical | 647 | **19** | 99.8% [99.5%, 100.0%] |
| dysuria_null_metaphor | 759 | **28** | 93.5% [82.8%, 100.0%] |
| dysuria_null_thirdparty | 867 | **23** | 96.4% [89.4%, 100.0%] |
| dysuria_true | 1481 | **45** | 93.5% [87.8%, 97.7%] |
| (none) | 2978 | **1** | 100.0% [100.0%, 100.0%] |
...
|---|---|---|---|---|---|---|
| `dysuria_false:ffc68e8d` | `dysuria_false` | -- | false | 0/40 | 0.0% | null 40 |
| `dysuria_null_metaphor:83929c02` | `dysuria_null_metaphor` | metaphor | null | 0/37 | 0.0% | true 37 |
| `dysuria_null_hedged:b1ae1f9d` | `dysuria_null_hedged` | hedged | null | 0/32 | 0.0% | true 32 |
| `dysuria_null_hedged:5bf05464` | `dysuria_null_hedged` | hedged | null | 0/15 | 0.0% | false 9, true 6 |
| `dysuria_null_thirdparty:2fd8fdb5` | `dysuria_null_thirdparty` | third_party | null | 1/14 | 7.1% | true 13, null 1 |
| `dysuria_null_hedged:ec574b54` | `dysuria_null_hedged` | hedged | null | 1/11 | 9.1% | true 10, null 1 |
| `dysuria_true:0d7321c0` | `dysuria_true` | -- | true | 5/34 | 14.7% | true 5, null 29 |
| `dysuria_null_thirdparty:575791a4` | `dysuria_null_thirdparty` | third_party | null | 10/25 | 40.0% | true 15, null 10 |
| `dysuria_true:a28e78a6` | `dysuria_true` | -- | true | 13/29 | 44.8% | true 13, null 16 |
| `dysuria_null_hedged:bea219da` | `dysuria_null_hedged` | hedged | null | 11/23 | 47.8% | true 12, null 11 |
| `dysuria_null_hedged:249a7342` | `dysuria_null_hedged` | hedged | null | 13/27 | 48.1% | true 14, null 13 |
| `dysuria_true:bc3a15bf` | `dysuria_true` | -- | true | 12/24 | 50.0% | false 12, true 12 |
| `dysuria_null_metaphor:91b6dbda` | `dysuria_null_metaphor` | metaphor | null | 13/25 | 52.0% | true 12, null 13 |
| `dysuria_null_hedged:89b32ba7` | `dysuria_null_hedged` | hedged | null | 10/19 | 52.6% | false 9, null 10 |
| `dysuria_null_thirdparty:ddfe9a7b` | `dysuria_null_thirdparty` | third_party | null | 5/8 | 62.5% | true 3, null 5 |
| `dysuria_null_hedged:464ee4f6` | `dysuria_null_hedged` | hedged | null | 19/29 | 65.5% | true 10, null 19 |
| `dysuria_true:146d5e49` | `dysuria_true` | -- | true | 23/34 | 67.6% | true 23, null 11 |
| `dysuria_true:985d61a2` | `dysuria_true` | -- | true | 25/34 | 73.5% | true 25, null 9 |
| `dysuria_true:63f5b24c` | `dysuria_true` | -- | true | 19/24 | 79.2% | true 19, null 5 |
| `dysuria_true:b898c2de` | `dysuria_true` | -- | true | 27/34 | 79.4% | true 27, null 7 |
| `dysuria_true:f02ba872` | `dysuria_true` | -- | true | 37/42 | 88.1% | true 37, null 5 |
| `dysuria_null_hedged:aadc0b7c` | `dysuria_null_hedged` | hedged | null | 28/30 | 93.3% | true 2, null 28 |
| `dysuria_null_historical:643625f1` | `dysuria_null_historical` | historical | null | 20/21 | 95.2% | true 1, null 20 |
| `dysuria_true:37c0a85e` | `dysuria_true` | -- | true | 28/29 | 96.6% | true 28, null 1 |
| `dysuria_true:8f0ade4e` | `dysuria_true` | -- | true | 37/38 | 97.4% | true 37, null 1 |
| `dysuria_true:93845aa6` | `dysuria_true` | -- | true | 48/49 | 98.0% | true 48, null 1 |

## `arm_b_finetune@c0.0-d0.3`

`roberta-base` with **every layer unfrozen**, mean-pooled, with the same `Linear(768, 3)` head -- 110M trainable parameters against Arm A's 2,307. Three epochs at batch 32, learning rate 2e-5, 10% linear warmup, AdamW, fp32. No gradient checkpointing, no 8-bit optimiser, no LoRA, no gradient accumulation: the full model fits in 12GB with room to spare, so anything that reads like a compute compromise would be a mistake rather than a saving. This is the arm that separates "the fragment libraries are the bottleneck" from "the method is too weak": if a fully fine-tuned encoder still cannot read third-party attribution, tense or metaphor, the limit is in the ideas the libraries contain and the fix is library work, not model work.

Decision-rule margins selected per fold (on each fold's own validation split): 0.05, 0.55, 0.85, 0.9.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2446 | 0 | 33 | 2479 |
| **truth true** | 0 | 1424 | 57 | 1481 |
| **truth null** | 1 | 199 | 5840 | 6040 |
| **total** | 2447 | 1623 | 5930 | 10000 |

`null -> true`: 199 of 6040 truly-null examples (3.29%).
...
|---|---|---|---|---|
| **truth false** | 2446 | 0 | 33 | 2479 |
| **truth true** | 0 | 1419 | 62 | 1481 |
| **truth null** | 4 | 181 | 5855 | 6040 |
| **total** | 2450 | 1600 | 5950 | 10000 |

`null -> true`: 181 of 6040 truly-null examples (3.00%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2450 | 99.8% | 98.7% | 99.2% |
| `true` | 1481 | 1600 | 88.7% | 95.8% | 92.1% |
| `null` | 6040 | 5950 | 98.4% | 96.9% | 97.7% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **128** | 98.7% [95.6%, 100.0%] |
| null_ambiguous | 3062 | **90** | 94.0% [89.2%, 97.6%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **124** | 95.8% [91.7%, 99.2%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| hedged | 789 | **20** | 89.7% [80.1%, 97.4%] |
| historical | 647 | **19** | 97.8% [94.6%, 100.0%] |
| metaphor | 759 | **28** | 94.3% [83.8%, 100.0%] |
| third_party | 867 | **23** | 94.6% [84.6%, 99.9%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| declarative_v1 | 1234 | **160** | 100.0% [100.0%, 100.0%] |
| dysuria_false | 1706 | **47** | 98.1% [94.0%, 100.0%] |
| dysuria_null_hedged | 789 | **20** | 89.7% [80.1%, 97.4%] |
| dysuria_null_historical | 647 | **19** | 97.8% [94.6%, 100.0%] |
| dysuria_null_metaphor | 759 | **28** | 94.3% [83.8%, 100.0%] |
| dysuria_null_thirdparty | 867 | **23** | 94.6% [84.6%, 99.9%] |
| dysuria_true | 1020 | **45** | 93.9% [87.6%, 98.9%] |
| (none) | 2978 | **1** | 100.0% [100.0%, 100.0%] |
...
24 of 643 decisive fragments were got wrong at least once.
...
| `dysuria_null_thirdparty:575791a4` | `dysuria_null_thirdparty` | third_party | null | 0/25 | 0.0% | true 25 |
| `dysuria_null_hedged:bea219da` | `dysuria_null_hedged` | hedged | null | 0/23 | 0.0% | true 23 |
| `dysuria_true:985d61a2` | `dysuria_true` | -- | true | 0/21 | 0.0% | null 21 |
| `dysuria_null_hedged:5bf05464` | `dysuria_null_hedged` | hedged | null | 0/15 | 0.0% | false 4, true 11 |
| `dysuria_null_thirdparty:2fd8fdb5` | `dysuria_null_thirdparty` | third_party | null | 0/14 | 0.0% | true 14 |
| `dysuria_null_hedged:ec574b54` | `dysuria_null_hedged` | hedged | null | 2/11 | 18.2% | true 9, null 2 |
| `dysuria_null_hedged:b1ae1f9d` | `dysuria_null_hedged` | hedged | null | 9/32 | 28.1% | true 23, null 9 |
| `dysuria_null_historical:e637313b` | `dysuria_null_historical` | historical | null | 3/10 | 30.0% | true 7, null 3 |
| `dysuria_true:146d5e49` | `dysuria_true` | -- | true | 8/23 | 34.8% | true 8, null 15 |
| `dysuria_true:2e98f278` | `dysuria_true` | -- | true | 6/17 | 35.3% | true 6, null 11 |
| `dysuria_true:63f5b24c` | `dysuria_true` | -- | true | 10/19 | 52.6% | true 10, null 9 |
| `dysuria_null_hedged:a5baf1c1` | `dysuria_null_hedged` | hedged | null | 13/21 | 61.9% | true 8, null 13 |
| `dysuria_null_historical:e7c8cfef` | `dysuria_null_historical` | historical | null | 17/24 | 70.8% | true 7, null 17 |
| `dysuria_null_thirdparty:4e732310` | `dysuria_null_thirdparty` | third_party | null | 12/16 | 75.0% | true 4, null 12 |
| `dysuria_null_metaphor:91b6dbda` | `dysuria_null_metaphor` | metaphor | null | 19/25 | 76.0% | true 6, null 19 |
| `dysuria_true:f5df5754` | `dysuria_true` | -- | true | 23/29 | 79.3% | true 23, null 6 |
| `dysuria_null_thirdparty:a2736b3b` | `dysuria_null_thirdparty` | third_party | null | 12/15 | 80.0% | true 3, null 12 |
| `dysuria_null_thirdparty:ddfe9a7b` | `dysuria_null_thirdparty` | third_party | null | 7/8 | 87.5% | true 1, null 7 |
| `dysuria_null_hedged:6f4ffbfa` | `dysuria_null_hedged` | hedged | null | 16/17 | 94.1% | true 1, null 16 |
| `dysuria_null_hedged:ffcde9d6` | `dysuria_null_hedged` | hedged | null | 18/19 | 94.7% | true 1, null 18 |
| `dysuria_null_hedged:249a7342` | `dysuria_null_hedged` | hedged | null | 26/27 | 96.3% | true 1, null 26 |
| `dysuria_false:e122d65e` | `dysuria_false` | -- | false | 37/38 | 97.4% | false 37, null 1 |
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 61.4% | 61.4% | 28.3% | 0.00% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 61.9% | 61.9% | 30.0% | 0.00% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 61.3% | 61.3% | 28.0% | 0.00% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 63.3% | 63.3% | 32.9% | 0.00% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 62.1% | 62.1% | 34.6% | 0.00% |

### `tfidf_logreg`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 76.1% | 76.1% | 65.3% | 5.54% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 78.4% | 78.4% | 66.0% | 0.58% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 81.0% | 81.0% | 69.7% | 0.83% |
| 3 | 10000 | 2000 | 2000 | 0.05 | 80.3% | 80.0% | 65.4% | 2.96% |
| 4 | 10000 | 2000 | 2000 | 0.05 | 80.5% | 80.4% | 67.0% | 0.00% |
...
| 2 | 10000 | 2000 | 2000 | 0.0 | 60.4% | 60.4% | 25.1% | 0.00% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 60.8% | 60.8% | 25.2% | 0.00% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 60.2% | 60.2% | 25.2% | 0.00% |

### `arm_b_finetune@c0.0-d0.0`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 95.0% | 95.0% | 93.7% | 7.94% |
| 1 | 10000 | 2000 | 2000 | 0.9 | 98.4% | 98.2% | 97.7% | 1.00% |
| 2 | 10000 | 2000 | 2000 | 0.8 | 96.4% | 96.5% | 95.1% | 3.31% |
| 3 | 10000 | 2000 | 2000 | 0.8 | 98.6% | 98.6% | 98.1% | 1.56% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 95.7% | 95.7% | 94.5% | 0.00% |

### `arm_b_finetune@c0.0-d0.3`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.55 | 95.6% | 95.6% | 94.3% | 5.62% |
| 1 | 10000 | 2000 | 2000 | 0.9 | 97.6% | 97.8% | 96.9% | 1.41% |
| 2 | 10000 | 2000 | 2000 | 0.9 | 96.8% | 96.9% | 96.0% | 5.13% |
| 3 | 10000 | 2000 | 2000 | 0.85 | 98.5% | 98.7% | 98.2% | 1.81% |
| 4 | 10000 | 2000 | 2000 | 0.05 | 97.0% | 97.0% | 96.5% | 1.00% |
