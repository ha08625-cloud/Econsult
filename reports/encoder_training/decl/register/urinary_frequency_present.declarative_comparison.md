...
*Generated 2026-09-02T19:53:55+00:00.*
...
| selected epochs | `c0.5-d0.0 2, 3, 1, 3, 1, c0.5-d0.3 1, 3, 1, 1, 3, c0.5-d0.6 3, 2, 1, 3, 3` |
| arm | `arm_b_finetune` |
...
* **c0.5-d0.6** (`data/synthetic/generated/decl/c0.5-d0.6`): 10000 examples per epoch, **10000** labelled positions for `urinary_frequency_present`
...
|---|---|---|---|---|---|---|---|
| `majority_class` | baseline | 7022 | **302** | 43.6% [37.6%, 50.7%] | 20.2% [18.2%, 22.4%] | 60.4% | 60.4% +/- 0.2% |
| `length_only` | baseline | 7022 | **302** | 43.6% [37.6%, 50.7%] | 20.2% [18.2%, 22.4%] | 60.4% | 60.4% +/- 0.2% |
| `tfidf_logreg` | baseline | 7022 | **302** | 57.0% [51.5%, 63.1%] | 44.0% [39.2%, 48.6%] | 69.7% | 69.7% +/- 3.2% |
| `length_only__shuffled` | negative control | 7022 | **302** | 43.6% [37.6%, 50.7%] | 20.2% [18.2%, 22.4%] | 60.4% | 60.4% +/- 0.2% |
| `tfidf_logreg__shuffled` | negative control | 7022 | **302** | 43.5% [37.5%, 50.6%] | 20.4% [18.4%, 22.6%] | 60.2% | 60.2% +/- 0.2% |
...
| `arm_b_finetune@c0.5-d0.6` | finetune | 7022 | **468** | 90.9% [88.1%, 93.6%] | 90.0% [86.8%, 92.8%] | 93.4% | 93.4% +/- 2.6% |
...
| `tfidf_logreg` | 97.8% [95.2%, 99.5%] (eff n 40) | -- | 93.1% [86.3%, 98.1%] (eff n 42) | 97.1% [93.9%, 99.2%] (eff n 40) | 97.8% [96.2%, 99.0%] (eff n 44) | 89.7% [82.3%, 95.8%] (eff n 44) |
...
| `tfidf_logreg__shuffled` | 99.5% [98.6%, 100.0%] (eff n 40) | -- | 99.4% [98.7%, 99.8%] (eff n 42) | 99.6% [99.1%, 100.0%] (eff n 40) | 99.9% [99.5%, 100.0%] (eff n 44) | 99.1% [98.2%, 99.8%] (eff n 44) |
...
| `arm_b_finetune@c0.5-d0.6` | 98.6% [96.2%, 100.0%] (eff n 40) | -- | 87.8% [80.1%, 95.0%] (eff n 42) | 98.7% [97.4%, 99.7%] (eff n 40) | 92.1% [82.9%, 99.6%] (eff n 44) | 96.1% [90.9%, 100.0%] (eff n 44) |
...
|---|---|---|---|---|
| `urinary_frequency_present` | 41 | 4.4% | 5.9% | 4.9% |
...
Recombination test slice: **n 7022**, **eff n 468** clusters, accuracy 90.9% [88.1%, 93.6%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.25, 0.6, 0.45, 0.85, 0.45. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `urinary_frequency_present` | 26/0/41 | 0 | 26 | 57.7% +/- 17.2% | +/-19.2% | 67 | 80.6% +/- 5.5% | 95.1% +/- 3.4% |

* `urinary_frequency_present`: no `false` examples in this set, so its number is very nearly a recall-only measurement: nothing here tests whether an explicit denial is read correctly, which was the largest error family in the synthetic evaluation.

`null -> true` on real text, per fold: `urinary_frequency_present` 3, 3, 0, 1, 3 of 41. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
`arm_b_finetune@c0.5-d0.0` ahead on 1 folds, `arm_b_finetune@c0.5-d0.3` on 4. `null -> true` mean: 4.4% against 5.9% -- **1.5 points higher** for `arm_b_finetune@c0.5-d0.3` -- more invented symptoms.
...
`arm_b_finetune@c0.5-d0.0` ahead on 0 folds, `arm_b_finetune@c0.5-d0.6` on 3. `null -> true` mean: 4.4% against 4.9% -- **0.5 points higher** for `arm_b_finetune@c0.5-d0.6` -- more invented symptoms.
...
`arm_b_finetune@c0.5-d0.3` ahead on 2 folds, `arm_b_finetune@c0.5-d0.6` on 2. `null -> true` mean: 5.9% against 4.9% -- **1.0 points lower** for `arm_b_finetune@c0.5-d0.6` -- fewer invented symptoms.
...
| `majority_class` vs `tfidf_logreg` | 3062 | 153 | 0 | 1.75e-46 |
| `majority_class` vs `arm_b_finetune@c0.5-d0.0` | 3062 | 182 | 0 | 3.26e-55 |
| `length_only` vs `tfidf_logreg` | 3062 | 153 | 0 | 1.75e-46 |
| `length_only` vs `arm_b_finetune@c0.5-d0.0` | 3062 | 182 | 0 | 3.26e-55 |
| `tfidf_logreg` vs `arm_b_finetune@c0.5-d0.0` | 3062 | 149 | 120 | 0.0876 |
...
* `tfidf_logreg`: 3018 errors across 144 of 302 decisive fragments. Half of them fall on **31** fragments (an even spread would be 72.0); the worst ten carry 20.9% of all errors.
...
* `arm_b_finetune@c0.5-d0.6`: 637 errors across 66 of 727 decisive fragments. Half of them fall on **14** fragments (an even spread would be 33.0); the worst ten carry 39.6% of all errors.
...
| `tfidf_logreg__shuffled` | 60.2% [38.7%, 77.4%] | 25.3% [18.8%, 29.2%] |
...
| `majority_class` vs `tfidf_logreg` | overall | 10000 | 166 | 1095 | 3.98e-168 |
| `majority_class` vs `tfidf_logreg` | null_ambiguous | 3062 | 153 | 0 | 1.75e-46 |
| `majority_class` vs `arm_b_finetune@c0.5-d0.0` | overall | 10000 | 208 | 2967 | 0 |
| `majority_class` vs `arm_b_finetune@c0.5-d0.0` | null_ambiguous | 3062 | 182 | 0 | 3.26e-55 |
| `length_only` vs `tfidf_logreg` | overall | 10000 | 166 | 1095 | 3.98e-168 |
| `length_only` vs `tfidf_logreg` | null_ambiguous | 3062 | 153 | 0 | 1.75e-46 |
| `length_only` vs `arm_b_finetune@c0.5-d0.0` | overall | 10000 | 208 | 2967 | 0 |
| `length_only` vs `arm_b_finetune@c0.5-d0.0` | null_ambiguous | 3062 | 182 | 0 | 3.26e-55 |
| `tfidf_logreg` vs `arm_b_finetune@c0.5-d0.0` | overall | 10000 | 267 | 2097 | 0 |
| `tfidf_logreg` vs `arm_b_finetune@c0.5-d0.0` | null_ambiguous | 3062 | 149 | 120 | 0.0876 |
...
|---|---|---|---|---|---|---|---|---|
| `urinary_frequency_false` | 950 | 0.0% | 0.0% | 40.6% | 80.4% | 74.9% | 74.0% | 80.4pp |
| `urinary_frequency_true` | 611 | 0.0% | 0.0% | 5.9% | 65.2% | 66.7% | 63.8% | 66.7pp |
| `urinary_frequency_null_hedged` | 623 | 100.0% | 100.0% | 93.1% | 87.6% | 90.9% | 87.8% | 12.4pp |
| `urinary_frequency_null_thirdparty` | 638 | 100.0% | 100.0% | 89.7% | 98.1% | 99.5% | 96.1% | 10.3pp |
| `urinary_frequency_null_metaphor` | 670 | 100.0% | 100.0% | 97.8% | 96.4% | 93.3% | 92.1% | 7.9pp |
| `urinary_frequency_null_adjacent` | 587 | 100.0% | 100.0% | 97.8% | 96.9% | 97.3% | 98.6% | 3.1pp |
| `urinary_frequency_null_historical` | 544 | 100.0% | 100.0% | 97.1% | 98.0% | 98.5% | 98.7% | 2.9pp |
| `(none)` | 2978 | 100.0% | 100.0% | 99.6% | 99.3% | 99.6% | 99.3% | 0.7pp |
...
|---|---|---|---|---|---|---|---|---|---|
| `urinary_frequency_false:a15017c2` | `urinary_frequency_false` | false | 134 | 134 | 45 | 8 | 42 | 53 | 126 |
| `urinary_frequency_false:a7fe81d1` | `urinary_frequency_false` | false | 125 | 125 | 110 | 0 | 0 | 0 | 125 |
| `urinary_frequency_false:d293ee8c` | `urinary_frequency_false` | false | 125 | 125 | 49 | 38 | 16 | 0 | 125 |
| `urinary_frequency_false:22b965f9` | `urinary_frequency_false` | false | 120 | 120 | 41 | 0 | 0 | 0 | 120 |
| `urinary_frequency_true:11d16987` | `urinary_frequency_true` | true | 70 | 70 | 70 | 70 | 48 | 29 | 41 |
| `urinary_frequency_false:6c16f65e` | `urinary_frequency_false` | false | 66 | 66 | 0 | 0 | 0 | 0 | 66 |
| `urinary_frequency_true:272d2041` | `urinary_frequency_true` | true | 66 | 66 | 58 | 0 | 0 | 0 | 66 |
| `urinary_frequency_false:a9a59952` | `urinary_frequency_false` | false | 65 | 65 | 33 | 25 | 37 | 20 | 45 |
| `urinary_frequency_false:a5342750` | `urinary_frequency_false` | false | 61 | 61 | 13 | 0 | 0 | 0 | 61 |
| `urinary_frequency_false:f3e3b17c` | `urinary_frequency_false` | false | 61 | 61 | 45 | 0 | 0 | 23 | 61 |
| `urinary_frequency_false:1d7759da` | `urinary_frequency_false` | false | 60 | 60 | 60 | 0 | 0 | 0 | 60 |
| `urinary_frequency_false:7fc83941` | `urinary_frequency_false` | false | 60 | 60 | 19 | 0 | 0 | 0 | 60 |
| `urinary_frequency_false:c7b96e67` | `urinary_frequency_false` | false | 60 | 60 | 13 | 0 | 0 | 0 | 60 |
| `urinary_frequency_true:764389c0` | `urinary_frequency_true` | true | 60 | 60 | 60 | 37 | 31 | 21 | 39 |
| `urinary_frequency_false:0c947cff` | `urinary_frequency_false` | false | 58 | 58 | 55 | 0 | 0 | 0 | 58 |
| `urinary_frequency_false:1a4ef542` | `urinary_frequency_false` | false | 58 | 58 | 19 | 6 | 0 | 0 | 58 |
| `urinary_frequency_false:3f640028` | `urinary_frequency_false` | false | 58 | 58 | 14 | 0 | 0 | 0 | 58 |
| `urinary_frequency_false:bb59f573` | `urinary_frequency_false` | false | 58 | 58 | 1 | 0 | 0 | 0 | 58 |
| `urinary_frequency_false:767e3f26` | `urinary_frequency_false` | false | 57 | 57 | 3 | 0 | 0 | 0 | 57 |
| `urinary_frequency_false:8a1fa086` | `urinary_frequency_false` | false | 57 | 57 | 54 | 0 | 0 | 0 | 57 |
| `urinary_frequency_false:cdacd51c` | `urinary_frequency_false` | false | 57 | 57 | 52 | 0 | 0 | 0 | 57 |
| `urinary_frequency_true:ffa90ce7` | `urinary_frequency_true` | true | 57 | 57 | 57 | 1 | 39 | 6 | 56 |
| `urinary_frequency_false:44543d5e` | `urinary_frequency_false` | false | 56 | 56 | 50 | 8 | 36 | 4 | 52 |
| `urinary_frequency_false:70687811` | `urinary_frequency_false` | false | 56 | 56 | 10 | 0 | 0 | 0 | 56 |
| `urinary_frequency_false:838b4247` | `urinary_frequency_false` | false | 55 | 55 | 15 | 1 | 0 | 0 | 55 |
| `urinary_frequency_false:f78f9d25` | `urinary_frequency_false` | false | 54 | 54 | 54 | 0 | 0 | 0 | 54 |
| `urinary_frequency_true:2a4e0890` | `urinary_frequency_true` | true | 54 | 54 | 54 | 0 | 0 | 0 | 54 |
| `urinary_frequency_true:d01347c4` | `urinary_frequency_true` | true | 53 | 53 | 42 | 0 | 0 | 0 | 53 |
| `urinary_frequency_false:99f7fbc1` | `urinary_frequency_false` | false | 51 | 51 | 16 | 0 | 0 | 0 | 51 |
| `urinary_frequency_false:c631660d` | `urinary_frequency_false` | false | 51 | 51 | 49 | 51 | 35 | 20 | 31 |
| `urinary_frequency_false:42205311` | `urinary_frequency_false` | false | 50 | 50 | 22 | 0 | 0 | 0 | 50 |
| `urinary_frequency_false:63302b59` | `urinary_frequency_false` | false | 50 | 50 | 32 | 50 | 39 | 24 | 26 |
| `urinary_frequency_false:f324736d` | `urinary_frequency_false` | false | 48 | 48 | 48 | 0 | 0 | 0 | 48 |
| `urinary_frequency_false:941626e8` | `urinary_frequency_false` | false | 47 | 47 | 44 | 47 | 35 | 18 | 29 |
| `urinary_frequency_true:73717ed3` | `urinary_frequency_true` | true | 47 | 47 | 45 | 1 | 0 | 5 | 47 |
| `urinary_frequency_false:fc6a56d2` | `urinary_frequency_false` | false | 45 | 45 | 43 | 45 | 38 | 22 | 23 |
| `urinary_frequency_true:2c452329` | `urinary_frequency_true` | true | 44 | 44 | 43 | 44 | 26 | 20 | 24 |
| `urinary_frequency_false:f32c9e68` | `urinary_frequency_false` | false | 43 | 43 | 42 | 43 | 33 | 2 | 41 |
| `urinary_frequency_false:6bb71206` | `urinary_frequency_false` | false | 42 | 42 | 42 | 42 | 31 | 19 | 23 |
| `urinary_frequency_true:48d16506` | `urinary_frequency_true` | true | 42 | 42 | 39 | 4 | 0 | 14 | 42 |

*123 further fragments erred on at least one model; the JSON holds them all.*
...
|---|---|---|---|
| adjacent | 587 | **40** | 100.0% [100.0%, 100.0%] |
| hedged | 623 | **42** | 100.0% [100.0%, 100.0%] |
| historical | 544 | **40** | 100.0% [100.0%, 100.0%] |
| metaphor | 670 | **44** | 100.0% [100.0%, 100.0%] |
| third_party | 638 | **44** | 100.0% [100.0%, 100.0%] |
...
| urinary_frequency_null_adjacent | 587 | **40** | 100.0% [100.0%, 100.0%] |
| urinary_frequency_null_hedged | 623 | **42** | 100.0% [100.0%, 100.0%] |
| urinary_frequency_null_historical | 544 | **40** | 100.0% [100.0%, 100.0%] |
| urinary_frequency_null_metaphor | 670 | **44** | 100.0% [100.0%, 100.0%] |
| urinary_frequency_null_thirdparty | 638 | **44** | 100.0% [100.0%, 100.0%] |
...
|---|---|---|---|---|---|---|
| `urinary_frequency_false:a15017c2` | `urinary_frequency_false` | -- | false | 0/134 | 0.0% | null 134 |
| `urinary_frequency_false:a7fe81d1` | `urinary_frequency_false` | -- | false | 0/125 | 0.0% | null 125 |
| `urinary_frequency_false:d293ee8c` | `urinary_frequency_false` | -- | false | 0/125 | 0.0% | null 125 |
| `urinary_frequency_false:22b965f9` | `urinary_frequency_false` | -- | false | 0/120 | 0.0% | null 120 |
...
| `urinary_frequency_true:272d2041` | `urinary_frequency_true` | -- | true | 0/66 | 0.0% | null 66 |
| `urinary_frequency_false:a9a59952` | `urinary_frequency_false` | -- | false | 0/65 | 0.0% | null 65 |
| `urinary_frequency_false:a5342750` | `urinary_frequency_false` | -- | false | 0/61 | 0.0% | null 61 |
| `urinary_frequency_false:f3e3b17c` | `urinary_frequency_false` | -- | false | 0/61 | 0.0% | null 61 |
| `urinary_frequency_false:1d7759da` | `urinary_frequency_false` | -- | false | 0/60 | 0.0% | null 60 |
| `urinary_frequency_false:7fc83941` | `urinary_frequency_false` | -- | false | 0/60 | 0.0% | null 60 |
| `urinary_frequency_false:c7b96e67` | `urinary_frequency_false` | -- | false | 0/60 | 0.0% | null 60 |
| `urinary_frequency_true:764389c0` | `urinary_frequency_true` | -- | true | 0/60 | 0.0% | null 60 |
| `urinary_frequency_false:0c947cff` | `urinary_frequency_false` | -- | false | 0/58 | 0.0% | null 58 |
| `urinary_frequency_false:1a4ef542` | `urinary_frequency_false` | -- | false | 0/58 | 0.0% | null 58 |
| `urinary_frequency_false:3f640028` | `urinary_frequency_false` | -- | false | 0/58 | 0.0% | null 58 |
| `urinary_frequency_false:bb59f573` | `urinary_frequency_false` | -- | false | 0/58 | 0.0% | null 58 |
| `urinary_frequency_false:767e3f26` | `urinary_frequency_false` | -- | false | 0/57 | 0.0% | null 57 |
| `urinary_frequency_false:8a1fa086` | `urinary_frequency_false` | -- | false | 0/57 | 0.0% | null 57 |
| `urinary_frequency_false:cdacd51c` | `urinary_frequency_false` | -- | false | 0/57 | 0.0% | null 57 |
| `urinary_frequency_true:ffa90ce7` | `urinary_frequency_true` | -- | true | 0/57 | 0.0% | null 57 |
...
| `urinary_frequency_false:838b4247` | `urinary_frequency_false` | -- | false | 0/55 | 0.0% | null 55 |
| `urinary_frequency_false:f78f9d25` | `urinary_frequency_false` | -- | false | 0/54 | 0.0% | null 54 |
| `urinary_frequency_true:2a4e0890` | `urinary_frequency_true` | -- | true | 0/54 | 0.0% | null 54 |
| `urinary_frequency_true:d01347c4` | `urinary_frequency_true` | -- | true | 0/53 | 0.0% | null 53 |
| `urinary_frequency_false:99f7fbc1` | `urinary_frequency_false` | -- | false | 0/51 | 0.0% | null 51 |
| `urinary_frequency_false:c631660d` | `urinary_frequency_false` | -- | false | 0/51 | 0.0% | null 51 |
| `urinary_frequency_false:42205311` | `urinary_frequency_false` | -- | false | 0/50 | 0.0% | null 50 |
| `urinary_frequency_false:63302b59` | `urinary_frequency_false` | -- | false | 0/50 | 0.0% | null 50 |
| `urinary_frequency_false:f324736d` | `urinary_frequency_false` | -- | false | 0/48 | 0.0% | null 48 |
...
| `urinary_frequency_false:fc6a56d2` | `urinary_frequency_false` | -- | false | 0/45 | 0.0% | null 45 |
| `urinary_frequency_true:2c452329` | `urinary_frequency_true` | -- | true | 0/44 | 0.0% | null 44 |
| `urinary_frequency_false:f32c9e68` | `urinary_frequency_false` | -- | false | 0/43 | 0.0% | null 43 |
| `urinary_frequency_false:6bb71206` | `urinary_frequency_false` | -- | false | 0/42 | 0.0% | null 42 |
| `urinary_frequency_true:48d16506` | `urinary_frequency_true` | -- | true | 0/42 | 0.0% | null 42 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1007 | 110 | 1362 | 2479 |
| **truth true** | 196 | 88 | 1197 | 1481 |
| **truth null** | 79 | 87 | 5874 | 6040 |
| **total** | 1282 | 285 | 8433 | 10000 |

`null -> true`: 87 of 6040 truly-null examples (1.44%).
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 1282 | 78.5% | 40.6% | 53.5% |
| `true` | 1481 | 285 | 30.9% | 5.9% | 10.0% |
| `null` | 6040 | 8433 | 69.7% | 97.3% | 81.2% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **46** | 40.6% [30.3%, 50.6%] |
| null_ambiguous | 3062 | **210** | 95.0% [92.7%, 96.9%] |
| null_structural | 2978 | **1** | 99.6% [99.6%, 99.6%] |
| true | 1481 | **46** | 5.9% [2.7%, 9.7%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| adjacent | 587 | **40** | 97.8% [95.2%, 99.5%] |
| hedged | 623 | **42** | 93.1% [86.3%, 98.1%] |
| historical | 544 | **40** | 97.1% [93.9%, 99.2%] |
| metaphor | 670 | **44** | 97.8% [96.2%, 99.0%] |
| third_party | 638 | **44** | 89.7% [82.3%, 95.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| urinary_frequency_false | 2479 | **46** | 40.6% [30.3%, 50.6%] |
| urinary_frequency_null_adjacent | 587 | **40** | 97.8% [95.2%, 99.5%] |
| urinary_frequency_null_hedged | 623 | **42** | 93.1% [86.3%, 98.1%] |
| urinary_frequency_null_historical | 544 | **40** | 97.1% [93.9%, 99.2%] |
| urinary_frequency_null_metaphor | 670 | **44** | 97.8% [96.2%, 99.0%] |
| urinary_frequency_null_thirdparty | 638 | **44** | 89.7% [82.3%, 95.8%] |
| urinary_frequency_true | 1481 | **46** | 5.9% [2.7%, 9.7%] |
...
144 of 302 decisive fragments were got wrong at least once.
...
|---|---|---|---|---|---|---|
| `urinary_frequency_true:11d16987` | `urinary_frequency_true` | -- | true | 0/70 | 0.0% | null 70 |
| `urinary_frequency_false:1d7759da` | `urinary_frequency_false` | -- | false | 0/60 | 0.0% | true 1, null 59 |
| `urinary_frequency_true:764389c0` | `urinary_frequency_true` | -- | true | 0/60 | 0.0% | null 60 |
| `urinary_frequency_true:ffa90ce7` | `urinary_frequency_true` | -- | true | 0/57 | 0.0% | null 57 |
| `urinary_frequency_false:f78f9d25` | `urinary_frequency_false` | -- | false | 0/54 | 0.0% | true 1, null 53 |
| `urinary_frequency_true:2a4e0890` | `urinary_frequency_true` | -- | true | 0/54 | 0.0% | null 54 |
| `urinary_frequency_false:f324736d` | `urinary_frequency_false` | -- | false | 0/48 | 0.0% | null 48 |
| `urinary_frequency_false:6bb71206` | `urinary_frequency_false` | -- | false | 0/42 | 0.0% | null 42 |
...
| `urinary_frequency_false:8ea3ee34` | `urinary_frequency_false` | -- | false | 0/38 | 0.0% | null 38 |
| `urinary_frequency_true:5008b431` | `urinary_frequency_true` | -- | true | 0/36 | 0.0% | false 5, null 31 |
| `urinary_frequency_true:eccbc8ee` | `urinary_frequency_true` | -- | true | 0/36 | 0.0% | false 9, null 27 |
| `urinary_frequency_true:3e2bc574` | `urinary_frequency_true` | -- | true | 0/35 | 0.0% | null 35 |
| `urinary_frequency_true:617cfdc3` | `urinary_frequency_true` | -- | true | 0/34 | 0.0% | null 34 |
| `urinary_frequency_true:35a67edf` | `urinary_frequency_true` | -- | true | 0/33 | 0.0% | false 2, null 31 |
| `urinary_frequency_false:c85c9d5a` | `urinary_frequency_false` | -- | false | 0/32 | 0.0% | null 32 |
| `urinary_frequency_true:900c8b2c` | `urinary_frequency_true` | -- | true | 0/32 | 0.0% | false 3, null 29 |
| `urinary_frequency_true:fbca5613` | `urinary_frequency_true` | -- | true | 0/32 | 0.0% | null 32 |
| `urinary_frequency_false:7be58a30` | `urinary_frequency_false` | -- | false | 0/31 | 0.0% | null 31 |
| `urinary_frequency_false:ec8210fb` | `urinary_frequency_false` | -- | false | 0/30 | 0.0% | null 30 |
| `urinary_frequency_true:e746abc0` | `urinary_frequency_true` | -- | true | 0/30 | 0.0% | null 30 |
| `urinary_frequency_false:b66fa498` | `urinary_frequency_false` | -- | false | 0/29 | 0.0% | true 7, null 22 |
| `urinary_frequency_true:32946372` | `urinary_frequency_true` | -- | true | 0/28 | 0.0% | false 20, null 8 |
| `urinary_frequency_true:fecb0185` | `urinary_frequency_true` | -- | true | 0/28 | 0.0% | null 28 |
| `urinary_frequency_true:5327793c` | `urinary_frequency_true` | -- | true | 0/27 | 0.0% | null 27 |
| `urinary_frequency_false:017dce58` | `urinary_frequency_false` | -- | false | 0/26 | 0.0% | null 26 |
| `urinary_frequency_true:1d671fe5` | `urinary_frequency_true` | -- | true | 0/26 | 0.0% | null 26 |
...
| `urinary_frequency_true:57632816` | `urinary_frequency_true` | -- | true | 0/22 | 0.0% | false 2, null 20 |
| `urinary_frequency_true:f0e98801` | `urinary_frequency_true` | -- | true | 0/22 | 0.0% | null 22 |
| `urinary_frequency_true:32cae421` | `urinary_frequency_true` | -- | true | 0/21 | 0.0% | false 21 |
| `urinary_frequency_true:c87f1579` | `urinary_frequency_true` | -- | true | 0/21 | 0.0% | false 1, null 20 |
| `urinary_frequency_true:95d4e96a` | `urinary_frequency_true` | -- | true | 0/20 | 0.0% | false 5, null 15 |
| `urinary_frequency_true:f5216cf2` | `urinary_frequency_true` | -- | true | 0/20 | 0.0% | null 20 |
| `urinary_frequency_true:c8bfbc09` | `urinary_frequency_true` | -- | true | 0/19 | 0.0% | false 6, null 13 |
| `urinary_frequency_true:20bd4d56` | `urinary_frequency_true` | -- | true | 0/18 | 0.0% | false 1, null 17 |
| `urinary_frequency_true:52b41248` | `urinary_frequency_true` | -- | true | 0/16 | 0.0% | null 16 |
| `urinary_frequency_true:2491f080` | `urinary_frequency_true` | -- | true | 0/15 | 0.0% | null 15 |

*104 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 8 | 0 | 2471 | 2479 |
| **truth true** | 10 | 0 | 1471 | 1481 |
| **truth null** | 27 | 1 | 6012 | 6040 |
| **total** | 45 | 1 | 9954 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 45 | 17.8% | 0.3% | 0.6% |
| `true` | 1481 | 1 | 0.0% | 0.0% | 0.0% |
| `null` | 6040 | 9954 | 60.4% | 99.5% | 75.2% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **46** | 0.3% [0.1%, 0.6%] |
| null_ambiguous | 3062 | **210** | 99.5% [99.2%, 99.7%] |
| null_structural | 2978 | **1** | 99.6% [99.6%, 99.6%] |
| true | 1481 | **46** | 0.0% [0.0%, 0.0%] |
...
| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| adjacent | 587 | **40** | 99.5% [98.6%, 100.0%] |
| hedged | 623 | **42** | 99.4% [98.7%, 99.8%] |
| historical | 544 | **40** | 99.6% [99.1%, 100.0%] |
| metaphor | 670 | **44** | 99.9% [99.5%, 100.0%] |
| third_party | 638 | **44** | 99.1% [98.2%, 99.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| urinary_frequency_false | 2479 | **46** | 0.3% [0.1%, 0.6%] |
| urinary_frequency_null_adjacent | 587 | **40** | 99.5% [98.6%, 100.0%] |
| urinary_frequency_null_hedged | 623 | **42** | 99.4% [98.7%, 99.8%] |
| urinary_frequency_null_historical | 544 | **40** | 99.6% [99.1%, 100.0%] |
| urinary_frequency_null_metaphor | 670 | **44** | 99.9% [99.5%, 100.0%] |
| urinary_frequency_null_thirdparty | 638 | **44** | 99.1% [98.2%, 99.8%] |
| urinary_frequency_true | 1481 | **46** | 0.0% [0.0%, 0.0%] |
| (none) | 2978 | **1** | 99.6% [99.6%, 99.6%] |
...
106 of 302 decisive fragments were got wrong at least once.

`tfidf_logreg__shuffled`: 3968 errors across 106 of 302 decisive fragments. Half of them fall on **30** fragments (an even spread would be 53.0); the worst ten carry 22.5% of all errors.
...
| `urinary_frequency_false:d293ee8c` | `urinary_frequency_false` | -- | false | 0/125 | 0.0% | null 125 |
| `urinary_frequency_false:22b965f9` | `urinary_frequency_false` | -- | false | 0/120 | 0.0% | null 120 |
| `urinary_frequency_true:11d16987` | `urinary_frequency_true` | -- | true | 0/70 | 0.0% | false 3, null 67 |
| `urinary_frequency_false:6c16f65e` | `urinary_frequency_false` | -- | false | 0/66 | 0.0% | null 66 |
| `urinary_frequency_true:272d2041` | `urinary_frequency_true` | -- | true | 0/66 | 0.0% | false 2, null 64 |
| `urinary_frequency_false:a5342750` | `urinary_frequency_false` | -- | false | 0/61 | 0.0% | null 61 |
| `urinary_frequency_false:f3e3b17c` | `urinary_frequency_false` | -- | false | 0/61 | 0.0% | null 61 |
| `urinary_frequency_false:1d7759da` | `urinary_frequency_false` | -- | false | 0/60 | 0.0% | null 60 |
| `urinary_frequency_false:7fc83941` | `urinary_frequency_false` | -- | false | 0/60 | 0.0% | null 60 |
...
| `urinary_frequency_true:73717ed3` | `urinary_frequency_true` | -- | true | 0/47 | 0.0% | null 47 |
| `urinary_frequency_false:fc6a56d2` | `urinary_frequency_false` | -- | false | 0/45 | 0.0% | null 45 |
| `urinary_frequency_true:2c452329` | `urinary_frequency_true` | -- | true | 0/44 | 0.0% | false 1, null 43 |
| `urinary_frequency_false:f32c9e68` | `urinary_frequency_false` | -- | false | 0/43 | 0.0% | null 43 |
| `urinary_frequency_false:6bb71206` | `urinary_frequency_false` | -- | false | 0/42 | 0.0% | null 42 |
| `urinary_frequency_true:48d16506` | `urinary_frequency_true` | -- | true | 0/42 | 0.0% | null 42 |
| `urinary_frequency_true:87b688c8` | `urinary_frequency_true` | -- | true | 0/42 | 0.0% | null 42 |
| `urinary_frequency_false:3ce1d817` | `urinary_frequency_false` | -- | false | 0/41 | 0.0% | null 41 |
| `urinary_frequency_true:cf215b55` | `urinary_frequency_true` | -- | true | 0/41 | 0.0% | false 2, null 39 |
| `urinary_frequency_true:f6de3825` | `urinary_frequency_true` | -- | true | 0/41 | 0.0% | null 41 |
| `urinary_frequency_false:3f80576c` | `urinary_frequency_false` | -- | false | 0/40 | 0.0% | null 40 |
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.25, 0.45, 0.6, 0.85.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2225 | 122 | 132 | 2479 |
| **truth true** | 13 | 1271 | 197 | 1481 |
| **truth null** | 18 | 184 | 5838 | 6040 |
| **total** | 2256 | 1577 | 6167 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2232 | 112 | 135 | 2479 |
| **truth true** | 14 | 1260 | 207 | 1481 |
| **truth null** | 18 | 171 | 5851 | 6040 |
| **total** | 2264 | 1543 | 6193 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2264 | 98.6% | 90.0% | 94.1% |
| `true` | 1481 | 1543 | 81.7% | 85.1% | 83.3% |
| `null` | 6040 | 6193 | 94.5% | 96.9% | 95.7% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **125** | 90.0% [83.6%, 95.5%] |
| null_ambiguous | 3062 | **210** | 94.5% [91.6%, 96.9%] |
| null_structural | 2978 | **1** | 99.3% [99.3%, 99.3%] |
| true | 1481 | **133** | 85.1% [77.9%, 91.6%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| adjacent | 587 | **40** | 98.6% [96.2%, 100.0%] |
| hedged | 623 | **42** | 87.8% [80.1%, 95.0%] |
| historical | 544 | **40** | 98.7% [97.4%, 99.7%] |
| metaphor | 670 | **44** | 92.1% [82.9%, 99.6%] |
| third_party | 638 | **44** | 96.1% [90.9%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| declarative_v1 | 2399 | **166** | 100.0% [100.0%, 100.0%] |
| urinary_frequency_false | 950 | **46** | 74.0% [59.9%, 86.5%] |
| urinary_frequency_null_adjacent | 587 | **40** | 98.6% [96.2%, 100.0%] |
| urinary_frequency_null_hedged | 623 | **42** | 87.8% [80.1%, 95.0%] |
| urinary_frequency_null_historical | 544 | **40** | 98.7% [97.4%, 99.7%] |
| urinary_frequency_null_metaphor | 670 | **44** | 92.1% [82.9%, 99.6%] |
| urinary_frequency_null_thirdparty | 638 | **44** | 96.1% [90.9%, 100.0%] |
| urinary_frequency_true | 611 | **46** | 63.8% [49.7%, 76.9%] |
| (none) | 2978 | **1** | 99.3% [99.3%, 99.3%] |
...
66 of 727 decisive fragments were got wrong at least once.

`arm_b_finetune@c0.5-d0.6`: 637 errors across 66 of 727 decisive fragments. Half of them fall on **14** fragments (an even spread would be 33.0); the worst ten carry 39.6% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `urinary_frequency_true:11d16987` | `urinary_frequency_true` | -- | true | 0/29 | 0.0% | null 29 |
| `urinary_frequency_false:63302b59` | `urinary_frequency_false` | -- | false | 0/24 | 0.0% | true 24 |
| `urinary_frequency_false:fc6a56d2` | `urinary_frequency_false` | -- | false | 0/22 | 0.0% | true 22 |
| `urinary_frequency_false:a9a59952` | `urinary_frequency_false` | -- | false | 0/20 | 0.0% | true 20 |
| `urinary_frequency_false:c631660d` | `urinary_frequency_false` | -- | false | 0/20 | 0.0% | null 20 |
| `urinary_frequency_null_metaphor:5c1e4a7d` | `urinary_frequency_null_metaphor` | metaphor | null | 0/20 | 0.0% | true 20 |
| `urinary_frequency_true:2c452329` | `urinary_frequency_true` | -- | true | 0/20 | 0.0% | false 1, null 19 |
| `urinary_frequency_false:6bb71206` | `urinary_frequency_false` | -- | false | 0/19 | 0.0% | true 8, null 11 |
| `urinary_frequency_false:941626e8` | `urinary_frequency_false` | -- | false | 0/18 | 0.0% | null 18 |
| `urinary_frequency_null_metaphor:518f483f` | `urinary_frequency_null_metaphor` | metaphor | null | 0/18 | 0.0% | true 18 |
| `urinary_frequency_true:5327793c` | `urinary_frequency_true` | -- | true | 0/17 | 0.0% | null 17 |
| `urinary_frequency_true:48d16506` | `urinary_frequency_true` | -- | true | 0/14 | 0.0% | null 14 |
| `urinary_frequency_null_hedged:5f612dfb` | `urinary_frequency_null_hedged` | hedged | null | 0/11 | 0.0% | true 11 |
| `urinary_frequency_true:76e4e79f` | `urinary_frequency_true` | -- | true | 0/11 | 0.0% | null 11 |
| `urinary_frequency_true:e746abc0` | `urinary_frequency_true` | -- | true | 0/9 | 0.0% | null 9 |
| `urinary_frequency_true:f9c03b9b` | `urinary_frequency_true` | -- | true | 0/9 | 0.0% | null 9 |
| `urinary_frequency_true:20bd4d56` | `urinary_frequency_true` | -- | true | 0/8 | 0.0% | null 8 |
| `urinary_frequency_true:c8d32074` | `urinary_frequency_true` | -- | true | 0/8 | 0.0% | null 8 |
| `urinary_frequency_true:c87f1579` | `urinary_frequency_true` | -- | true | 0/4 | 0.0% | null 4 |
| `urinary_frequency_false:f3e3b17c` | `urinary_frequency_false` | -- | false | 1/24 | 4.2% | false 1, null 23 |
| `urinary_frequency_true:764389c0` | `urinary_frequency_true` | -- | true | 1/22 | 4.5% | true 1, null 21 |
| `urinary_frequency_null_thirdparty:bf658595` | `urinary_frequency_null_thirdparty` | third_party | null | 1/14 | 7.1% | true 13, null 1 |
| `urinary_frequency_true:f5216cf2` | `urinary_frequency_true` | -- | true | 1/14 | 7.1% | true 1, null 13 |
| `urinary_frequency_false:a61aba66` | `urinary_frequency_false` | -- | false | 1/13 | 7.7% | false 1, null 12 |
| `urinary_frequency_null_metaphor:92dfbbce` | `urinary_frequency_null_metaphor` | metaphor | null | 1/13 | 7.7% | true 12, null 1 |
| `urinary_frequency_true:32cae421` | `urinary_frequency_true` | -- | true | 1/13 | 7.7% | false 12, true 1 |
| `urinary_frequency_true:fecb0185` | `urinary_frequency_true` | -- | true | 1/11 | 9.1% | true 1, null 10 |
| `urinary_frequency_false:ec8210fb` | `urinary_frequency_false` | -- | false | 1/10 | 10.0% | false 1, null 9 |
| `urinary_frequency_false:a15017c2` | `urinary_frequency_false` | -- | false | 9/62 | 14.5% | false 9, true 28, null 25 |
| `urinary_frequency_false:7be58a30` | `urinary_frequency_false` | -- | false | 2/13 | 15.4% | false 2, null 11 |
| `urinary_frequency_null_hedged:41035ae0` | `urinary_frequency_null_hedged` | hedged | null | 2/13 | 15.4% | true 11, null 2 |
| `urinary_frequency_false:b66fa498` | `urinary_frequency_false` | -- | false | 1/6 | 16.7% | false 1, null 5 |
| `urinary_frequency_null_hedged:fe13847c` | `urinary_frequency_null_hedged` | hedged | null | 4/16 | 25.0% | true 12, null 4 |
| `urinary_frequency_true:fbca5613` | `urinary_frequency_true` | -- | true | 3/10 | 30.0% | true 3, null 7 |
| `urinary_frequency_null_hedged:ff5d90b8` | `urinary_frequency_null_hedged` | hedged | null | 4/13 | 30.8% | false 8, true 1, null 4 |
| `urinary_frequency_null_hedged:61fe8d58` | `urinary_frequency_null_hedged` | hedged | null | 6/15 | 40.0% | true 9, null 6 |
| `urinary_frequency_true:617cfdc3` | `urinary_frequency_true` | -- | true | 5/12 | 41.7% | true 5, null 7 |
| `urinary_frequency_null_hedged:624acb37` | `urinary_frequency_null_hedged` | hedged | null | 7/14 | 50.0% | true 7, null 7 |
| `urinary_frequency_false:8239d5f6` | `urinary_frequency_false` | -- | false | 5/9 | 55.6% | false 5, true 4 |
| `urinary_frequency_null_adjacent:15320912` | `urinary_frequency_null_adjacent` | adjacent | null | 9/16 | 56.2% | true 7, null 9 |
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 71.0% | 71.0% | 52.2% | 2.32% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 67.0% | 67.0% | 42.9% | 1.41% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 65.8% | 65.8% | 40.6% | 0.08% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 73.6% | 73.6% | 52.1% | 1.15% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 71.0% | 71.0% | 51.3% | 2.24% |
...
| 1 | 10000 | 2000 | 2000 | 0.0 | 60.2% | 60.2% | 25.7% | 0.08% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 60.1% | 60.1% | 25.1% | 0.00% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 60.4% | 60.4% | 25.1% | 0.00% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 60.0% | 60.0% | 25.1% | 0.00% |
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.25 | 94.9% | 94.9% | 93.0% | 1.57% |
| 1 | 10000 | 2000 | 2000 | 0.6 | 89.8% | 90.0% | 86.4% | 3.16% |
| 2 | 10000 | 2000 | 2000 | 0.45 | 92.6% | 92.6% | 90.4% | 1.90% |
| 3 | 10000 | 2000 | 2000 | 0.85 | 96.9% | 96.8% | 94.8% | 0.08% |
| 4 | 10000 | 2000 | 2000 | 0.45 | 92.6% | 92.8% | 90.9% | 7.46% |
