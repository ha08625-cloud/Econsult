...
*Generated 2026-09-05T20:15:49+00:00.*
...
| split salt | `0` |
| dataset dir | `data/synthetic/generated/swapclass/clean` |
| dataset expansion | `none -- the tree carries no expansion block` |
...
| artefacts | `models/encoder-swapclass/clean-trained-combined-test/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.0% [90.9%, 95.0%] | 92.4% [90.1%, 94.6%] | 95.1% | 95.1% +/- 2.7% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 93.4% [85.8%, 98.9%] (eff n 43) | 85.9% [77.3%, 93.4%] (eff n 63) | 92.2% [85.7%, 97.5%] (eff n 36) | 99.2% [97.4%, 100.0%] (eff n 47) | 96.1% [91.7%, 99.2%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.0% [90.9%, 95.0%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.55, 0.0, 0.45, 0.1. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 92.8% [89.9%, 95.5%] |
...
* `arm_b_finetune`: 489 errors across 67 of 463 decisive fragments. Half of them fall on **16** fragments (an even spread would be 33.5); the worst ten carry 37.6% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2343 | 66 | 70 | 2479 |
| **truth true** | 13 | 1352 | 116 | 1481 |
| **truth null** | 50 | 179 | 5811 | 6040 |
| **total** | 2406 | 1597 | 5997 | 10000 |

`null -> true`: 179 of 6040 truly-null examples (2.96%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2344 | 64 | 71 | 2479 |
| **truth true** | 13 | 1347 | 121 | 1481 |
| **truth null** | 51 | 170 | 5819 | 6040 |
| **total** | 2408 | 1581 | 6011 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2408 | 97.3% | 94.6% | 95.9% |
| `true` | 1481 | 1581 | 85.2% | 91.0% | 88.0% |
| `null` | 6040 | 6011 | 96.8% | 96.3% | 96.6% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.6% [90.1%, 98.0%] |
| null_ambiguous | 3062 | **224** | 92.8% [89.9%, 95.5%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **96** | 91.0% [85.8%, 95.5%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 93.4% [85.8%, 98.9%] |
| hedged | 828 | **63** | 85.9% [77.3%, 93.4%] |
| historical | 511 | **36** | 92.2% [85.7%, 97.5%] |
| metaphor | 641 | **47** | 99.2% [97.4%, 100.0%] |
| third_party | 508 | **35** | 96.1% [91.7%, 99.2%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 94.6% [90.1%, 98.0%] |
| fever_null_attribution | 574 | **43** | 93.4% [85.8%, 98.9%] |
| fever_null_hedged | 828 | **63** | 85.9% [77.3%, 93.4%] |
| fever_null_historical | 511 | **36** | 92.2% [85.7%, 97.5%] |
| fever_null_metaphor | 641 | **47** | 99.2% [97.4%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 96.1% [91.7%, 99.2%] |
| fever_true | 1481 | **96** | 91.0% [85.8%, 95.5%] |
...
67 of 463 decisive fragments were got wrong at least once.
...
| `fever_null_hedged:0906c944` | `fever_null_hedged` | hedged | null | 1/12 | 8.3% | false 5, true 6, null 1 |
...
| `fever_false:3a3043ff` | `fever_false` | -- | false | 4/29 | 13.8% | false 4, true 25 |
...
| `fever_null_hedged:9e333f46` | `fever_null_hedged` | hedged | null | 2/10 | 20.0% | false 7, true 1, null 2 |
| `fever_true:ef344ff7` | `fever_true` | -- | true | 3/13 | 23.1% | true 3, null 10 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 5/16 | 31.2% | false 11, true 5 |
| `fever_null_thirdparty:05f9c98e` | `fever_null_thirdparty` | third_party | null | 5/14 | 35.7% | true 9, null 5 |
| `fever_null_hedged:bba323b8` | `fever_null_hedged` | hedged | null | 5/13 | 38.5% | true 8, null 5 |
| `fever_null_historical:9920da91` | `fever_null_historical` | historical | null | 5/13 | 38.5% | true 8, null 5 |
| `fever_true:391fb2ce` | `fever_true` | -- | true | 7/18 | 38.9% | true 7, null 11 |
| `fever_true:ed36ef0f` | `fever_true` | -- | true | 5/12 | 41.7% | true 5, null 7 |
| `fever_null_historical:ebfd0af7` | `fever_null_historical` | historical | null | 6/11 | 54.5% | true 5, null 6 |
| `fever_null_metaphor:625f220a` | `fever_null_metaphor` | metaphor | null | 6/11 | 54.5% | true 5, null 6 |
| `fever_true:c7489e90` | `fever_true` | -- | true | 11/19 | 57.9% | true 11, null 8 |
| `fever_true:872e3af9` | `fever_true` | -- | true | 7/12 | 58.3% | true 7, null 5 |
| `fever_null_hedged:43dc94df` | `fever_null_hedged` | hedged | null | 6/10 | 60.0% | false 4, null 6 |
| `fever_null_thirdparty:72b6bd16` | `fever_null_thirdparty` | third_party | null | 3/5 | 60.0% | true 2, null 3 |
| `fever_null_attribution:5cd352f2` | `fever_null_attribution` | attribution | null | 8/13 | 61.5% | true 5, null 8 |
| `fever_true:01833454` | `fever_true` | -- | true | 10/16 | 62.5% | false 2, true 10, null 4 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.55 | 96.5% | 96.8% | 96.1% | 3.80% |
| 1 | 10000 | 2000 | 2000 | 0.55 | 94.0% | 93.9% | 92.1% | 1.33% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 91.5% | 91.5% | 88.3% | 4.39% |
| 3 | 10000 | 2000 | 2000 | 0.45 | 94.6% | 94.7% | 93.1% | 3.05% |
| 4 | 10000 | 2000 | 2000 | 0.1 | 98.6% | 98.6% | 98.0% | 1.49% |
