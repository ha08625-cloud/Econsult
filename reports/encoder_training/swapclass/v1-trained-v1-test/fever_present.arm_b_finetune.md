...
*Generated 2026-09-05T20:48:40+00:00.*
...
| split salt | `0` |
| dataset dir | `data/synthetic/generated/swapclass/exp-v1` |
| test dataset dir | `data/synthetic/generated/swapclass/exp-v1` |
...
| artefacts | `models/encoder-swapclass/v1-trained-v1-test/fever_present/arm_b_finetune` |
...
* **clean_share**: 0.25
* **class_groups**: []
* **rule_sources**: [{'path': 'data/expansion/fever_present.rules.json', 'sha256': '31cc52905b63dfc3695e07c77f253d7022713cfefb081a4d04de63411d47b843', 'kind': 'rules', 'signal': 'fever_present', 'count': 36}]
* **rules_count**: 36
* **changed_share**: 0.3725
* **substitutions_per_hundred_words**: {'by_label': {'true': 1.1174, 'false': 1.4938, 'null': 1.3191}, 'by_label_mode': {'true': 1.1174, 'false': 1.4938, 'null_structural': 1.2914, 'null_ambiguous': 1.3459}, 'overall': 1.3308, 'largest_by_label_gap': 0.3764}
...
* **rule_sources**: [{'path': 'data/expansion/fever_present.rules.json', 'sha256': '31cc52905b63dfc3695e07c77f253d7022713cfefb081a4d04de63411d47b843', 'kind': 'rules', 'signal': 'fever_present', 'count': 36}]
* **rules_count**: 36
* **changed_share**: 0.4375
* **substitutions_per_hundred_words**: {'by_label': {'true': 1.4156, 'false': 1.6061, 'null': 1.5417}, 'by_label_mode': {'true': 1.4156, 'false': 1.6061, 'null_structural': 1.4329, 'null_ambiguous': 1.6364}, 'overall': 1.5383, 'largest_by_label_gap': 0.1905}
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 94.3% [92.2%, 96.1%] | 93.7% [91.4%, 95.8%] | 96.0% | 96.0% +/- 2.6% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 94.9% [88.1%, 99.8%] (eff n 43) | 92.4% [85.9%, 97.6%] (eff n 63) | 95.3% [90.2%, 99.0%] (eff n 36) | 98.1% [95.1%, 99.9%] (eff n 47) | 96.1% [89.9%, 99.8%] (eff n 35) |
...
|---|---|---|
| `fever_present` | 49 | 9.0% |

### `arm_b_finetune`

Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 94.3% [92.2%, 96.1%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.25, 0.4, 0.0, 0.8, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `fever_present` | 9/9/49 | 0 | 18 | 65.6% +/- 10.7% | +/-23.1% | 67 | 81.2% +/- 4.4% | 86.9% +/- 6.1% |

`null -> true` on real text, per fold: `fever_present` 1, 4, 5, 4, 8 of 49. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 95.2% [92.9%, 97.3%] |
...
* `arm_b_finetune`: 400 errors across 54 of 463 decisive fragments. Half of them fall on **12** fragments (an even spread would be 27.0); the worst ten carry 46.2% of all errors.
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.25, 0.4, 0.8.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2350 | 65 | 64 | 2479 |
| **truth true** | 6 | 1359 | 116 | 1481 |
| **truth null** | 38 | 118 | 5884 | 6040 |
| **total** | 2394 | 1542 | 6064 | 10000 |

`null -> true`: 118 of 6040 truly-null examples (1.95%).
...
|---|---|---|---|---|
| **truth false** | 2350 | 65 | 64 | 2479 |
| **truth true** | 6 | 1358 | 117 | 1481 |
| **truth null** | 39 | 111 | 5890 | 6040 |
| **total** | 2395 | 1534 | 6071 | 10000 |

`null -> true`: 111 of 6040 truly-null examples (1.84%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2395 | 98.1% | 94.8% | 96.4% |
| `true` | 1481 | 1534 | 88.5% | 91.7% | 90.1% |
| `null` | 6040 | 6071 | 97.0% | 97.5% | 97.3% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.8% [90.6%, 98.4%] |
| null_ambiguous | 3062 | **224** | 95.2% [92.9%, 97.3%] |
| null_structural | 2978 | **1** | 99.9% [99.9%, 99.9%] |
| true | 1481 | **96** | 91.7% [86.2%, 96.6%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 94.9% [88.1%, 99.8%] |
| hedged | 828 | **63** | 92.4% [85.9%, 97.6%] |
| historical | 511 | **36** | 95.3% [90.2%, 99.0%] |
| metaphor | 641 | **47** | 98.1% [95.1%, 99.9%] |
| third_party | 508 | **35** | 96.1% [89.9%, 99.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 94.8% [90.6%, 98.4%] |
| fever_null_attribution | 574 | **43** | 94.9% [88.1%, 99.8%] |
| fever_null_hedged | 828 | **63** | 92.4% [85.9%, 97.6%] |
| fever_null_historical | 511 | **36** | 95.3% [90.2%, 99.0%] |
| fever_null_metaphor | 641 | **47** | 98.1% [95.1%, 99.9%] |
| fever_null_thirdparty | 508 | **35** | 96.1% [89.9%, 99.8%] |
| fever_true | 1481 | **96** | 91.7% [86.2%, 96.6%] |
...
| `fever_null_thirdparty:05f9c98e` | `fever_null_thirdparty` | third_party | null | 1/14 | 7.1% | true 13, null 1 |
| `fever_false:e70e24b6` | `fever_false` | -- | false | 2/27 | 7.4% | false 2, true 25 |
| `fever_true:391fb2ce` | `fever_true` | -- | true | 2/18 | 11.1% | true 2, null 16 |
| `fever_true:5ce7adbd` | `fever_true` | -- | true | 1/9 | 11.1% | true 1, null 8 |
| `fever_null_hedged:5bf1b63f` | `fever_null_hedged` | hedged | null | 2/14 | 14.3% | true 12, null 2 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 5/29 | 17.2% | false 5, true 24 |
| `fever_true:b950a4fc` | `fever_true` | -- | true | 2/11 | 18.2% | true 2, null 9 |
| `fever_null_hedged:fafa0b56` | `fever_null_hedged` | hedged | null | 3/12 | 25.0% | true 9, null 3 |
| `fever_null_metaphor:625f220a` | `fever_null_metaphor` | metaphor | null | 3/11 | 27.3% | true 8, null 3 |
| `fever_null_attribution:1eb2016b` | `fever_null_attribution` | attribution | null | 4/12 | 33.3% | false 8, null 4 |
...
| `fever_false:afdc7129` | `fever_false` | -- | false | 12/22 | 54.5% | false 12, null 10 |
| `fever_null_thirdparty:ced0319e` | `fever_null_thirdparty` | third_party | null | 6/11 | 54.5% | true 5, null 6 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 10/16 | 62.5% | false 6, true 10 |
| `fever_false:44cd09fd` | `fever_false` | -- | false | 18/28 | 64.3% | false 18, null 10 |
| `fever_null_hedged:0de4380d` | `fever_null_hedged` | hedged | null | 13/20 | 65.0% | true 7, null 13 |
| `fever_false:fc2ae0f2` | `fever_false` | -- | false | 23/34 | 67.6% | false 23, null 11 |
| `fever_null_hedged:bba323b8` | `fever_null_hedged` | hedged | null | 9/13 | 69.2% | true 4, null 9 |
| `fever_null_historical:ebfd0af7` | `fever_null_historical` | historical | null | 8/11 | 72.7% | true 3, null 8 |
| `fever_null_hedged:771b9894` | `fever_null_hedged` | hedged | null | 6/8 | 75.0% | false 2, null 6 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 11/14 | 78.6% | true 11, null 3 |
| `fever_true:2ee57e4c` | `fever_true` | -- | true | 8/10 | 80.0% | true 8, null 2 |
| `fever_null_metaphor:1cc8d971` | `fever_null_metaphor` | metaphor | null | 9/11 | 81.8% | true 2, null 9 |
| `fever_null_historical:53955b97` | `fever_null_historical` | historical | null | 11/13 | 84.6% | true 2, null 11 |
| `fever_null_historical:9920da91` | `fever_null_historical` | historical | null | 11/13 | 84.6% | true 2, null 11 |
| `fever_null_metaphor:4076133d` | `fever_null_metaphor` | metaphor | null | 6/7 | 85.7% | true 1, null 6 |
| `fever_null_thirdparty:d8bac83f` | `fever_null_thirdparty` | third_party | null | 6/7 | 85.7% | false 1, null 6 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.25 | 96.1% | 96.1% | 95.2% | 2.32% |
| 1 | 10000 | 2000 | 2000 | 0.4 | 95.3% | 95.3% | 94.0% | 1.00% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 92.2% | 92.2% | 89.0% | 2.98% |
| 3 | 10000 | 2000 | 2000 | 0.8 | 96.7% | 96.9% | 95.8% | 1.98% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 99.4% | 99.4% | 99.2% | 0.91% |
