...
*Generated 2026-09-05T21:32:28+00:00.*
...
| split salt | `0` |
| dataset dir | `data/synthetic/generated/swapclass/exp-combined` |
| test dataset dir | `data/synthetic/generated/swapclass/exp-combined` |
...
| artefacts | `models/encoder-swapclass/combined-trained-combined-test/fever_present/arm_b_finetune` |
...
* **rule_sources**: [{'path': 'data/expansion/fever_present.rules.json', 'sha256': '31cc52905b63dfc3695e07c77f253d7022713cfefb081a4d04de63411d47b843', 'kind': 'rules', 'signal': 'fever_present', 'count': 36}, {'path': 'data/expansion/classes/referent.classes.json', 'sha256': '0e88e3a6256d8753cb65b760cf8182a8a35ad6983e73d6e736a47f280e84efd4', 'kind': 'classes', 'signal': None, 'count': 252}, {'path': 'data/expansion/classes/calendar.classes.json', 'sha256': 'c02b6a68fb78730f67262f51aa5515accb388cb065e2ea0be097c803fe9f323d', 'kind': 'classes', 'signal': None, 'count': 42}, {'path': 'data/expansion/classes/setting.classes.json', 'sha256': '707164688bd143f4914c2bd557b7de09d064483b4969bac741d8400f97e6b538', 'kind': 'classes', 'signal': None, 'count': 6}]
* **rules_count**: 336
* **changed_share**: 0.4727
* **substitutions_per_hundred_words**: {'by_label': {'true': 1.6937, 'false': 2.0288, 'null': 1.942}, 'by_label_mode': {'true': 1.6937, 'false': 2.0288, 'null_structural': 1.9692, 'null_ambiguous': 1.9158}, 'overall': 1.9241, 'largest_by_label_gap': 0.3351}
...
* **rule_sources**: [{'path': 'data/expansion/fever_present.rules.json', 'sha256': '31cc52905b63dfc3695e07c77f253d7022713cfefb081a4d04de63411d47b843', 'kind': 'rules', 'signal': 'fever_present', 'count': 36}, {'path': 'data/expansion/classes/referent.classes.json', 'sha256': '0e88e3a6256d8753cb65b760cf8182a8a35ad6983e73d6e736a47f280e84efd4', 'kind': 'classes', 'signal': None, 'count': 252}, {'path': 'data/expansion/classes/calendar.classes.json', 'sha256': 'c02b6a68fb78730f67262f51aa5515accb388cb065e2ea0be097c803fe9f323d', 'kind': 'classes', 'signal': None, 'count': 42}, {'path': 'data/expansion/classes/setting.classes.json', 'sha256': '707164688bd143f4914c2bd557b7de09d064483b4969bac741d8400f97e6b538', 'kind': 'classes', 'signal': None, 'count': 6}]
* **rules_count**: 336
* **changed_share**: 0.5115
* **substitutions_per_hundred_words**: {'by_label': {'true': 1.9079, 'false': 2.1199, 'null': 2.1011}, 'by_label_mode': {'true': 1.9079, 'false': 2.1199, 'null_structural': 2.0556, 'null_ambiguous': 2.1407}, 'overall': 2.0756, 'largest_by_label_gap': 0.212}
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.4% [91.3%, 95.4%] | 92.8% [90.3%, 95.0%] | 95.4% | 95.4% +/- 2.3% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 93.4% [86.4%, 98.8%] (eff n 43) | 89.1% [81.0%, 96.1%] (eff n 63) | 97.3% [93.4%, 99.8%] (eff n 36) | 98.0% [95.0%, 100.0%] (eff n 47) | 98.6% [96.6%, 99.8%] (eff n 35) |
...
|---|---|---|
| `fever_present` | 49 | 13.1% |

### `arm_b_finetune`

Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.4% [91.3%, 95.4%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.0, 0.65, 0.3, 0.0, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `fever_present` | 9/9/49 | 0 | 18 | 73.3% +/- 9.9% | +/-23.1% | 67 | 80.3% +/- 11.8% | 82.9% +/- 17.8% |

`null -> true` on real text, per fold: `fever_present` 3, 20, 1, 4, 4 of 49. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 94.7% [92.1%, 97.1%] |
...
* `arm_b_finetune`: 462 errors across 62 of 463 decisive fragments. Half of them fall on **14** fragments (an even spread would be 31.0); the worst ten carry 39.4% of all errors.
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.3, 0.65.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2339 | 72 | 68 | 2479 |
| **truth true** | 34 | 1327 | 120 | 1481 |
| **truth null** | 78 | 89 | 5873 | 6040 |
| **total** | 2451 | 1488 | 6061 | 10000 |

`null -> true`: 89 of 6040 truly-null examples (1.47%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2340 | 69 | 70 | 2479 |
| **truth true** | 35 | 1320 | 126 | 1481 |
| **truth null** | 78 | 84 | 5878 | 6040 |
| **total** | 2453 | 1473 | 6074 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2453 | 95.4% | 94.4% | 94.9% |
| `true` | 1481 | 1473 | 89.6% | 89.1% | 89.4% |
| `null` | 6040 | 6074 | 96.8% | 97.3% | 97.0% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.4% [90.2%, 97.8%] |
| null_ambiguous | 3062 | **224** | 94.7% [92.1%, 97.1%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **96** | 89.1% [83.1%, 94.3%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 93.4% [86.4%, 98.8%] |
| hedged | 828 | **63** | 89.1% [81.0%, 96.1%] |
| historical | 511 | **36** | 97.3% [93.4%, 99.8%] |
| metaphor | 641 | **47** | 98.0% [95.0%, 100.0%] |
| third_party | 508 | **35** | 98.6% [96.6%, 99.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 94.4% [90.2%, 97.8%] |
| fever_null_attribution | 574 | **43** | 93.4% [86.4%, 98.8%] |
| fever_null_hedged | 828 | **63** | 89.1% [81.0%, 96.1%] |
| fever_null_historical | 511 | **36** | 97.3% [93.4%, 99.8%] |
| fever_null_metaphor | 641 | **47** | 98.0% [95.0%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 98.6% [96.6%, 99.8%] |
| fever_true | 1481 | **96** | 89.1% [83.1%, 94.3%] |
...
|---|---|---|---|---|---|---|
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/30 | 0.0% | true 25, null 5 |
...
| `fever_true:34ea6a85` | `fever_true` | -- | true | 0/13 | 0.0% | false 13 |
...
| `fever_true:391fb2ce` | `fever_true` | -- | true | 2/18 | 11.1% | true 2, null 16 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 2/14 | 14.3% | true 2, null 12 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 2/13 | 15.4% | true 11, null 2 |
| `fever_null_hedged:9e333f46` | `fever_null_hedged` | hedged | null | 2/10 | 20.0% | false 8, null 2 |
| `fever_true:2ee57e4c` | `fever_true` | -- | true | 3/10 | 30.0% | true 3, null 7 |
| `fever_true:ef344ff7` | `fever_true` | -- | true | 4/13 | 30.8% | true 4, null 9 |
| `fever_false:fc2ae0f2` | `fever_false` | -- | false | 11/34 | 32.4% | false 11, null 23 |
| `fever_false:e70e24b6` | `fever_false` | -- | false | 9/27 | 33.3% | false 9, true 18 |
| `fever_null_metaphor:15ab0c24` | `fever_null_metaphor` | metaphor | null | 3/9 | 33.3% | false 6, null 3 |
| `fever_true:b950a4fc` | `fever_true` | -- | true | 4/11 | 36.4% | true 4, null 7 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 11/27 | 40.7% | false 11, null 16 |
| `fever_null_attribution:1eb2016b` | `fever_null_attribution` | attribution | null | 5/12 | 41.7% | false 7, null 5 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 7/16 | 43.8% | false 9, true 7 |
| `fever_null_historical:1b314733` | `fever_null_historical` | historical | null | 4/8 | 50.0% | true 4, null 4 |
...
| `fever_null_hedged:fafa0b56` | `fever_null_hedged` | hedged | null | 7/12 | 58.3% | true 5, null 7 |
| `fever_null_hedged:771b9894` | `fever_null_hedged` | hedged | null | 5/8 | 62.5% | false 3, null 5 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 19/29 | 65.5% | false 19, true 10 |
| `fever_true:74ccf7bd` | `fever_true` | -- | true | 8/12 | 66.7% | true 8, null 4 |
| `fever_null_thirdparty:05f9c98e` | `fever_null_thirdparty` | third_party | null | 10/14 | 71.4% | true 4, null 10 |
| `fever_false:b9076eff` | `fever_false` | -- | false | 24/33 | 72.7% | false 24, null 9 |
| `fever_null_hedged:0906c944` | `fever_null_hedged` | hedged | null | 9/12 | 75.0% | false 3, null 9 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 94.8% | 94.8% | 93.5% | 0.74% |
| 1 | 10000 | 2000 | 2000 | 0.65 | 95.0% | 94.9% | 92.7% | 1.33% |
| 2 | 10000 | 2000 | 2000 | 0.3 | 92.5% | 92.5% | 90.1% | 3.15% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 95.7% | 95.7% | 94.0% | 0.91% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 99.0% | 99.0% | 98.7% | 0.83% |
