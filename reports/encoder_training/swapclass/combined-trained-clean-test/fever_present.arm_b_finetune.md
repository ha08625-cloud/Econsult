...
*Generated 2026-09-05T21:21:32+00:00.*
...
| test dataset dir | `data/synthetic/generated/swapclass/clean` |
| test dataset noise | `none -- the test tree carries no noise block` |
| test dataset expansion | `none -- the tree carries no expansion block` |
...
| artefacts | `models/encoder-swapclass/combined-trained-clean-test/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.4% [91.2%, 95.4%] | 92.8% [90.2%, 94.9%] | 95.3% | 95.3% +/- 2.2% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 93.6% [86.6%, 98.9%] (eff n 43) | 89.3% [81.1%, 96.2%] (eff n 63) | 97.5% [93.8%, 99.8%] (eff n 36) | 98.0% [95.0%, 100.0%] (eff n 47) | 97.8% [94.4%, 99.8%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.4% [91.2%, 95.4%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.0, 0.65, 0.3, 0.0, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 94.7% [92.0%, 97.0%] |
...
* `arm_b_finetune`: 464 errors across 62 of 463 decisive fragments. Half of them fall on **14** fragments (an even spread would be 31.0); the worst ten carry 40.3% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2339 | 68 | 72 | 2479 |
| **truth true** | 34 | 1326 | 121 | 1481 |
| **truth null** | 78 | 91 | 5871 | 6040 |
| **total** | 2451 | 1485 | 6064 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2340 | 65 | 74 | 2479 |
| **truth true** | 35 | 1319 | 127 | 1481 |
| **truth null** | 78 | 86 | 5876 | 6040 |
| **total** | 2453 | 1470 | 6077 | 10000 |

`null -> true`: 86 of 6040 truly-null examples (1.42%).
...
| `true` | 1481 | 1470 | 89.7% | 89.1% | 89.4% |
| `null` | 6040 | 6077 | 96.7% | 97.3% | 97.0% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.4% [90.2%, 97.9%] |
| null_ambiguous | 3062 | **224** | 94.7% [92.0%, 97.0%] |
...
|---|---|---|---|
| attribution | 574 | **43** | 93.6% [86.6%, 98.9%] |
| hedged | 828 | **63** | 89.3% [81.1%, 96.2%] |
| historical | 511 | **36** | 97.5% [93.8%, 99.8%] |
| metaphor | 641 | **47** | 98.0% [95.0%, 100.0%] |
| third_party | 508 | **35** | 97.8% [94.4%, 99.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 94.4% [90.2%, 97.9%] |
| fever_null_attribution | 574 | **43** | 93.6% [86.6%, 98.9%] |
| fever_null_hedged | 828 | **63** | 89.3% [81.1%, 96.2%] |
| fever_null_historical | 511 | **36** | 97.5% [93.8%, 99.8%] |
| fever_null_metaphor | 641 | **47** | 98.0% [95.0%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 97.8% [94.4%, 99.8%] |
...
| `fever_false:3de7ecac` | `fever_false` | -- | false | 6/27 | 22.2% | false 6, null 21 |
...
| `fever_false:e70e24b6` | `fever_false` | -- | false | 10/27 | 37.0% | false 10, true 17 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 7/16 | 43.8% | false 9, true 7 |
| `fever_null_thirdparty:05f9c98e` | `fever_null_thirdparty` | third_party | null | 7/14 | 50.0% | true 7, null 7 |
| `fever_null_attribution:1eb2016b` | `fever_null_attribution` | attribution | null | 6/12 | 50.0% | false 6, null 6 |
| `fever_true:ef344ff7` | `fever_true` | -- | true | 7/13 | 53.8% | true 7, null 6 |
...
| `fever_false:f7d03fcb` | `fever_false` | -- | false | 13/21 | 61.9% | false 13, null 8 |
| `fever_null_hedged:771b9894` | `fever_null_hedged` | hedged | null | 5/8 | 62.5% | false 3, null 5 |
| `fever_null_historical:1b314733` | `fever_null_historical` | historical | null | 5/8 | 62.5% | true 3, null 5 |
| `fever_false:b9076eff` | `fever_false` | -- | false | 23/33 | 69.7% | false 23, null 10 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 22/29 | 75.9% | false 22, true 7 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 94.3% | 94.3% | 92.9% | 0.91% |
| 1 | 10000 | 2000 | 2000 | 0.65 | 95.0% | 94.8% | 92.6% | 1.33% |
| 2 | 10000 | 2000 | 2000 | 0.3 | 92.9% | 93.0% | 90.7% | 3.15% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 95.7% | 95.7% | 94.0% | 0.82% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 98.9% | 98.9% | 98.7% | 0.91% |
