...
*Generated 2026-09-05T20:37:42+00:00.*
...
| artefacts | `models/encoder-swapclass/v1-trained-clean-test/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 94.5% [92.4%, 96.3%] | 93.9% [91.6%, 95.9%] | 96.1% | 96.1% +/- 2.7% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 94.8% [87.8%, 99.8%] (eff n 43) | 92.5% [86.0%, 97.7%] (eff n 63) | 96.5% [91.7%, 99.8%] (eff n 36) | 98.1% [95.1%, 99.9%] (eff n 47) | 96.3% [90.4%, 99.8%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 94.5% [92.4%, 96.3%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.25, 0.4, 0.0, 0.8, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 95.4% [93.2%, 97.5%] |
...
* `arm_b_finetune`: 387 errors across 52 of 463 decisive fragments. Half of them fall on **11** fragments (an even spread would be 26.0); the worst ten carry 47.3% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2359 | 62 | 58 | 2479 |
| **truth true** | 6 | 1356 | 119 | 1481 |
| **truth null** | 37 | 112 | 5891 | 6040 |
| **total** | 2402 | 1530 | 6068 | 10000 |

`null -> true`: 112 of 6040 truly-null examples (1.85%).
...
|---|---|---|---|---|
| **truth false** | 2359 | 62 | 58 | 2479 |
| **truth true** | 6 | 1355 | 120 | 1481 |
| **truth null** | 38 | 105 | 5897 | 6040 |
| **total** | 2403 | 1522 | 6075 | 10000 |

`null -> true`: 105 of 6040 truly-null examples (1.74%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2403 | 98.2% | 95.2% | 96.6% |
| `true` | 1481 | 1522 | 89.0% | 91.5% | 90.2% |
| `null` | 6040 | 6075 | 97.1% | 97.6% | 97.4% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 95.2% [91.0%, 98.6%] |
| null_ambiguous | 3062 | **224** | 95.4% [93.2%, 97.5%] |
| null_structural | 2978 | **1** | 99.9% [99.9%, 99.9%] |
| true | 1481 | **96** | 91.5% [86.0%, 96.5%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 94.8% [87.8%, 99.8%] |
| hedged | 828 | **63** | 92.5% [86.0%, 97.7%] |
| historical | 511 | **36** | 96.5% [91.7%, 99.8%] |
| metaphor | 641 | **47** | 98.1% [95.1%, 99.9%] |
| third_party | 508 | **35** | 96.3% [90.4%, 99.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 95.2% [91.0%, 98.6%] |
| fever_null_attribution | 574 | **43** | 94.8% [87.8%, 99.8%] |
| fever_null_hedged | 828 | **63** | 92.5% [86.0%, 97.7%] |
| fever_null_historical | 511 | **36** | 96.5% [91.7%, 99.8%] |
| fever_null_metaphor | 641 | **47** | 98.1% [95.1%, 99.9%] |
| fever_null_thirdparty | 508 | **35** | 96.3% [90.4%, 99.8%] |
| fever_true | 1481 | **96** | 91.5% [86.0%, 96.5%] |
...
52 of 463 decisive fragments were got wrong at least once.
...
| `fever_false:e70e24b6` | `fever_false` | -- | false | 1/27 | 3.7% | false 1, true 26 |
...
| `fever_false:3a3043ff` | `fever_false` | -- | false | 9/29 | 31.0% | false 9, true 20 |
| `fever_null_attribution:1eb2016b` | `fever_null_attribution` | attribution | null | 4/12 | 33.3% | false 8, null 4 |
| `fever_false:afdc7129` | `fever_false` | -- | false | 9/22 | 40.9% | false 9, null 13 |
...
| `fever_null_thirdparty:ced0319e` | `fever_null_thirdparty` | third_party | null | 7/11 | 63.6% | true 4, null 7 |
...
| `fever_null_hedged:17a3f60a` | `fever_null_hedged` | hedged | null | 7/9 | 77.8% | true 2, null 7 |
...
| `fever_null_hedged:771b9894` | `fever_null_hedged` | hedged | null | 7/8 | 87.5% | false 1, null 7 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 24/27 | 88.9% | false 24, null 3 |
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | hedged | null | 8/9 | 88.9% | true 1, null 8 |

*12 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.25 | 96.8% | 96.8% | 96.0% | 2.07% |
| 1 | 10000 | 2000 | 2000 | 0.4 | 95.2% | 95.2% | 93.8% | 1.00% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 92.2% | 92.2% | 89.0% | 2.98% |
| 3 | 10000 | 2000 | 2000 | 0.8 | 96.9% | 97.0% | 96.0% | 1.73% |
