...
*Generated 2026-09-05T20:26:46+00:00.*
...
| artefacts | `models/encoder-swapclass/clean-trained-affect-test/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.3% [91.2%, 95.2%] | 92.6% [90.3%, 94.8%] | 95.3% | 95.3% +/- 3.0% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 93.0% [85.3%, 98.6%] (eff n 43) | 86.8% [78.5%, 94.2%] (eff n 63) | 95.7% [90.3%, 100.0%] (eff n 36) | 99.4% [97.9%, 100.0%] (eff n 47) | 97.0% [91.5%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.3% [91.2%, 95.2%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.55, 0.0, 0.45, 0.1. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
* `arm_b_finetune`: 473 errors across 54 of 463 decisive fragments. Half of them fall on **14** fragments (an even spread would be 27.0); the worst ten carry 39.1% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2337 | 62 | 80 | 2479 |
| **truth true** | 12 | 1344 | 125 | 1481 |
| **truth null** | 44 | 155 | 5841 | 6040 |
| **total** | 2393 | 1561 | 6046 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2394 | 97.6% | 94.3% | 95.9% |
| `true` | 1481 | 1547 | 86.6% | 90.5% | 88.5% |
| `null` | 6040 | 6059 | 96.5% | 96.8% | 96.7% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.3% [89.9%, 97.8%] |
...
| metaphor | 641 | **47** | 99.4% [97.9%, 100.0%] |
...
|---|---|---|---|
| fever_false | 2479 | **98** | 94.3% [89.9%, 97.8%] |
...
| fever_null_metaphor | 641 | **47** | 99.4% [97.9%, 100.0%] |
...
| `fever_false:de0596c4` | `fever_false` | -- | false | 16/31 | 51.6% | false 16, null 15 |
...
| `fever_false:afdc7129` | `fever_false` | -- | false | 14/22 | 63.6% | false 14, null 8 |
| `fever_null_metaphor:625f220a` | `fever_null_metaphor` | metaphor | null | 7/11 | 63.6% | true 4, null 7 |
...
| 1 | 10000 | 2000 | 2000 | 0.55 | 93.2% | 93.2% | 91.0% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 91.8% | 91.8% | 88.7% | 4.14% |
| 3 | 10000 | 2000 | 2000 | 0.45 | 94.8% | 94.9% | 93.4% | 2.72% |
| 4 | 10000 | 2000 | 2000 | 0.1 | 98.8% | 98.9% | 98.4% | 1.33% |
