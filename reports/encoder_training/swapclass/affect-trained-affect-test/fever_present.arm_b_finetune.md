...
*Generated 2026-09-05T21:54:22+00:00.*
...
| split salt | `0` |
| dataset dir | `data/synthetic/generated/swapclass/exp-affect` |
| test dataset dir | `data/synthetic/generated/swapclass/exp-affect` |
...
| artefacts | `models/encoder-swapclass/affect-trained-affect-test/fever_present/arm_b_finetune` |
...
* **clean_share**: 0.25
* **class_groups**: ['affect']
* **rule_sources**: [{'path': 'data/expansion/classes/affect.classes.json', 'sha256': '1b99cdd8736f613003904fab7f2b910467d8644a1a89e6f9495c986382565dea', 'kind': 'classes', 'signal': None, 'count': 20}]
* **rules_count**: 20
* **changed_share**: 0.0724
* **substitutions_per_hundred_words**: {'by_label': {'true': 0.153, 'false': 0.1636, 'null': 0.2389}, 'by_label_mode': {'true': 0.153, 'false': 0.1636, 'null_structural': 0.3069, 'null_ambiguous': 0.1735}, 'overall': 0.2062, 'largest_by_label_gap': 0.0859}
...
* **rules_count**: 20
* **changed_share**: 0.061
* **substitutions_per_hundred_words**: {'by_label': {'true': 0.16, 'false': 0.1608, 'null': 0.1658}, 'by_label_mode': {'true': 0.16, 'false': 0.1608, 'null_structural': 0.1976, 'null_ambiguous': 0.1382}, 'overall': 0.1636, 'largest_by_label_gap': 0.0058}
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.4% [91.2%, 95.5%] | 92.6% [90.0%, 95.1%] | 95.4% | 95.4% +/- 3.1% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 95.6% [91.1%, 99.2%] (eff n 43) | 93.0% [85.8%, 98.1%] (eff n 63) | 96.5% [91.7%, 99.8%] (eff n 36) | 99.4% [98.0%, 100.0%] (eff n 47) | 99.8% [99.3%, 100.0%] (eff n 35) |
...
|---|---|---|
| `fever_present` | 49 | 18.4% |

### `arm_b_finetune`

Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.4% [91.2%, 95.5%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.85, 0.9, 0.0, 0.9, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `fever_present` | 9/9/49 | 0 | 18 | 71.1% +/- 4.6% | +/-23.1% | 67 | 75.8% +/- 11.9% | 77.6% +/- 16.8% |

`null -> true` on real text, per fold: `fever_present` 9, 20, 7, 0, 9 of 49. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 96.5% [94.5%, 98.3%] |
...
* `arm_b_finetune`: 460 errors across 57 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 28.5); the worst ten carry 44.1% of all errors.
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.85, 0.9.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2319 | 90 | 70 | 2479 |
| **truth true** | 0 | 1311 | 170 | 1481 |
| **truth null** | 30 | 93 | 5917 | 6040 |
| **total** | 2349 | 1494 | 6157 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2319 | 89 | 71 | 2479 |
| **truth true** | 0 | 1287 | 194 | 1481 |
| **truth null** | 30 | 76 | 5934 | 6040 |
| **total** | 2349 | 1452 | 6199 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2349 | 98.7% | 93.5% | 96.1% |
| `true` | 1481 | 1452 | 88.6% | 86.9% | 87.8% |
| `null` | 6040 | 6199 | 95.7% | 98.2% | 97.0% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 93.5% [88.7%, 97.4%] |
| null_ambiguous | 3062 | **224** | 96.5% [94.5%, 98.3%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **96** | 86.9% [80.5%, 93.0%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 95.6% [91.1%, 99.2%] |
| hedged | 828 | **63** | 93.0% [85.8%, 98.1%] |
| historical | 511 | **36** | 96.5% [91.7%, 99.8%] |
| metaphor | 641 | **47** | 99.4% [98.0%, 100.0%] |
...
|---|---|---|---|
| fever_false | 2479 | **98** | 93.5% [88.7%, 97.4%] |
| fever_null_attribution | 574 | **43** | 95.6% [91.1%, 99.2%] |
| fever_null_hedged | 828 | **63** | 93.0% [85.8%, 98.1%] |
| fever_null_historical | 511 | **36** | 96.5% [91.7%, 99.8%] |
| fever_null_metaphor | 641 | **47** | 99.4% [98.0%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 99.8% [99.3%, 100.0%] |
| fever_true | 1481 | **96** | 86.9% [80.5%, 93.0%] |
...
57 of 463 decisive fragments were got wrong at least once.

`arm_b_finetune`: 460 errors across 57 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 28.5); the worst ten carry 44.1% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/30 | 0.0% | true 17, null 13 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 0/29 | 0.0% | true 29 |
| `fever_false:e70e24b6` | `fever_false` | -- | false | 0/27 | 0.0% | true 27 |
...
| `fever_true:872e3af9` | `fever_true` | -- | true | 1/12 | 8.3% | true 1, null 11 |
...
| `fever_true:d00c307b` | `fever_true` | -- | true | 3/14 | 21.4% | true 3, null 11 |
| `fever_true:5ce7adbd` | `fever_true` | -- | true | 2/9 | 22.2% | true 2, null 7 |
| `fever_null_attribution:dba8c443` | `fever_null_attribution` | attribution | null | 3/11 | 27.3% | false 8, null 3 |
| `fever_true:c5d3e4a0` | `fever_true` | -- | true | 4/12 | 33.3% | true 4, null 8 |
...
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 6/13 | 46.2% | true 7, null 6 |
| `fever_true:dd7a11e2` | `fever_true` | -- | true | 5/10 | 50.0% | true 5, null 5 |
| `fever_true:15a05d92` | `fever_true` | -- | true | 13/24 | 54.2% | true 13, null 11 |
...
| `fever_null_attribution:9b15a5f9` | `fever_null_attribution` | attribution | null | 6/9 | 66.7% | true 3, null 6 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 19/27 | 70.4% | false 19, null 8 |
| `fever_false:ebac5db7` | `fever_false` | -- | false | 18/24 | 75.0% | false 18, null 6 |
| `fever_false:f7d03fcb` | `fever_false` | -- | false | 16/21 | 76.2% | false 16, null 5 |
| `fever_null_hedged:bba323b8` | `fever_null_hedged` | hedged | null | 10/13 | 76.9% | true 3, null 10 |
| `fever_null_hedged:b8236158` | `fever_null_hedged` | hedged | null | 7/9 | 77.8% | true 2, null 7 |
| `fever_false:0cc191ec` | `fever_false` | -- | false | 18/23 | 78.3% | false 18, null 5 |

*17 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.85 | 97.7% | 97.5% | 96.9% | 0.83% |
| 1 | 10000 | 2000 | 2000 | 0.9 | 92.7% | 92.7% | 89.1% | 1.25% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 91.8% | 91.8% | 88.7% | 2.40% |
| 3 | 10000 | 2000 | 2000 | 0.9 | 95.9% | 95.7% | 94.0% | 1.07% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 99.2% | 99.2% | 99.1% | 0.75% |
