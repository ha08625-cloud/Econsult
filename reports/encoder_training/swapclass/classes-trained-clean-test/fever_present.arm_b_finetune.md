...
*Generated 2026-09-05T20:59:37+00:00.*
...
| artefacts | `models/encoder-swapclass/classes-trained-clean-test/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 94.2% [92.3%, 96.0%] | 93.5% [91.3%, 95.5%] | 95.9% | 95.9% +/- 3.1% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 95.6% [89.8%, 99.7%] (eff n 43) | 88.0% [79.7%, 95.0%] (eff n 63) | 97.8% [94.3%, 99.8%] (eff n 36) | 98.9% [97.2%, 99.9%] (eff n 47) | 99.8% [99.4%, 100.0%] (eff n 35) |
...
* `arm_b_finetune`: 405 errors across 60 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 30.0); the worst ten carry 42.5% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2404 | 51 | 24 | 2479 |
| **truth true** | 18 | 1295 | 168 | 1481 |
| **truth null** | 66 | 85 | 5889 | 6040 |
| **total** | 2488 | 1431 | 6081 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2404 | 49 | 26 | 2479 |
| **truth true** | 18 | 1294 | 169 | 1481 |
| **truth null** | 66 | 84 | 5890 | 6040 |
| **total** | 2488 | 1427 | 6085 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2488 | 96.6% | 97.0% | 96.8% |
| `true` | 1481 | 1427 | 90.7% | 87.4% | 89.0% |
| `null` | 6040 | 6085 | 96.8% | 97.5% | 97.2% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 97.0% [93.7%, 99.2%] |
| null_ambiguous | 3062 | **224** | 95.3% [92.7%, 97.6%] |
| null_structural | 2978 | **1** | 99.8% [99.8%, 99.8%] |
| true | 1481 | **96** | 87.4% [81.0%, 93.2%] |
...
|---|---|---|---|
| fever_false | 2479 | **98** | 97.0% [93.7%, 99.2%] |
| fever_null_attribution | 574 | **43** | 95.6% [89.8%, 99.7%] |
| fever_null_hedged | 828 | **63** | 88.0% [79.7%, 95.0%] |
...
| fever_true | 1481 | **96** | 87.4% [81.0%, 93.2%] |
...
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | hedged | null | 7/9 | 77.8% | true 2, null 7 |
...
| 1 | 10000 | 2000 | 2000 | 0.9 | 93.2% | 93.2% | 90.1% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 92.3% | 92.3% | 89.5% | 3.81% |
