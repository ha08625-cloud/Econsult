...
*Generated 2026-09-05T20:04:51+00:00.*
...
| artefacts | `models/encoder-swapclass/clean-trained-classes-test/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.4% [91.2%, 95.3%] | 92.7% [90.4%, 94.9%] | 95.3% | 95.3% +/- 2.9% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 93.4% [85.8%, 98.9%] (eff n 43) | 86.6% [78.1%, 94.0%] (eff n 63) | 95.5% [89.8%, 100.0%] (eff n 36) | 99.2% [97.4%, 100.0%] (eff n 47) | 97.6% [93.4%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.4% [91.2%, 95.3%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.55, 0.0, 0.45, 0.1. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
* `arm_b_finetune`: 466 errors across 53 of 463 decisive fragments. Half of them fall on **14** fragments (an even spread would be 26.5); the worst ten carry 39.5% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2343 | 62 | 74 | 2479 |
| **truth true** | 12 | 1344 | 125 | 1481 |
| **truth null** | 44 | 153 | 5843 | 6040 |
| **total** | 2399 | 1559 | 6042 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2343 | 61 | 75 | 2479 |
| **truth true** | 12 | 1340 | 129 | 1481 |
| **truth null** | 45 | 145 | 5850 | 6040 |
| **total** | 2400 | 1546 | 6054 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2400 | 97.6% | 94.5% | 96.0% |
| `true` | 1481 | 1546 | 86.7% | 90.5% | 88.5% |
| `null` | 6040 | 6054 | 96.6% | 96.9% | 96.7% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.5% [90.2%, 97.9%] |
...
| hedged | 828 | **63** | 86.6% [78.1%, 94.0%] |
| historical | 511 | **36** | 95.5% [89.8%, 100.0%] |
| metaphor | 641 | **47** | 99.2% [97.4%, 100.0%] |
| third_party | 508 | **35** | 97.6% [93.4%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 94.5% [90.2%, 97.9%] |
| fever_null_attribution | 574 | **43** | 93.4% [85.8%, 98.9%] |
| fever_null_hedged | 828 | **63** | 86.6% [78.1%, 94.0%] |
| fever_null_historical | 511 | **36** | 95.5% [89.8%, 100.0%] |
| fever_null_metaphor | 641 | **47** | 99.2% [97.4%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 97.6% [93.4%, 100.0%] |
...
53 of 463 decisive fragments were got wrong at least once.
...
| `fever_null_hedged:0906c944` | `fever_null_hedged` | hedged | null | 3/12 | 25.0% | false 2, true 7, null 3 |
...
| `fever_null_historical:9920da91` | `fever_null_historical` | historical | null | 6/13 | 46.2% | true 7, null 6 |
| `fever_null_metaphor:625f220a` | `fever_null_metaphor` | metaphor | null | 6/11 | 54.5% | true 5, null 6 |
| `fever_null_hedged:917d0e09` | `fever_null_hedged` | hedged | null | 7/12 | 58.3% | true 5, null 7 |
...
| `fever_false:de0596c4` | `fever_false` | -- | false | 21/31 | 67.7% | false 21, null 10 |
| `fever_false:afdc7129` | `fever_false` | -- | false | 15/22 | 68.2% | false 15, null 7 |

*13 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.55 | 97.5% | 97.7% | 97.1% | 2.65% |
| 1 | 10000 | 2000 | 2000 | 0.55 | 93.5% | 93.5% | 91.3% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 91.8% | 91.8% | 88.8% | 4.22% |
| 3 | 10000 | 2000 | 2000 | 0.45 | 94.8% | 94.8% | 93.2% | 2.72% |
| 4 | 10000 | 2000 | 2000 | 0.1 | 98.9% | 98.9% | 98.4% | 1.24% |
