...
*Generated 2026-09-05T19:53:55+00:00.*
...
| artefacts | `models/encoder-swapclass/clean-trained-v1-test/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.1% [90.9%, 95.0%] | 92.4% [90.1%, 94.6%] | 95.1% | 95.1% +/- 2.8% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 93.0% [85.3%, 98.6%] (eff n 43) | 85.7% [77.2%, 93.3%] (eff n 63) | 93.2% [86.7%, 98.2%] (eff n 36) | 99.2% [97.4%, 100.0%] (eff n 47) | 95.5% [89.6%, 99.4%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.1% [90.9%, 95.0%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.55, 0.0, 0.45, 0.1. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 92.8% [89.8%, 95.5%] |
...
* `arm_b_finetune`: 486 errors across 66 of 463 decisive fragments. Half of them fall on **16** fragments (an even spread would be 33.0); the worst ten carry 37.9% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2343 | 65 | 71 | 2479 |
| **truth true** | 13 | 1356 | 112 | 1481 |
| **truth null** | 49 | 177 | 5814 | 6040 |
| **total** | 2405 | 1598 | 5997 | 10000 |

`null -> true`: 177 of 6040 truly-null examples (2.93%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2344 | 63 | 72 | 2479 |
| **truth true** | 13 | 1351 | 117 | 1481 |
| **truth null** | 50 | 172 | 5818 | 6040 |
| **total** | 2407 | 1586 | 6007 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2407 | 97.4% | 94.6% | 95.9% |
| `true` | 1481 | 1586 | 85.2% | 91.2% | 88.1% |
| `null` | 6040 | 6007 | 96.9% | 96.3% | 96.6% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.6% [90.2%, 98.0%] |
| null_ambiguous | 3062 | **224** | 92.8% [89.8%, 95.5%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **96** | 91.2% [86.0%, 95.8%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 93.0% [85.3%, 98.6%] |
| hedged | 828 | **63** | 85.7% [77.2%, 93.3%] |
| historical | 511 | **36** | 93.2% [86.7%, 98.2%] |
| metaphor | 641 | **47** | 99.2% [97.4%, 100.0%] |
| third_party | 508 | **35** | 95.5% [89.6%, 99.4%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 94.6% [90.2%, 98.0%] |
| fever_null_attribution | 574 | **43** | 93.0% [85.3%, 98.6%] |
| fever_null_hedged | 828 | **63** | 85.7% [77.2%, 93.3%] |
| fever_null_historical | 511 | **36** | 93.2% [86.7%, 98.2%] |
| fever_null_metaphor | 641 | **47** | 99.2% [97.4%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 95.5% [89.6%, 99.4%] |
| fever_true | 1481 | **96** | 91.2% [86.0%, 95.8%] |
...
66 of 463 decisive fragments were got wrong at least once.
...
| `fever_null_historical:ebfd0af7` | `fever_null_historical` | historical | null | 7/11 | 63.6% | true 4, null 7 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.55 | 96.8% | 96.8% | 96.1% | 3.97% |
| 1 | 10000 | 2000 | 2000 | 0.55 | 94.1% | 94.0% | 92.2% | 1.33% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 91.5% | 91.5% | 88.2% | 4.47% |
| 3 | 10000 | 2000 | 2000 | 0.45 | 94.7% | 94.8% | 93.2% | 2.96% |
| 4 | 10000 | 2000 | 2000 | 0.1 | 98.6% | 98.7% | 98.1% | 1.49% |
