...
*Generated 2026-09-05T21:10:33+00:00.*
...
| split salt | `0` |
| dataset dir | `data/synthetic/generated/swapclass/exp-classes` |
| test dataset dir | `data/synthetic/generated/swapclass/exp-classes` |
| test dataset noise | `none -- the test tree carries no noise block` |
...
| artefacts | `models/encoder-swapclass/classes-trained-classes-test/fever_present/arm_b_finetune` |
...
* **source_dir**: data/synthetic/generated/swapclass/clean
* **seed**: 42
* **requested_rate**: 0.4
* **clean_share**: 0.25
* **class_groups**: ['referent', 'calendar', 'setting']
* **rule_sources**: [{'path': 'data/expansion/classes/referent.classes.json', 'sha256': '0e88e3a6256d8753cb65b760cf8182a8a35ad6983e73d6e736a47f280e84efd4', 'kind': 'classes', 'signal': None, 'count': 252}, {'path': 'data/expansion/classes/calendar.classes.json', 'sha256': 'c02b6a68fb78730f67262f51aa5515accb388cb065e2ea0be097c803fe9f323d', 'kind': 'classes', 'signal': None, 'count': 42}, {'path': 'data/expansion/classes/setting.classes.json', 'sha256': '707164688bd143f4914c2bd557b7de09d064483b4969bac741d8400f97e6b538', 'kind': 'classes', 'signal': None, 'count': 6}]
* **rules_count**: 300
* **changed_share**: 0.1935
* **substitutions_per_hundred_words**: {'by_label': {'true': 0.6084, 'false': 0.5352, 'null': 0.6325}, 'by_label_mode': {'true': 0.6084, 'false': 0.5352, 'null_structural': 0.6828, 'null_ambiguous': 0.584}, 'overall': 0.6041, 'largest_by_label_gap': 0.0973}
...
* **rule_sources**: [{'path': 'data/expansion/classes/referent.classes.json', 'sha256': '0e88e3a6256d8753cb65b760cf8182a8a35ad6983e73d6e736a47f280e84efd4', 'kind': 'classes', 'signal': None, 'count': 252}, {'path': 'data/expansion/classes/calendar.classes.json', 'sha256': 'c02b6a68fb78730f67262f51aa5515accb388cb065e2ea0be097c803fe9f323d', 'kind': 'classes', 'signal': None, 'count': 42}, {'path': 'data/expansion/classes/setting.classes.json', 'sha256': '707164688bd143f4914c2bd557b7de09d064483b4969bac741d8400f97e6b538', 'kind': 'classes', 'signal': None, 'count': 6}]
* **rules_count**: 300
* **changed_share**: 0.1805
* **substitutions_per_hundred_words**: {'by_label': {'true': 0.4633, 'false': 0.5135, 'null': 0.5758}, 'by_label_mode': {'true': 0.4633, 'false': 0.5135, 'null_structural': 0.6602, 'null_ambiguous': 0.5026}, 'overall': 0.5423, 'largest_by_label_gap': 0.1125}
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 94.2% [92.3%, 96.0%] | 93.5% [91.3%, 95.5%] | 95.9% | 95.9% +/- 3.2% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 95.6% [89.8%, 99.7%] (eff n 43) | 88.0% [79.6%, 95.0%] (eff n 63) | 97.8% [94.3%, 99.8%] (eff n 36) | 98.9% [97.2%, 99.9%] (eff n 47) | 99.8% [99.4%, 100.0%] (eff n 35) |
...
|---|---|---|
| `fever_present` | 49 | 27.8% |

### `arm_b_finetune`

Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 94.2% [92.3%, 96.0%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.0, 0.9, 0.0, 0.25, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `fever_present` | 9/9/49 | 0 | 18 | 76.7% +/- 8.2% | +/-23.1% | 67 | 69.9% +/- 11.0% | 67.3% +/- 15.9% |

`null -> true` on real text, per fold: `fever_present` 5, 24, 16, 12, 11 of 49. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 95.3% [92.7%, 97.6%] |
...
* `arm_b_finetune`: 406 errors across 59 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 29.5); the worst ten carry 42.4% of all errors.
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.25, 0.9.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2405 | 51 | 23 | 2479 |
| **truth true** | 18 | 1294 | 169 | 1481 |
| **truth null** | 66 | 85 | 5889 | 6040 |
| **total** | 2489 | 1430 | 6081 | 10000 |

`null -> true`: 85 of 6040 truly-null examples (1.41%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2405 | 49 | 25 | 2479 |
| **truth true** | 18 | 1292 | 171 | 1481 |
| **truth null** | 66 | 84 | 5890 | 6040 |
| **total** | 2489 | 1425 | 6086 | 10000 |

`null -> true`: 84 of 6040 truly-null examples (1.39%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2489 | 96.6% | 97.0% | 96.8% |
| `true` | 1481 | 1425 | 90.7% | 87.2% | 88.9% |
| `null` | 6040 | 6086 | 96.8% | 97.5% | 97.1% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 97.0% [93.7%, 99.3%] |
| null_ambiguous | 3062 | **224** | 95.3% [92.7%, 97.6%] |
| null_structural | 2978 | **1** | 99.8% [99.8%, 99.8%] |
| true | 1481 | **96** | 87.2% [80.9%, 93.1%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 95.6% [89.8%, 99.7%] |
| hedged | 828 | **63** | 88.0% [79.6%, 95.0%] |
| historical | 511 | **36** | 97.8% [94.3%, 99.8%] |
| metaphor | 641 | **47** | 98.9% [97.2%, 99.9%] |
...
|---|---|---|---|
| fever_false | 2479 | **98** | 97.0% [93.7%, 99.3%] |
| fever_null_attribution | 574 | **43** | 95.6% [89.8%, 99.7%] |
| fever_null_hedged | 828 | **63** | 88.0% [79.6%, 95.0%] |
| fever_null_historical | 511 | **36** | 97.8% [94.3%, 99.8%] |
| fever_null_metaphor | 641 | **47** | 98.9% [97.2%, 99.9%] |
| fever_null_thirdparty | 508 | **35** | 99.8% [99.4%, 100.0%] |
| fever_true | 1481 | **96** | 87.2% [80.9%, 93.1%] |
...
59 of 463 decisive fragments were got wrong at least once.

`arm_b_finetune`: 406 errors across 59 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 29.5); the worst ten carry 42.4% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/30 | 0.0% | true 20, null 10 |
...
| `fever_true:db1acb55` | `fever_true` | -- | true | 0/16 | 0.0% | false 16 |
...
| `fever_null_hedged:9e333f46` | `fever_null_hedged` | hedged | null | 1/10 | 10.0% | false 9, null 1 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 1/10 | 10.0% | true 1, null 9 |
| `fever_null_hedged:60bffa1a` | `fever_null_hedged` | hedged | null | 1/8 | 12.5% | true 7, null 1 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 2/13 | 15.4% | true 11, null 2 |
| `fever_true:c7489e90` | `fever_true` | -- | true | 3/19 | 15.8% | true 3, null 16 |
| `fever_null_attribution:dba8c443` | `fever_null_attribution` | attribution | null | 2/11 | 18.2% | false 9, null 2 |
| `fever_true:2ee57e4c` | `fever_true` | -- | true | 2/10 | 20.0% | true 2, null 8 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 4/14 | 28.6% | true 4, null 10 |
| `fever_null_metaphor:15ab0c24` | `fever_null_metaphor` | metaphor | null | 5/9 | 55.6% | false 4, null 5 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 12/19 | 63.2% | true 12, null 7 |
| `fever_null_hedged:2f76e581` | `fever_null_hedged` | hedged | null | 7/11 | 63.6% | false 1, true 3, null 7 |
| `fever_false:f7d03fcb` | `fever_false` | -- | false | 14/21 | 66.7% | false 14, null 7 |
| `fever_null_hedged:17a3f60a` | `fever_null_hedged` | hedged | null | 6/9 | 66.7% | true 3, null 6 |
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | hedged | null | 6/9 | 66.7% | true 3, null 6 |
| `fever_null_attribution:eb9e8ecd` | `fever_null_attribution` | attribution | null | 8/11 | 72.7% | false 3, null 8 |
| `fever_null_hedged:fafa0b56` | `fever_null_hedged` | hedged | null | 9/12 | 75.0% | true 3, null 9 |
| `fever_true:74ccf7bd` | `fever_true` | -- | true | 9/12 | 75.0% | true 9, null 3 |
| `fever_null_hedged:771b9894` | `fever_null_hedged` | hedged | null | 6/8 | 75.0% | false 2, null 6 |
| `fever_true:76170ee2` | `fever_true` | -- | true | 19/25 | 76.0% | true 19, null 6 |
| `fever_false:e70e24b6` | `fever_false` | -- | false | 21/27 | 77.8% | false 21, true 6 |
| `fever_true:15a05d92` | `fever_true` | -- | true | 19/24 | 79.2% | true 19, null 5 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 23/29 | 79.3% | false 23, true 6 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 22/27 | 81.5% | false 22, null 5 |
| `fever_true:872e3af9` | `fever_true` | -- | true | 10/12 | 83.3% | true 10, null 2 |

*19 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 98.8% | 98.8% | 98.5% | 0.08% |
| 1 | 10000 | 2000 | 2000 | 0.9 | 93.3% | 93.2% | 90.1% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 92.2% | 92.2% | 89.5% | 3.81% |
| 3 | 10000 | 2000 | 2000 | 0.25 | 95.8% | 95.8% | 94.4% | 1.73% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 99.3% | 99.3% | 99.0% | 0.17% |
