...
*Generated 2026-08-19T20:32:24+00:00.*
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune@Arm0_control` | finetune | 7015 | **243** | 98.1% [96.4%, 99.5%] | 97.8% [95.8%, 99.5%] | 98.6% | 98.6% +/- 1.7% |
| `arm_b_finetune@ArmC_remargined` | finetune | 7015 | **243** | 98.2% [96.6%, 99.6%] | 98.0% [96.0%, 99.6%] | 98.7% | 98.7% +/- 1.8% |
| `arm_b_finetune@ArmP_companions` | finetune | 7015 | **243** | 96.4% [93.7%, 98.5%] | 96.3% [93.5%, 98.5%] | 97.2% | 97.2% +/- 3.1% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune@Arm0_control` | -- | -- | 97.6% [93.8%, 100.0%] (eff n 53) | 99.9% [99.6%, 100.0%] (eff n 40) | -- | 99.8% [99.5%, 100.0%] (eff n 47) |
| `arm_b_finetune@ArmC_remargined` | -- | -- | 97.6% [93.8%, 100.0%] (eff n 53) | 99.9% [99.6%, 100.0%] (eff n 40) | -- | 99.8% [99.5%, 100.0%] (eff n 47) |
| `arm_b_finetune@ArmP_companions` | -- | -- | 97.3% [93.6%, 99.7%] (eff n 53) | 99.5% [99.0%, 99.9%] (eff n 40) | -- | 99.8% [99.5%, 100.0%] (eff n 47) |
...
`arm_b_finetune@Arm0_control` ahead on 0 folds, `arm_b_finetune@ArmC_remargined` on 2. `null -> true` mean: 87.5% against 85.3% -- **+2.3 points** in favour of `arm_b_finetune@ArmC_remargined`.
...
`arm_b_finetune@Arm0_control` ahead on 0 folds, `arm_b_finetune@ArmP_companions` on 5. `null -> true` mean: 87.5% against 17.7% -- **+69.8 points** in favour of `arm_b_finetune@ArmP_companions`.
...
`arm_b_finetune@ArmC_remargined` ahead on 0 folds, `arm_b_finetune@ArmP_companions` on 5. `null -> true` mean: 85.3% against 17.7% -- **+67.5 points** in favour of `arm_b_finetune@ArmP_companions`.
...
|---|---|---|---|---|
| `arm_b_finetune@Arm0_control` | finetune | 3000 | **140** | 99.0% [97.4%, 100.0%] |
| `arm_b_finetune@ArmC_remargined` | finetune | 3000 | **140** | 99.0% [97.4%, 100.0%] |
| `arm_b_finetune@ArmP_companions` | finetune | 3000 | **140** | 98.7% [97.3%, 99.7%] |
...
* `arm_b_finetune@Arm0_control`: 133 errors across 10 of 243 decisive fragments. Half of them fall on **2** fragments (an even spread would be 5.0); the worst ten carry 100.0% of all errors.
* `arm_b_finetune@ArmC_remargined`: 123 errors across 11 of 243 decisive fragments. Half of them fall on **2** fragments (an even spread would be 5.5); the worst ten carry 99.2% of all errors.
* `arm_b_finetune@ArmP_companions`: 251 errors across 29 of 243 decisive fragments. Half of them fall on **3** fragments (an even spread would be 14.5); the worst ten carry 92.0% of all errors.
...
|---|---|---|---|---|---|
| `flank_pain_false` | 2395 | 99.0% | 99.6% | 93.0% | 6.6pp |
| `flank_pain_true` | 1620 | 95.1% | 94.9% | 97.2% | 2.3pp |
| `flank_pain_null_hedged` | 1166 | 97.6% | 97.6% | 97.3% | 0.4pp |
| `(none)` | 2985 | 99.8% | 99.8% | 99.2% | 0.6pp |
| `flank_pain_null_historical` | 809 | 99.9% | 99.9% | 99.5% | 0.4pp |
| `flank_pain_null_thirdparty` | 1025 | 99.8% | 99.8% | 99.8% | 0.0pp |
...
|---|---|---|---|---|---|---|
| `flank_pain_false:d7abb5ec` | `flank_pain_false` | false | 0 | 0 | 52 | 52 |
| `flank_pain_false:f63b22a5` | `flank_pain_false` | false | 0 | 0 | 38 | 38 |
| `flank_pain_true:214c674e` | `flank_pain_true` | true | 35 | 37 | 36 | 2 |
| `flank_pain_false:0468979b` | `flank_pain_false` | false | 0 | 0 | 35 | 35 |
| `flank_pain_true:801b09f3` | `flank_pain_true` | true | 33 | 33 | 6 | 27 |
| `flank_pain_false:3273a39a` | `flank_pain_false` | false | 0 | 0 | 28 | 28 |
| `flank_pain_false:76bc0785` | `flank_pain_false` | false | 23 | 9 | 0 | 23 |
| `flank_pain_null_hedged:73cf9df7` | `flank_pain_null_hedged` | null | 17 | 17 | 12 | 5 |
| `flank_pain_null_hedged:1ee3ae69` | `flank_pain_null_hedged` | null | 11 | 11 | 15 | 4 |
| `flank_pain_true:a50a0907` | `flank_pain_true` | true | 9 | 10 | 1 | 9 |
| `flank_pain_false:37373d48` | `flank_pain_false` | false | 0 | 0 | 7 | 7 |
| `flank_pain_false:1777a47f` | `flank_pain_false` | false | 0 | 0 | 2 | 2 |
| `flank_pain_false:cbb11cce` | `flank_pain_false` | false | 0 | 0 | 2 | 2 |
| `flank_pain_true:3d4f2eb9` | `flank_pain_true` | true | 2 | 2 | 0 | 2 |
| `flank_pain_false:4d4ec138` | `flank_pain_false` | false | 0 | 0 | 1 | 1 |
| `flank_pain_false:51da13c0` | `flank_pain_false` | false | 0 | 0 | 1 | 1 |
| `flank_pain_false:9ed5cbe0` | `flank_pain_false` | false | 0 | 0 | 1 | 1 |
| `flank_pain_false:bead93da` | `flank_pain_false` | false | 0 | 0 | 1 | 1 |
| `flank_pain_null_hedged:2af91871` | `flank_pain_null_hedged` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_hedged:5a1dff5a` | `flank_pain_null_hedged` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_hedged:b832ca13` | `flank_pain_null_hedged` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_hedged:c5af47ea` | `flank_pain_null_hedged` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_hedged:d0b42e86` | `flank_pain_null_hedged` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_historical:68d1f572` | `flank_pain_null_historical` | null | 1 | 1 | 1 | 0 |
| `flank_pain_null_historical:a2096510` | `flank_pain_null_historical` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_historical:cf82e8f1` | `flank_pain_null_historical` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_historical:e5af2cf0` | `flank_pain_null_historical` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_thirdparty:1d078e6d` | `flank_pain_null_thirdparty` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_thirdparty:3003d95a` | `flank_pain_null_thirdparty` | null | 1 | 1 | 0 | 1 |
| `flank_pain_null_thirdparty:6b9359a1` | `flank_pain_null_thirdparty` | null | 0 | 0 | 1 | 1 |
| `flank_pain_null_thirdparty:89cfecd3` | `flank_pain_null_thirdparty` | null | 1 | 1 | 0 | 1 |
| `flank_pain_true:0b172f6c` | `flank_pain_true` | true | 0 | 0 | 1 | 1 |
| `flank_pain_true:19e39218` | `flank_pain_true` | true | 0 | 1 | 0 | 1 |
| `flank_pain_true:b2b80fa1` | `flank_pain_true` | true | 0 | 0 | 1 | 1 |
...
|---|---|---|---|---|
| **truth false** | 2372 | 23 | 0 | 2395 |
| **truth true** | 30 | 1548 | 42 | 1620 |
| **truth null** | 20 | 19 | 5946 | 5985 |
| **total** | 2422 | 1590 | 5988 | 10000 |

`null -> true`: 19 of 5985 truly-null examples (0.32%).
...
|---|---|---|---|---|
| **truth false** | 2372 | 23 | 0 | 2395 |
| **truth true** | 37 | 1541 | 42 | 1620 |
| **truth null** | 20 | 17 | 5948 | 5985 |
| **total** | 2429 | 1581 | 5990 | 10000 |

`null -> true`: 17 of 5985 truly-null examples (0.28%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2395 | 2429 | 97.7% | 99.0% | 98.3% |
| `true` | 1620 | 1581 | 97.5% | 95.1% | 96.3% |
| `null` | 5985 | 5990 | 99.3% | 99.4% | 99.3% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2395 | **55** | 99.0% [97.0%, 100.0%] |
| null_ambiguous | 3000 | **140** | 99.0% [97.4%, 100.0%] |
| null_structural | 2985 | **1** | 99.8% [99.8%, 99.8%] |
| true | 1620 | **48** | 95.1% [88.7%, 99.9%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| hedged | 1173 | **53** | 97.6% [93.8%, 100.0%] |
| historical | 813 | **40** | 99.9% [99.6%, 100.0%] |
| third_party | 1014 | **47** | 99.8% [99.5%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| flank_pain_false | 2395 | **55** | 99.0% [97.0%, 100.0%] |
| flank_pain_null_hedged | 1173 | **53** | 97.6% [93.8%, 100.0%] |
| flank_pain_null_historical | 813 | **40** | 99.9% [99.6%, 100.0%] |
| flank_pain_null_thirdparty | 1014 | **47** | 99.8% [99.5%, 100.0%] |
| flank_pain_true | 1620 | **48** | 95.1% [88.7%, 99.9%] |
...
10 of 243 decisive fragments were got wrong at least once.

`arm_b_finetune@Arm0_control`: 133 errors across 10 of 243 decisive fragments. Half of them fall on **2** fragments (an even spread would be 5.0); the worst ten carry 100.0% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `flank_pain_true:801b09f3` | `flank_pain_true` | -- | true | 0/33 | 0.0% | null 33 |
| `flank_pain_true:214c674e` | `flank_pain_true` | -- | true | 2/37 | 5.4% | false 35, true 2 |
| `flank_pain_null_hedged:73cf9df7` | `flank_pain_null_hedged` | hedged | null | 8/25 | 32.0% | true 17, null 8 |
| `flank_pain_false:76bc0785` | `flank_pain_false` | -- | false | 23/46 | 50.0% | false 23, true 23 |
| `flank_pain_null_hedged:1ee3ae69` | `flank_pain_null_hedged` | hedged | null | 11/22 | 50.0% | false 11, null 11 |
| `flank_pain_true:a50a0907` | `flank_pain_true` | -- | true | 12/21 | 57.1% | true 12, null 9 |
| `flank_pain_true:3d4f2eb9` | `flank_pain_true` | -- | true | 34/36 | 94.4% | false 2, true 34 |
| `flank_pain_null_historical:68d1f572` | `flank_pain_null_historical` | historical | null | 17/18 | 94.4% | false 1, null 17 |
| `flank_pain_null_thirdparty:89cfecd3` | `flank_pain_null_thirdparty` | third_party | null | 20/21 | 95.2% | false 1, null 20 |
| `flank_pain_null_thirdparty:3003d95a` | `flank_pain_null_thirdparty` | third_party | null | 27/28 | 96.4% | false 1, null 27 |
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.65, 0.9.
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2386 | 9 | 0 | 2395 |
| **truth true** | 39 | 1537 | 44 | 1620 |
| **truth null** | 20 | 17 | 5948 | 5985 |
| **total** | 2445 | 1563 | 5992 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2395 | 2445 | 97.6% | 99.6% | 98.6% |
| `true` | 1620 | 1563 | 98.3% | 94.9% | 96.6% |
| `null` | 5985 | 5992 | 99.3% | 99.4% | 99.3% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2395 | **55** | 99.6% [98.8%, 100.0%] |
| null_ambiguous | 3000 | **140** | 99.0% [97.4%, 100.0%] |
| null_structural | 2985 | **1** | 99.8% [99.8%, 99.8%] |
| true | 1620 | **48** | 94.9% [88.2%, 99.8%] |
...
| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| flank_pain_false | 2395 | **55** | 99.6% [98.8%, 100.0%] |
| flank_pain_null_hedged | 1173 | **53** | 97.6% [93.8%, 100.0%] |
| flank_pain_null_historical | 813 | **40** | 99.9% [99.6%, 100.0%] |
| flank_pain_null_thirdparty | 1014 | **47** | 99.8% [99.5%, 100.0%] |
| flank_pain_true | 1620 | **48** | 94.9% [88.2%, 99.8%] |
| (none) | 2985 | **1** | 99.8% [99.8%, 99.8%] |
...
11 of 243 decisive fragments were got wrong at least once.

`arm_b_finetune@ArmC_remargined`: 123 errors across 11 of 243 decisive fragments. Half of them fall on **2** fragments (an even spread would be 5.5); the worst ten carry 99.2% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `flank_pain_true:214c674e` | `flank_pain_true` | -- | true | 0/37 | 0.0% | false 37 |
| `flank_pain_true:801b09f3` | `flank_pain_true` | -- | true | 0/33 | 0.0% | null 33 |
| `flank_pain_null_hedged:73cf9df7` | `flank_pain_null_hedged` | hedged | null | 8/25 | 32.0% | true 17, null 8 |
| `flank_pain_null_hedged:1ee3ae69` | `flank_pain_null_hedged` | hedged | null | 11/22 | 50.0% | false 11, null 11 |
| `flank_pain_true:a50a0907` | `flank_pain_true` | -- | true | 11/21 | 52.4% | true 11, null 10 |
| `flank_pain_false:76bc0785` | `flank_pain_false` | -- | false | 37/46 | 80.4% | false 37, true 9 |
| `flank_pain_true:3d4f2eb9` | `flank_pain_true` | -- | true | 34/36 | 94.4% | false 2, true 34 |
| `flank_pain_null_historical:68d1f572` | `flank_pain_null_historical` | historical | null | 17/18 | 94.4% | false 1, null 17 |
| `flank_pain_null_thirdparty:89cfecd3` | `flank_pain_null_thirdparty` | third_party | null | 20/21 | 95.2% | false 1, null 20 |
| `flank_pain_null_thirdparty:3003d95a` | `flank_pain_null_thirdparty` | third_party | null | 27/28 | 96.4% | false 1, null 27 |
| `flank_pain_true:19e39218` | `flank_pain_true` | -- | true | 40/41 | 97.6% | true 40, null 1 |

## `arm_b_finetune@ArmP_companions`

`roberta-base` with **every layer unfrozen**, mean-pooled, with the same `Linear(768, 3)` head -- 110M trainable parameters against Arm A's 2,307. Three epochs at batch 32, learning rate 2e-5, 10% linear warmup, AdamW, fp32. No gradient checkpointing, no 8-bit optimiser, no LoRA, no gradient accumulation: the full model fits in 12GB with room to spare, so anything that reads like a compute compromise would be a mistake rather than a saving. This is the arm that separates "the fragment libraries are the bottleneck" from "the method is too weak": if a fully fine-tuned encoder still cannot read third-party attribution, tense or metaphor, the limit is in the ideas the libraries contain and the fix is library work, not model work. **Joint multi-head training**: 6 heads sharing one encoder (dysuria_present, fever_present, flank_pain_present, haematuria_present, nocturia_present, urinary_frequency_present). Epoch selection uses DD6's unweighted mean of every head's own validation macro-F1, so this signal's stopping point may differ from a single-signal run's own best epoch. Each head's margin is chosen independently on its own validation split -- no cross-head trade.

Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.4, 0.8, 0.85.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2223 | 46 | 126 | 2395 |
| **truth true** | 36 | 1583 | 1 | 1620 |
| **truth null** | 10 | 60 | 5915 | 5985 |
| **total** | 2269 | 1689 | 6042 | 10000 |

`null -> true`: 60 of 5985 truly-null examples (1.00%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2227 | 42 | 126 | 2395 |
| **truth true** | 37 | 1575 | 8 | 1620 |
| **truth null** | 12 | 50 | 5923 | 5985 |
| **total** | 2276 | 1667 | 6057 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2395 | 2276 | 97.8% | 93.0% | 95.4% |
| `true` | 1620 | 1667 | 94.5% | 97.2% | 95.8% |
| `null` | 5985 | 6057 | 97.8% | 99.0% | 98.4% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2395 | **55** | 93.0% [86.5%, 98.2%] |
| null_ambiguous | 3000 | **140** | 98.7% [97.3%, 99.7%] |
| null_structural | 2985 | **1** | 99.2% [99.2%, 99.2%] |
| true | 1620 | **48** | 97.2% [92.3%, 99.9%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| hedged | 1166 | **53** | 97.3% [93.6%, 99.7%] |
| historical | 809 | **40** | 99.5% [99.0%, 99.9%] |
| third_party | 1025 | **47** | 99.8% [99.5%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| flank_pain_false | 2395 | **55** | 93.0% [86.5%, 98.2%] |
| flank_pain_null_hedged | 1166 | **53** | 97.3% [93.6%, 99.7%] |
| flank_pain_null_historical | 809 | **40** | 99.5% [99.0%, 99.9%] |
| flank_pain_null_thirdparty | 1025 | **47** | 99.8% [99.5%, 100.0%] |
| flank_pain_true | 1620 | **48** | 97.2% [92.3%, 99.9%] |
| (none) | 2985 | **1** | 99.2% [99.2%, 99.2%] |
...
29 of 243 decisive fragments were got wrong at least once.

`arm_b_finetune@ArmP_companions`: 251 errors across 29 of 243 decisive fragments. Half of them fall on **3** fragments (an even spread would be 14.5); the worst ten carry 92.0% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `flank_pain_false:d7abb5ec` | `flank_pain_false` | -- | false | 0/52 | 0.0% | null 52 |
| `flank_pain_true:214c674e` | `flank_pain_true` | -- | true | 0/36 | 0.0% | false 36 |
| `flank_pain_false:f63b22a5` | `flank_pain_false` | -- | false | 3/41 | 7.3% | false 3, true 38 |
| `flank_pain_false:0468979b` | `flank_pain_false` | -- | false | 11/46 | 23.9% | false 11, null 35 |
| `flank_pain_null_hedged:1ee3ae69` | `flank_pain_null_hedged` | hedged | null | 7/22 | 31.8% | false 4, true 11, null 7 |
| `flank_pain_false:3273a39a` | `flank_pain_false` | -- | false | 21/49 | 42.9% | false 21, null 28 |
| `flank_pain_null_hedged:73cf9df7` | `flank_pain_null_hedged` | hedged | null | 13/25 | 52.0% | true 12, null 13 |
| `flank_pain_true:801b09f3` | `flank_pain_true` | -- | true | 24/30 | 80.0% | true 24, null 6 |
| `flank_pain_false:37373d48` | `flank_pain_false` | -- | false | 47/54 | 87.0% | false 47, null 7 |
| `flank_pain_false:cbb11cce` | `flank_pain_false` | -- | false | 27/29 | 93.1% | false 27, true 2 |
| `flank_pain_false:1777a47f` | `flank_pain_false` | -- | false | 29/31 | 93.5% | false 29, true 2 |
| `flank_pain_null_historical:68d1f572` | `flank_pain_null_historical` | historical | null | 16/17 | 94.1% | false 1, null 16 |
| `flank_pain_null_thirdparty:1d078e6d` | `flank_pain_null_thirdparty` | third_party | null | 16/17 | 94.1% | false 1, null 16 |
| `flank_pain_null_hedged:b832ca13` | `flank_pain_null_hedged` | hedged | null | 17/18 | 94.4% | true 1, null 17 |
| `flank_pain_null_thirdparty:6b9359a1` | `flank_pain_null_thirdparty` | third_party | null | 17/18 | 94.4% | false 1, null 17 |
| `flank_pain_null_hedged:c5af47ea` | `flank_pain_null_hedged` | hedged | null | 18/19 | 94.7% | true 1, null 18 |
| `flank_pain_null_hedged:5a1dff5a` | `flank_pain_null_hedged` | hedged | null | 19/20 | 95.0% | true 1, null 19 |
| `flank_pain_null_hedged:d0b42e86` | `flank_pain_null_hedged` | hedged | null | 19/20 | 95.0% | true 1, null 19 |
| `flank_pain_null_historical:a2096510` | `flank_pain_null_historical` | historical | null | 19/20 | 95.0% | true 1, null 19 |
| `flank_pain_true:a50a0907` | `flank_pain_true` | -- | true | 20/21 | 95.2% | true 20, null 1 |
| `flank_pain_null_historical:e5af2cf0` | `flank_pain_null_historical` | historical | null | 21/22 | 95.5% | true 1, null 21 |
| `flank_pain_null_historical:cf82e8f1` | `flank_pain_null_historical` | historical | null | 22/23 | 95.7% | true 1, null 22 |
| `flank_pain_null_hedged:2af91871` | `flank_pain_null_hedged` | hedged | null | 27/28 | 96.4% | true 1, null 27 |
| `flank_pain_false:bead93da` | `flank_pain_false` | -- | false | 28/29 | 96.6% | false 28, null 1 |
| `flank_pain_false:51da13c0` | `flank_pain_false` | -- | false | 32/33 | 97.0% | false 32, null 1 |
| `flank_pain_true:b2b80fa1` | `flank_pain_true` | -- | true | 40/41 | 97.6% | true 40, null 1 |
| `flank_pain_false:9ed5cbe0` | `flank_pain_false` | -- | false | 52/53 | 98.1% | false 52, null 1 |
| `flank_pain_true:0b172f6c` | `flank_pain_true` | -- | true | 55/56 | 98.2% | false 1, true 55 |
| `flank_pain_false:4d4ec138` | `flank_pain_false` | -- | false | 78/79 | 98.7% | false 78, null 1 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 44680 | 2000 | 2000 | 0.85 | 100.0% | 100.0% | 100.0% | 0.00% |
| 1 | 44680 | 2000 | 2000 | 0.0 | 99.0% | 99.0% | 98.9% | 0.00% |
| 2 | 44680 | 2000 | 2000 | 0.85 | 96.0% | 95.8% | 93.4% | 1.42% |
| 3 | 44680 | 2000 | 2000 | 0.0 | 98.9% | 98.9% | 98.0% | 0.00% |
| 4 | 44680 | 2000 | 2000 | 0.8 | 99.5% | 99.5% | 99.4% | 0.00% |

### `arm_b_finetune@ArmC_remargined`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 44680 | 2000 | 2000 | 0.9 | 100.0% | 100.0% | 100.0% | 0.00% |
| 1 | 44680 | 2000 | 2000 | 0.65 | 99.0% | 99.0% | 98.8% | 0.00% |
| 2 | 44680 | 2000 | 2000 | 0.9 | 96.0% | 95.7% | 93.2% | 1.42% |
| 3 | 44680 | 2000 | 2000 | 0.9 | 98.9% | 99.6% | 99.2% | 0.00% |
| 4 | 44680 | 2000 | 2000 | 0.9 | 99.5% | 99.4% | 99.3% | 0.00% |

### `arm_b_finetune@ArmP_companions`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 54410 | 2000 | 2000 | 0.0 | 98.9% | 98.9% | 98.5% | 1.34% |
| 1 | 54415 | 2000 | 2000 | 0.4 | 98.6% | 98.6% | 98.3% | 1.67% |
| 2 | 54410 | 2000 | 2000 | 0.8 | 91.8% | 92.0% | 88.9% | 1.17% |
| 3 | 54410 | 2000 | 2000 | 0.0 | 97.0% | 97.0% | 97.0% | 0.00% |
| 4 | 54405 | 2000 | 2000 | 0.85 | 99.8% | 99.7% | 99.7% | 0.00% |
