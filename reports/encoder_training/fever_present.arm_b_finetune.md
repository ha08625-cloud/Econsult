...
*Generated 2026-08-09T18:57:55+00:00.*
...
| `arm_a_probe` | probe | 7022 | **349** | 71.6% [68.2%, 75.0%] | 68.0% [64.4%, 71.4%] | 79.7% | 79.7% +/- 2.7% |
| `arm_b_finetune` | finetune | 7022 | **349** | 83.5% [79.1%, 88.0%] | 82.1% [77.4%, 86.8%] | 88.4% | 88.4% +/- 4.4% |
| `arm_b_finetune__shuffled` | negative control | 7022 | **349** | 43.6% [37.9%, 49.7%] | 20.2% [18.3%, 22.1%] | 60.4% | 60.4% +/- 0.2% |
...
| `arm_a_probe` | 88.8% [83.5%, 93.1%] (eff n 43) | 67.6% [55.9%, 77.7%] (eff n 32) | 80.7% [72.8%, 87.5%] (eff n 36) | 89.8% [83.5%, 94.8%] (eff n 47) | 89.4% [83.5%, 95.0%] (eff n 35) |
| `arm_b_finetune` | 94.0% [87.4%, 98.6%] (eff n 43) | 75.6% [60.3%, 89.0%] (eff n 32) | 92.1% [84.2%, 98.1%] (eff n 36) | 92.0% [83.3%, 98.0%] (eff n 47) | 90.5% [81.7%, 97.8%] (eff n 35) |
| `arm_b_finetune__shuffled` | 100.0% [100.0%, 100.0%] (eff n 43) | 100.0% [100.0%, 100.0%] (eff n 32) | 100.0% [100.0%, 100.0%] (eff n 36) | 100.0% [100.0%, 100.0%] (eff n 47) | 100.0% [100.0%, 100.0%] (eff n 35) |
...
| `arm_a_probe` | probe | 3062 | **193** | 83.7% [80.3%, 86.9%] |
| `arm_b_finetune` | finetune | 3062 | **193** | 89.1% [84.7%, 92.9%] |
...
| `majority_class` vs `arm_a_probe` | 3062 | 517 | 0 | 4.66e-156 |
| `majority_class` vs `arm_b_finetune` | 3062 | 398 | 0 | 3.1e-120 |
| `length_only` vs `tfidf_logreg` | 3062 | 169 | 35 | 2.94e-22 |
| `length_only` vs `arm_a_probe` | 3062 | 508 | 26 | 4.13e-117 |
| `length_only` vs `arm_b_finetune` | 3062 | 391 | 28 | 5.48e-83 |
| `tfidf_logreg` vs `arm_a_probe` | 3062 | 432 | 84 | 1.99e-57 |
| `tfidf_logreg` vs `arm_b_finetune` | 3062 | 311 | 82 | 1.73e-32 |
| `arm_a_probe` vs `arm_b_finetune` | 3062 | 217 | 336 | 4.74e-07 |
...
* `arm_a_probe`: 1992 errors across 264 of 394 decisive fragments. Half of them fall on **51** fragments (an even spread would be 132.0); the worst ten carry 16.7% of all errors.
* `arm_b_finetune`: 1157 errors across 96 of 394 decisive fragments. Half of them fall on **17** fragments (an even spread would be 48.0); the worst ten carry 37.9% of all errors.
...
| `arm_b_finetune__shuffled` | 60.4% [39.5%, 76.8%] | 25.1% [18.9%, 29.0%] |
...
| `majority_class` vs `arm_a_probe` | overall | 10000 | 560 | 2486 | 9.67e-288 |
| `majority_class` vs `arm_a_probe` | null_ambiguous | 3062 | 517 | 0 | 4.66e-156 |
| `majority_class` vs `arm_b_finetune` | overall | 10000 | 403 | 3114 | 0 |
| `majority_class` vs `arm_b_finetune` | null_ambiguous | 3062 | 398 | 0 | 3.1e-120 |
| `length_only` vs `tfidf_logreg` | overall | 10000 | 246 | 2063 | 0 |
| `length_only` vs `tfidf_logreg` | null_ambiguous | 3062 | 169 | 35 | 2.94e-22 |
| `length_only` vs `arm_a_probe` | overall | 10000 | 572 | 2466 | 2.34e-278 |
| `length_only` vs `arm_a_probe` | null_ambiguous | 3062 | 508 | 26 | 4.13e-117 |
| `length_only` vs `arm_b_finetune` | overall | 10000 | 416 | 3095 | 0 |
| `length_only` vs `arm_b_finetune` | null_ambiguous | 3062 | 391 | 28 | 5.48e-83 |
| `tfidf_logreg` vs `arm_a_probe` | overall | 10000 | 894 | 971 | 0.0784 |
| `tfidf_logreg` vs `arm_a_probe` | null_ambiguous | 3062 | 432 | 84 | 1.99e-57 |
| `tfidf_logreg` vs `arm_b_finetune` | overall | 10000 | 518 | 1380 | 4.1e-90 |
| `tfidf_logreg` vs `arm_b_finetune` | null_ambiguous | 3062 | 311 | 82 | 1.73e-32 |
| `arm_a_probe` vs `arm_b_finetune` | overall | 10000 | 544 | 1329 | 1.38e-75 |
| `arm_a_probe` vs `arm_b_finetune` | null_ambiguous | 3062 | 217 | 336 | 4.74e-07 |
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.0, 0.05, 0.15.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1760 | 305 | 414 | 2479 |
| **truth true** | 207 | 726 | 548 | 1481 |
| **truth null** | 297 | 263 | 5480 | 6040 |
| **total** | 2264 | 1294 | 6442 | 10000 |

`null -> true`: 263 of 6040 truly-null examples (4.35%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1769 | 290 | 420 | 2479 |
| **truth true** | 219 | 698 | 564 | 1481 |
| **truth null** | 302 | 237 | 5501 | 6040 |
| **total** | 2290 | 1225 | 6485 | 10000 |

`null -> true`: 237 of 6040 truly-null examples (3.92%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2290 | 77.2% | 71.4% | 74.2% |
| `true` | 1481 | 1225 | 57.0% | 47.1% | 51.6% |
| `null` | 6040 | 6485 | 84.8% | 91.1% | 87.8% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **60** | 71.4% [63.7%, 78.1%] |
| null_ambiguous | 3062 | **193** | 83.7% [80.3%, 86.9%] |
| null_structural | 2978 | **1** | 98.7% [98.7%, 98.7%] |
| true | 1481 | **96** | 47.1% [40.5%, 54.5%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 597 | **43** | 88.8% [83.5%, 93.1%] |
| hedged | 558 | **32** | 67.6% [55.9%, 77.7%] |
| historical | 597 | **36** | 80.7% [72.8%, 87.5%] |
| metaphor | 677 | **47** | 89.8% [83.5%, 94.8%] |
| third_party | 633 | **35** | 89.4% [83.5%, 95.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **60** | 71.4% [63.7%, 78.1%] |
| fever_null_attribution | 597 | **43** | 88.8% [83.5%, 93.1%] |
| fever_null_hedged | 558 | **32** | 67.6% [55.9%, 77.7%] |
| fever_null_historical | 597 | **36** | 80.7% [72.8%, 87.5%] |
| fever_null_metaphor | 677 | **47** | 89.8% [83.5%, 94.8%] |
| fever_null_thirdparty | 633 | **35** | 89.4% [83.5%, 95.0%] |
| fever_true | 1481 | **96** | 47.1% [40.5%, 54.5%] |
...
264 of 394 decisive fragments were got wrong at least once.

`arm_a_probe`: 1992 errors across 264 of 394 decisive fragments. Half of them fall on **51** fragments (an even spread would be 132.0); the worst ten carry 16.7% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:cbf9d7a5` | `fever_false` | -- | false | 0/33 | 0.0% | true 32, null 1 |
| `fever_true:76170ee2` | `fever_true` | -- | true | 0/21 | 0.0% | false 7, null 14 |
| `fever_true:0ddb8a11` | `fever_true` | -- | true | 0/19 | 0.0% | false 1, null 18 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 0/19 | 0.0% | false 2, null 17 |
| `fever_true:872e3af9` | `fever_true` | -- | true | 0/18 | 0.0% | false 1, null 17 |
| `fever_true:3d00c372` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_true:74ccf7bd` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_true:ef344ff7` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 0/15 | 0.0% | false 12, true 3 |
| `fever_true:391fb2ce` | `fever_true` | -- | true | 0/15 | 0.0% | false 2, null 13 |
| `fever_null_hedged:60bffa1a` | `fever_null_hedged` | hedged | null | 0/14 | 0.0% | true 14 |
| `fever_true:c5d3e4a0` | `fever_true` | -- | true | 0/14 | 0.0% | false 14 |
| `fever_true:f3ee0d07` | `fever_true` | -- | true | 0/14 | 0.0% | false 14 |
| `fever_true:1c3df822` | `fever_true` | -- | true | 0/13 | 0.0% | false 3, null 10 |
| `fever_null_metaphor:abd3124d` | `fever_null_metaphor` | metaphor | null | 0/12 | 0.0% | false 11, true 1 |
| `fever_true:7cad3f0f` | `fever_true` | -- | true | 0/10 | 0.0% | false 10 |
| `fever_true:e919adf9` | `fever_true` | -- | true | 0/10 | 0.0% | false 4, null 6 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | false 6, true 3 |
| `fever_false:e0897296` | `fever_false` | -- | false | 1/38 | 2.6% | false 1, true 37 |
| `fever_true:65e4286c` | `fever_true` | -- | true | 1/32 | 3.1% | false 7, true 1, null 24 |
| `fever_false:de0596c4` | `fever_false` | -- | false | 2/47 | 4.3% | false 2, null 45 |
| `fever_true:a6c8dae6` | `fever_true` | -- | true | 1/15 | 6.7% | false 9, true 1, null 5 |
| `fever_null_historical:4afec229` | `fever_null_historical` | historical | null | 1/13 | 7.7% | false 12, null 1 |
| `fever_true:ed36ef0f` | `fever_true` | -- | true | 1/13 | 7.7% | false 2, true 1, null 10 |
| `fever_true:7844c66b` | `fever_true` | -- | true | 1/12 | 8.3% | false 1, true 1, null 10 |
| `fever_null_historical:2c3501f1` | `fever_null_historical` | historical | null | 2/16 | 12.5% | false 14, null 2 |
| `fever_true:80f7ba2e` | `fever_true` | -- | true | 2/16 | 12.5% | false 1, true 2, null 13 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 2/15 | 13.3% | false 3, true 2, null 10 |
| `fever_true:d0dd4129` | `fever_true` | -- | true | 2/15 | 13.3% | true 2, null 13 |
| `fever_true:dd6bbec4` | `fever_true` | -- | true | 2/15 | 13.3% | false 1, true 2, null 12 |
| `fever_null_historical:feadcb2c` | `fever_null_historical` | historical | null | 2/14 | 14.3% | true 12, null 2 |
| `fever_true:7ef2ecf5` | `fever_true` | -- | true | 2/13 | 15.4% | false 7, true 2, null 4 |
| `fever_true:c5273bcd` | `fever_true` | -- | true | 3/18 | 16.7% | true 3, null 15 |
| `fever_null_metaphor:e839f625` | `fever_null_metaphor` | metaphor | null | 2/12 | 16.7% | false 1, true 9, null 2 |
| `fever_true:b950a4fc` | `fever_true` | -- | true | 2/12 | 16.7% | false 3, true 2, null 7 |
| `fever_true:15a05d92` | `fever_true` | -- | true | 2/11 | 18.2% | true 2, null 9 |
| `fever_true:18173593` | `fever_true` | -- | true | 3/16 | 18.8% | false 7, true 3, null 6 |
| `fever_null_hedged:0906c944` | `fever_null_hedged` | hedged | null | 4/19 | 21.1% | false 12, true 3, null 4 |
| `fever_true:4635d31b` | `fever_true` | -- | true | 4/19 | 21.1% | true 4, null 15 |

*224 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.2, 0.9.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1880 | 389 | 210 | 2479 |
| **truth true** | 40 | 1234 | 207 | 1481 |
| **truth null** | 68 | 335 | 5637 | 6040 |
| **total** | 1988 | 1958 | 6054 | 10000 |

`null -> true`: 335 of 6040 truly-null examples (5.55%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1937 | 313 | 229 | 2479 |
| **truth true** | 48 | 1199 | 234 | 1481 |
| **truth null** | 84 | 253 | 5703 | 6040 |
| **total** | 2069 | 1765 | 6166 | 10000 |

`null -> true`: 253 of 6040 truly-null examples (4.19%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2069 | 93.6% | 78.1% | 85.2% |
| `true` | 1481 | 1765 | 67.9% | 81.0% | 73.9% |
| `null` | 6040 | 6166 | 92.5% | 94.4% | 93.4% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **60** | 78.1% [67.5%, 88.1%] |
| null_ambiguous | 3062 | **193** | 89.1% [84.7%, 92.9%] |
| null_structural | 2978 | **1** | 99.9% [99.9%, 99.9%] |
| true | 1481 | **96** | 81.0% [73.4%, 88.1%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 597 | **43** | 94.0% [87.4%, 98.6%] |
| hedged | 558 | **32** | 75.6% [60.3%, 89.0%] |
| historical | 597 | **36** | 92.1% [84.2%, 98.1%] |
| metaphor | 677 | **47** | 92.0% [83.3%, 98.0%] |
| third_party | 633 | **35** | 90.5% [81.7%, 97.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **60** | 78.1% [67.5%, 88.1%] |
| fever_null_attribution | 597 | **43** | 94.0% [87.4%, 98.6%] |
| fever_null_hedged | 558 | **32** | 75.6% [60.3%, 89.0%] |
| fever_null_historical | 597 | **36** | 92.1% [84.2%, 98.1%] |
| fever_null_metaphor | 677 | **47** | 92.0% [83.3%, 98.0%] |
| fever_null_thirdparty | 633 | **35** | 90.5% [81.7%, 97.8%] |
| fever_true | 1481 | **96** | 81.0% [73.4%, 88.1%] |
| (none) | 2978 | **1** | 99.9% [99.9%, 99.9%] |
...
96 of 394 decisive fragments were got wrong at least once.
...
| `fever_false:357d0419` | `fever_false` | -- | false | 0/59 | 0.0% | null 59 |
| `fever_false:de0596c4` | `fever_false` | -- | false | 0/47 | 0.0% | null 47 |
| `fever_false:c747066d` | `fever_false` | -- | false | 0/38 | 0.0% | true 38 |
| `fever_false:e0897296` | `fever_false` | -- | false | 0/38 | 0.0% | true 38 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 0/36 | 0.0% | null 36 |
| `fever_true:76170ee2` | `fever_true` | -- | true | 0/21 | 0.0% | null 21 |
| `fever_true:0ddb8a11` | `fever_true` | -- | true | 0/19 | 0.0% | null 19 |
| `fever_true:e360a5de` | `fever_true` | -- | true | 0/19 | 0.0% | false 19 |
| `fever_true:3d00c372` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 0/17 | 0.0% | null 17 |
| `fever_null_historical:2c3501f1` | `fever_null_historical` | historical | null | 0/16 | 0.0% | false 16 |
| `fever_null_thirdparty:15f5a2bb` | `fever_null_thirdparty` | third_party | null | 0/16 | 0.0% | true 16 |
| `fever_null_hedged:917d0e09` | `fever_null_hedged` | hedged | null | 0/15 | 0.0% | false 5, true 10 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 0/15 | 0.0% | false 5, true 10 |
| `fever_true:5441ccb2` | `fever_true` | -- | true | 0/15 | 0.0% | null 15 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 0/15 | 0.0% | null 15 |
| `fever_null_hedged:a59467df` | `fever_null_hedged` | hedged | null | 0/14 | 0.0% | true 14 |
| `fever_null_historical:feadcb2c` | `fever_null_historical` | historical | null | 0/14 | 0.0% | true 14 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 0/14 | 0.0% | null 14 |
| `fever_true:f3ee0d07` | `fever_true` | -- | true | 0/14 | 0.0% | false 14 |
| `fever_null_attribution:bce52417` | `fever_null_attribution` | attribution | null | 0/12 | 0.0% | true 12 |
| `fever_null_hedged:9318fa9a` | `fever_null_hedged` | hedged | null | 0/12 | 0.0% | false 3, true 9 |
| `fever_true:b950a4fc` | `fever_true` | -- | true | 0/12 | 0.0% | null 12 |
| `fever_null_hedged:bba323b8` | `fever_null_hedged` | hedged | null | 0/11 | 0.0% | false 11 |
| `fever_null_metaphor:a46e0ccc` | `fever_null_metaphor` | metaphor | null | 0/11 | 0.0% | true 11 |
| `fever_null_metaphor:079cbbb1` | `fever_null_metaphor` | metaphor | null | 0/10 | 0.0% | false 1, true 9 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | false 4, true 5 |
| `fever_null_metaphor:ea0a7bd1` | `fever_null_metaphor` | metaphor | null | 0/9 | 0.0% | true 9 |
| `fever_null_thirdparty:258913a5` | `fever_null_thirdparty` | third_party | null | 0/6 | 0.0% | true 6 |
| `fever_null_historical:1b314733` | `fever_null_historical` | historical | null | 0/3 | 0.0% | true 3 |
| `fever_false:e8c514ff` | `fever_false` | -- | false | 1/54 | 1.9% | false 1, true 53 |
| `fever_false:f586e96d` | `fever_false` | -- | false | 1/38 | 2.6% | false 1, true 37 |
| `fever_true:74ccf7bd` | `fever_true` | -- | true | 1/17 | 5.9% | true 1, null 16 |
| `fever_true:2ee57e4c` | `fever_true` | -- | true | 1/16 | 6.2% | true 1, null 15 |
| `fever_false:f6985a04` | `fever_false` | -- | false | 3/47 | 6.4% | false 3, true 40, null 4 |
| `fever_false:464eb13e` | `fever_false` | -- | false | 2/28 | 7.1% | false 2, true 26 |
| `fever_null_hedged:60bffa1a` | `fever_null_hedged` | hedged | null | 1/14 | 7.1% | true 13, null 1 |
| `fever_null_thirdparty:59550cfc` | `fever_null_thirdparty` | third_party | null | 1/13 | 7.7% | true 12, null 1 |
| `fever_null_thirdparty:96bac6da` | `fever_null_thirdparty` | third_party | null | 1/12 | 8.3% | true 11, null 1 |
| `fever_null_hedged:0906c944` | `fever_null_hedged` | hedged | null | 2/19 | 10.5% | false 17, null 2 |

*56 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
`arm_b_finetune__shuffled`: 3960 errors across 156 of 394 decisive fragments. Half of them fall on **43** fragments (an even spread would be 78.0); the worst ten carry 13.7% of all errors.
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 81.7% | 81.7% | 74.1% | 2.81% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 78.1% | 78.1% | 67.6% | 2.00% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 81.5% | 81.5% | 74.5% | 6.71% |
| 3 | 10000 | 2000 | 2000 | 0.15 | 75.3% | 75.6% | 65.8% | 4.28% |
| 4 | 10000 | 2000 | 2000 | 0.05 | 81.7% | 81.5% | 73.8% | 3.81% |

### `arm_b_finetune`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.9 | 93.5% | 93.7% | 90.9% | 1.16% |
| 1 | 10000 | 2000 | 2000 | 0.9 | 82.8% | 84.9% | 79.6% | 4.91% |
| 2 | 10000 | 2000 | 2000 | 0.2 | 92.5% | 92.7% | 89.7% | 5.63% |
| 3 | 10000 | 2000 | 2000 | 0.9 | 83.5% | 85.2% | 79.8% | 3.37% |
| 4 | 10000 | 2000 | 2000 | 0.9 | 85.4% | 85.5% | 80.0% | 5.89% |
