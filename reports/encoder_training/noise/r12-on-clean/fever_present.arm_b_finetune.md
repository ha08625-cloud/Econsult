...
| artefacts | `models/encoder-noise/r12-on-clean/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 94.3% [92.3%, 96.1%] | 93.8% [91.5%, 95.6%] | 95.8% | 95.8% +/- 2.7% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 93.4% [85.8%, 98.9%] (eff n 43) | 88.0% [79.0%, 95.4%] (eff n 63) | 97.8% [94.3%, 99.8%] (eff n 36) | 99.4% [98.5%, 100.0%] (eff n 47) | 99.8% [99.4%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 94.3% [92.3%, 96.1%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.85, 0.9, 0.0, 0.75, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 95.0% [92.3%, 97.5%] |
...
* `arm_b_finetune`: 398 errors across 55 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 27.5); the worst ten carry 41.5% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2423 | 11 | 45 | 2479 |
| **truth true** | 13 | 1305 | 163 | 1481 |
| **truth null** | 65 | 107 | 5868 | 6040 |
| **total** | 2501 | 1423 | 6076 | 10000 |

`null -> true`: 107 of 6040 truly-null examples (1.77%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2423 | 3 | 53 | 2479 |
| **truth true** | 13 | 1292 | 176 | 1481 |
| **truth null** | 68 | 104 | 5868 | 6040 |
| **total** | 2504 | 1399 | 6097 | 10000 |

`null -> true`: 104 of 6040 truly-null examples (1.72%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2504 | 96.8% | 97.7% | 97.3% |
| `true` | 1481 | 1399 | 92.4% | 87.2% | 89.7% |
| `null` | 6040 | 6097 | 96.2% | 97.2% | 96.7% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 97.7% [94.7%, 99.9%] |
| null_ambiguous | 3062 | **224** | 95.0% [92.3%, 97.5%] |
| null_structural | 2978 | **1** | 99.4% [99.4%, 99.4%] |
| true | 1481 | **96** | 87.2% [81.1%, 93.0%] |
...
| hedged | 828 | **63** | 88.0% [79.0%, 95.4%] |
| historical | 511 | **36** | 97.8% [94.3%, 99.8%] |
| metaphor | 641 | **47** | 99.4% [98.5%, 100.0%] |
...
|---|---|---|---|
| fever_false | 2479 | **98** | 97.7% [94.7%, 99.9%] |
| fever_null_attribution | 574 | **43** | 93.4% [85.8%, 98.9%] |
| fever_null_hedged | 828 | **63** | 88.0% [79.0%, 95.4%] |
| fever_null_historical | 511 | **36** | 97.8% [94.3%, 99.8%] |
| fever_null_metaphor | 641 | **47** | 99.4% [98.5%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 99.8% [99.4%, 100.0%] |
| fever_true | 1481 | **96** | 87.2% [81.1%, 93.0%] |
...
| `fever_null_hedged:9e333f46` | `fever_null_hedged` | hedged | null | 0/10 | 0.0% | false 8, true 2 |
...
| `fever_false:e8c514ff` | `fever_false` | -- | false | 1/16 | 6.2% | false 1, true 2, null 13 |
...
| `fever_true:01833454` | `fever_true` | -- | true | 3/16 | 18.8% | false 13, true 3 |
| `fever_true:c7489e90` | `fever_true` | -- | true | 8/19 | 42.1% | true 8, null 11 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 6/14 | 42.9% | true 6, null 8 |
...
| `fever_true:fc118943` | `fever_true` | -- | true | 7/11 | 63.6% | true 7, null 4 |
| `fever_true:15a05d92` | `fever_true` | -- | true | 16/24 | 66.7% | true 16, null 8 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 13/19 | 68.4% | true 13, null 6 |
| `fever_true:2ee57e4c` | `fever_true` | -- | true | 7/10 | 70.0% | true 7, null 3 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 7/10 | 70.0% | true 7, null 3 |
| `fever_null_hedged:b8236158` | `fever_null_hedged` | hedged | null | 7/9 | 77.8% | true 2, null 7 |
| `fever_null_metaphor:625f220a` | `fever_null_metaphor` | metaphor | null | 9/11 | 81.8% | true 2, null 9 |
| `fever_null_hedged:c6f19a33` | `fever_null_hedged` | hedged | null | 5/6 | 83.3% | true 1, null 5 |
| `fever_true:199d4eb4` | `fever_true` | -- | true | 12/14 | 85.7% | true 12, null 2 |
| `fever_null_metaphor:4076133d` | `fever_null_metaphor` | metaphor | null | 6/7 | 85.7% | true 1, null 6 |
| `fever_null_hedged:60bffa1a` | `fever_null_hedged` | hedged | null | 7/8 | 87.5% | true 1, null 7 |
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.85 | 98.2% | 97.9% | 97.3% | 0.00% |
| 1 | 10000 | 2000 | 2000 | 0.9 | 93.7% | 93.5% | 91.0% | 1.08% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 92.7% | 92.7% | 91.1% | 5.30% |
| 3 | 10000 | 2000 | 2000 | 0.75 | 96.7% | 96.5% | 95.6% | 1.23% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 98.7% | 98.7% | 97.8% | 1.00% |
