...
*Generated 2026-08-31T09:12:06+00:00.*
...
| split salt | `0` |
| dataset dir | `data/synthetic/generated/noise/fever-r06-freezeall` |
...
| artefacts | `models/encoder-noise/freezeall-on-freezeall/fever_present/arm_b_finetune` |
| weights | `models/encoder-noise/freezeall-on-freezeall/fever_present/arm_b_finetune/weights -- ~440MB per fold, not committed` |
...
| `tfidf_logreg` | baseline | 7022 | **418** | 73.3% [69.8%, 76.7%] | 70.4% [66.6%, 74.2%] | 81.1% | 81.1% +/- 2.8% |
| `length_only__shuffled` | negative control | 7022 | **418** | 43.6% [38.6%, 48.8%] | 20.2% [18.6%, 21.9%] | 60.4% | 60.4% +/- 0.2% |
| `tfidf_logreg__shuffled` | negative control | 7022 | **418** | 43.5% [38.5%, 48.7%] | 20.4% [18.7%, 22.1%] | 60.2% | 60.2% +/- 0.4% |
| `arm_a_probe` | probe | 7022 | **418** | 74.8% [71.7%, 77.8%] | 72.0% [68.6%, 75.2%] | 81.9% | 81.9% +/- 2.8% |
| `arm_b_finetune` | finetune | 7022 | **418** | 91.7% [89.5%, 93.6%] | 90.8% [88.3%, 92.9%] | 93.9% | 93.9% +/- 2.5% |
...
| `tfidf_logreg` | -- | 93.4% [89.3%, 97.0%] (eff n 43) | 89.1% [82.2%, 94.7%] (eff n 63) | 91.6% [86.7%, 95.6%] (eff n 36) | 97.0% [94.8%, 98.8%] (eff n 47) | 91.9% [87.1%, 96.3%] (eff n 35) |
...
| `tfidf_logreg__shuffled` | -- | 99.3% [98.4%, 100.0%] (eff n 43) | 100.0% [100.0%, 100.0%] (eff n 63) | 99.4% [98.7%, 100.0%] (eff n 36) | 99.4% [98.6%, 100.0%] (eff n 47) | 99.8% [99.4%, 100.0%] (eff n 35) |
| `arm_a_probe` | -- | 87.5% [81.5%, 92.8%] (eff n 43) | 77.4% [70.8%, 83.6%] (eff n 63) | 87.3% [82.7%, 91.4%] (eff n 36) | 95.8% [93.2%, 97.9%] (eff n 47) | 92.9% [89.2%, 96.4%] (eff n 35) |
| `arm_b_finetune` | -- | 85.7% [76.4%, 93.5%] (eff n 43) | 83.7% [74.8%, 91.6%] (eff n 63) | 94.7% [90.0%, 98.0%] (eff n 36) | 97.5% [95.5%, 99.1%] (eff n 47) | 95.5% [91.3%, 99.2%] (eff n 35) |
...
|---|---|---|
| `fever_present` | 49 | 15.5% |

### `arm_b_finetune`

Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 91.7% [89.5%, 93.6%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.45, 0.0, 0.9, 0.9, 0.85. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `fever_present` | 9/9/49 | 0 | 18 | 78.9% +/- 10.7% | +/-23.1% | 67 | 79.7% +/- 7.5% | 80.0% +/- 11.5% |

`null -> true` on real text, per fold: `fever_present` 3, 14, 0, 8, 13 of 49. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
| `tfidf_logreg` | baseline | 3062 | **224** | 92.5% [90.1%, 94.5%] |
| `arm_a_probe` | probe | 3062 | **224** | 87.4% [84.8%, 89.7%] |
| `arm_b_finetune` | finetune | 3062 | **224** | 90.8% [87.6%, 93.7%] |
...
| `majority_class` vs `tfidf_logreg` | 3062 | 231 | 0 | 5.8e-70 |
| `majority_class` vs `arm_a_probe` | 3062 | 387 | 0 | 6.34e-117 |
| `majority_class` vs `arm_b_finetune` | 3062 | 321 | 0 | 4.68e-97 |
| `length_only` vs `tfidf_logreg` | 3062 | 230 | 2 | 7.83e-66 |
| `length_only` vs `arm_a_probe` | 3062 | 385 | 1 | 4.91e-114 |
| `length_only` vs `arm_b_finetune` | 3062 | 320 | 2 | 1.22e-92 |
| `tfidf_logreg` vs `arm_a_probe` | 3062 | 299 | 143 | 9.31e-14 |
| `tfidf_logreg` vs `arm_b_finetune` | 3062 | 227 | 137 | 2.77e-06 |
| `arm_a_probe` vs `arm_b_finetune` | 3062 | 211 | 277 | 0.00322 |
...
* `tfidf_logreg`: 1878 errors across 232 of 463 decisive fragments. Half of them fall on **48** fragments (an even spread would be 116.0); the worst ten carry 14.6% of all errors.
* `arm_a_probe`: 1772 errors across 293 of 463 decisive fragments. Half of them fall on **57** fragments (an even spread would be 146.5); the worst ten carry 13.2% of all errors.
* `arm_b_finetune`: 584 errors across 100 of 463 decisive fragments. Half of them fall on **21** fragments (an even spread would be 50.0); the worst ten carry 28.3% of all errors.
...
| `tfidf_logreg__shuffled` | 60.2% [39.8%, 76.2%] | 25.2% [19.2%, 29.1%] |
...
| `majority_class` vs `tfidf_logreg` | overall | 10000 | 245 | 2313 | 0 |
| `majority_class` vs `tfidf_logreg` | null_ambiguous | 3062 | 231 | 0 | 5.8e-70 |
| `majority_class` vs `arm_a_probe` | overall | 10000 | 426 | 2575 | 0 |
| `majority_class` vs `arm_a_probe` | null_ambiguous | 3062 | 387 | 0 | 6.34e-117 |
| `majority_class` vs `arm_b_finetune` | overall | 10000 | 349 | 3679 | 0 |
| `majority_class` vs `arm_b_finetune` | null_ambiguous | 3062 | 321 | 0 | 4.68e-97 |
| `length_only` vs `tfidf_logreg` | overall | 10000 | 244 | 2291 | 0 |
| `length_only` vs `tfidf_logreg` | null_ambiguous | 3062 | 230 | 2 | 7.83e-66 |
| `length_only` vs `arm_a_probe` | overall | 10000 | 440 | 2568 | 0 |
| `length_only` vs `arm_a_probe` | null_ambiguous | 3062 | 385 | 1 | 4.91e-114 |
| `length_only` vs `arm_b_finetune` | overall | 10000 | 348 | 3657 | 0 |
| `length_only` vs `arm_b_finetune` | null_ambiguous | 3062 | 320 | 2 | 1.22e-92 |
| `tfidf_logreg` vs `arm_a_probe` | overall | 10000 | 802 | 883 | 0.0513 |
| `tfidf_logreg` vs `arm_a_probe` | null_ambiguous | 3062 | 299 | 143 | 9.31e-14 |
| `tfidf_logreg` vs `arm_b_finetune` | overall | 10000 | 289 | 1551 | 2.13e-208 |
| `tfidf_logreg` vs `arm_b_finetune` | null_ambiguous | 3062 | 227 | 137 | 2.77e-06 |
| `arm_a_probe` vs `arm_b_finetune` | overall | 10000 | 301 | 1482 | 4.19e-187 |
| `arm_a_probe` vs `arm_b_finetune` | null_ambiguous | 3062 | 211 | 277 | 0.00322 |
...
|---|---|---|---|---|---|---|---|
| `fever_false` | 2479 | 0.0% | 0.2% | 63.9% | 73.0% | 96.7% | 96.7pp |
| `fever_true` | 1481 | 0.0% | 1.4% | 49.2% | 51.7% | 85.1% | 85.1pp |
| `fever_null_hedged` | 828 | 100.0% | 100.0% | 89.1% | 77.4% | 83.7% | 22.6pp |
| `fever_null_attribution` | 574 | 100.0% | 99.5% | 93.4% | 87.5% | 85.7% | 14.3pp |
| `fever_null_historical` | 511 | 100.0% | 100.0% | 91.6% | 87.3% | 94.7% | 12.7pp |
| `fever_null_thirdparty` | 508 | 100.0% | 100.0% | 91.9% | 92.9% | 95.5% | 8.1pp |
| `fever_null_metaphor` | 641 | 100.0% | 100.0% | 97.0% | 95.8% | 97.5% | 4.2pp |
...
| `fever_false:d0ca84a7` | `fever_false` | false | 37 | 37 | 2 | 1 | 0 | 37 |
| `fever_false:24e5c247` | `fever_false` | false | 36 | 36 | 14 | 11 | 0 | 36 |
| `fever_false:a9a0220e` | `fever_false` | false | 36 | 36 | 0 | 2 | 0 | 36 |
| `fever_false:0429068c` | `fever_false` | false | 34 | 34 | 12 | 0 | 0 | 34 |
| `fever_false:17f6c637` | `fever_false` | false | 34 | 34 | 0 | 0 | 0 | 34 |
| `fever_false:9f46e710` | `fever_false` | false | 34 | 34 | 1 | 4 | 0 | 34 |
| `fever_false:fc2ae0f2` | `fever_false` | false | 34 | 34 | 6 | 6 | 0 | 34 |
| `fever_false:5969c6c9` | `fever_false` | false | 33 | 33 | 2 | 10 | 0 | 33 |
| `fever_false:b9076eff` | `fever_false` | false | 33 | 33 | 13 | 21 | 13 | 20 |
| `fever_false:b96ed279` | `fever_false` | false | 33 | 33 | 33 | 15 | 0 | 33 |
| `fever_false:2b944abc` | `fever_false` | false | 32 | 32 | 1 | 0 | 0 | 32 |
| `fever_false:55bf1913` | `fever_false` | false | 32 | 32 | 1 | 0 | 0 | 32 |
| `fever_false:a5b671a1` | `fever_false` | false | 32 | 32 | 16 | 29 | 0 | 32 |
| `fever_false:cdf2609b` | `fever_false` | false | 32 | 32 | 30 | 8 | 1 | 31 |
| `fever_false:8d02bd9e` | `fever_false` | false | 31 | 31 | 20 | 6 | 0 | 31 |
| `fever_false:d5ed3ff1` | `fever_false` | false | 31 | 31 | 17 | 10 | 0 | 31 |
| `fever_false:de0596c4` | `fever_false` | false | 31 | 31 | 16 | 11 | 0 | 31 |
| `fever_false:e2aff3b8` | `fever_false` | false | 31 | 31 | 10 | 3 | 1 | 30 |
| `fever_false:f586e96d` | `fever_false` | false | 31 | 31 | 13 | 17 | 0 | 31 |
| `fever_false:56a45ff1` | `fever_false` | false | 30 | 30 | 5 | 5 | 0 | 30 |
| `fever_false:5c2a065d` | `fever_false` | false | 30 | 30 | 30 | 6 | 29 | 24 |
| `fever_false:c747066d` | `fever_false` | false | 30 | 30 | 4 | 1 | 0 | 30 |
| `fever_false:3a3043ff` | `fever_false` | false | 29 | 29 | 24 | 25 | 8 | 21 |
| `fever_false:463f8189` | `fever_false` | false | 29 | 29 | 0 | 5 | 0 | 29 |
| `fever_false:758d5434` | `fever_false` | false | 29 | 29 | 0 | 0 | 0 | 29 |
| `fever_false:7b64d17a` | `fever_false` | false | 29 | 29 | 21 | 4 | 0 | 29 |
| `fever_false:a4cda1e2` | `fever_false` | false | 29 | 29 | 1 | 0 | 0 | 29 |
| `fever_true:18173593` | `fever_true` | true | 29 | 29 | 17 | 24 | 0 | 29 |
| `fever_true:f3ee0d07` | `fever_true` | true | 29 | 29 | 0 | 0 | 0 | 29 |
| `fever_false:44cd09fd` | `fever_false` | false | 28 | 28 | 28 | 9 | 0 | 28 |
| `fever_false:a6c0d44a` | `fever_false` | false | 28 | 28 | 11 | 1 | 0 | 28 |
| `fever_false:cbf9d7a5` | `fever_false` | false | 28 | 28 | 28 | 23 | 4 | 24 |
| `fever_false:147d5cf0` | `fever_false` | false | 27 | 27 | 11 | 1 | 0 | 27 |
| `fever_false:3de7ecac` | `fever_false` | false | 27 | 27 | 27 | 14 | 0 | 27 |
| `fever_false:43f5b35d` | `fever_false` | false | 27 | 27 | 8 | 0 | 0 | 27 |
| `fever_false:8599e318` | `fever_false` | false | 27 | 27 | 2 | 2 | 0 | 27 |
| `fever_false:e70e24b6` | `fever_false` | false | 27 | 27 | 9 | 21 | 0 | 27 |
| `fever_true:753c7815` | `fever_true` | true | 27 | 27 | 0 | 0 | 0 | 27 |
| `fever_false:033927e6` | `fever_false` | false | 26 | 26 | 26 | 24 | 0 | 26 |

*323 further fragments erred on at least one model; the JSON holds them all.*
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1584 | 116 | 779 | 2479 |
| **truth true** | 123 | 729 | 629 | 1481 |
| **truth null** | 169 | 76 | 5795 | 6040 |
| **total** | 1876 | 921 | 7203 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 1876 | 84.4% | 63.9% | 72.7% |
| `true` | 1481 | 921 | 79.2% | 49.2% | 60.7% |
| `null` | 6040 | 7203 | 80.5% | 95.9% | 87.5% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 63.9% [57.0%, 70.5%] |
| null_ambiguous | 3062 | **224** | 92.5% [90.1%, 94.5%] |
| null_structural | 2978 | **1** | 99.5% [99.5%, 99.5%] |
| true | 1481 | **96** | 49.2% [41.0%, 57.6%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 93.4% [89.3%, 97.0%] |
| hedged | 828 | **63** | 89.1% [82.2%, 94.7%] |
| historical | 511 | **36** | 91.6% [86.7%, 95.6%] |
| metaphor | 641 | **47** | 97.0% [94.8%, 98.8%] |
| third_party | 508 | **35** | 91.9% [87.1%, 96.3%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 63.9% [57.0%, 70.5%] |
| fever_null_attribution | 574 | **43** | 93.4% [89.3%, 97.0%] |
| fever_null_hedged | 828 | **63** | 89.1% [82.2%, 94.7%] |
| fever_null_historical | 511 | **36** | 91.6% [86.7%, 95.6%] |
| fever_null_metaphor | 641 | **47** | 97.0% [94.8%, 98.8%] |
| fever_null_thirdparty | 508 | **35** | 91.9% [87.1%, 96.3%] |
| fever_true | 1481 | **96** | 49.2% [41.0%, 57.6%] |
...
232 of 463 decisive fragments were got wrong at least once.
...
| `fever_true:c5d3e4a0` | `fever_true` | -- | true | 0/12 | 0.0% | false 11, null 1 |
...
| `fever_true:01833454` | `fever_true` | -- | true | 1/16 | 6.2% | false 13, true 1, null 2 |
...
*192 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
| **truth true** | 14 | 1 | 1466 | 1481 |
| **truth null** | 24 | 1 | 6015 | 6040 |
| **total** | 43 | 2 | 9955 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 43 | 11.6% | 0.2% | 0.4% |
| `true` | 1481 | 2 | 50.0% | 0.1% | 0.1% |
| `null` | 6040 | 9955 | 60.4% | 99.6% | 75.2% |
...
| null_ambiguous | 3062 | **224** | 99.6% [99.3%, 99.8%] |
| null_structural | 2978 | **1** | 99.6% [99.6%, 99.6%] |
| true | 1481 | **96** | 0.1% [0.0%, 0.2%] |
...
| hedged | 828 | **63** | 100.0% [100.0%, 100.0%] |
| historical | 511 | **36** | 99.4% [98.7%, 100.0%] |
| metaphor | 641 | **47** | 99.4% [98.6%, 100.0%] |
...
| fever_null_hedged | 828 | **63** | 100.0% [100.0%, 100.0%] |
| fever_null_historical | 511 | **36** | 99.4% [98.7%, 100.0%] |
| fever_null_metaphor | 641 | **47** | 99.4% [98.6%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 99.8% [99.4%, 100.0%] |
| fever_true | 1481 | **96** | 0.1% [0.0%, 0.2%] |
...
`tfidf_logreg__shuffled`: 3966 errors across 205 of 463 decisive fragments. Half of them fall on **71** fragments (an even spread would be 102.5); the worst ten carry 8.9% of all errors.
...
| **truth true** | 133 | 766 | 582 | 1481 |
| **truth null** | 276 | 150 | 5614 | 6040 |
| **total** | 2218 | 1067 | 6715 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2218 | 81.6% | 73.0% | 77.0% |
| `true` | 1481 | 1067 | 71.8% | 51.7% | 60.1% |
| `null` | 6040 | 6715 | 83.6% | 92.9% | 88.0% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 73.0% [67.5%, 78.2%] |
| null_ambiguous | 3062 | **224** | 87.4% [84.8%, 89.7%] |
| null_structural | 2978 | **1** | 98.7% [98.7%, 98.7%] |
| true | 1481 | **96** | 51.7% [44.3%, 59.2%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 87.5% [81.5%, 92.8%] |
| hedged | 828 | **63** | 77.4% [70.8%, 83.6%] |
| historical | 511 | **36** | 87.3% [82.7%, 91.4%] |
| metaphor | 641 | **47** | 95.8% [93.2%, 97.9%] |
| third_party | 508 | **35** | 92.9% [89.2%, 96.4%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 73.0% [67.5%, 78.2%] |
| fever_null_attribution | 574 | **43** | 87.5% [81.5%, 92.8%] |
| fever_null_hedged | 828 | **63** | 77.4% [70.8%, 83.6%] |
| fever_null_historical | 511 | **36** | 87.3% [82.7%, 91.4%] |
| fever_null_metaphor | 641 | **47** | 95.8% [93.2%, 97.9%] |
| fever_null_thirdparty | 508 | **35** | 92.9% [89.2%, 96.4%] |
| fever_true | 1481 | **96** | 51.7% [44.3%, 59.2%] |
...
293 of 463 decisive fragments were got wrong at least once.
...
| `fever_false:3a3043ff` | `fever_false` | -- | false | 4/29 | 13.8% | false 4, true 10, null 15 |
...
| `fever_true:c5d3e4a0` | `fever_true` | -- | true | 2/12 | 16.7% | false 10, true 2 |
| `fever_true:c3a107bf` | `fever_true` | -- | true | 1/6 | 16.7% | true 1, null 5 |
| `fever_true:18173593` | `fever_true` | -- | true | 5/29 | 17.2% | false 8, true 5, null 16 |
...
| `fever_true:dd6bbec4` | `fever_true` | -- | true | 5/24 | 20.8% | false 6, true 5, null 13 |
...
*253 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2392 | 37 | 50 | 2479 |
| **truth true** | 28 | 1287 | 166 | 1481 |
| **truth null** | 105 | 244 | 5691 | 6040 |
| **total** | 2525 | 1568 | 5907 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2398 | 31 | 50 | 2479 |
| **truth true** | 39 | 1261 | 181 | 1481 |
| **truth null** | 106 | 200 | 5734 | 6040 |
| **total** | 2543 | 1492 | 5965 | 10000 |

`null -> true`: 200 of 6040 truly-null examples (3.31%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2543 | 94.3% | 96.7% | 95.5% |
| `true` | 1481 | 1492 | 84.5% | 85.1% | 84.8% |
| `null` | 6040 | 5965 | 96.1% | 94.9% | 95.5% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 96.7% [93.7%, 99.1%] |
| null_ambiguous | 3062 | **224** | 90.8% [87.6%, 93.7%] |
| null_structural | 2978 | **1** | 99.2% [99.2%, 99.2%] |
| true | 1481 | **96** | 85.1% [78.7%, 91.0%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 85.7% [76.4%, 93.5%] |
| hedged | 828 | **63** | 83.7% [74.8%, 91.6%] |
| historical | 511 | **36** | 94.7% [90.0%, 98.0%] |
| metaphor | 641 | **47** | 97.5% [95.5%, 99.1%] |
| third_party | 508 | **35** | 95.5% [91.3%, 99.2%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 96.7% [93.7%, 99.1%] |
| fever_null_attribution | 574 | **43** | 85.7% [76.4%, 93.5%] |
| fever_null_hedged | 828 | **63** | 83.7% [74.8%, 91.6%] |
| fever_null_historical | 511 | **36** | 94.7% [90.0%, 98.0%] |
| fever_null_metaphor | 641 | **47** | 97.5% [95.5%, 99.1%] |
| fever_null_thirdparty | 508 | **35** | 95.5% [91.3%, 99.2%] |
| fever_true | 1481 | **96** | 85.1% [78.7%, 91.0%] |
...
100 of 463 decisive fragments were got wrong at least once.
...
| `fever_true:ed36ef0f` | `fever_true` | -- | true | 0/12 | 0.0% | null 12 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 0/11 | 0.0% | false 8, true 3 |
| `fever_true:b950a4fc` | `fever_true` | -- | true | 0/11 | 0.0% | null 11 |
| `fever_null_hedged:9e333f46` | `fever_null_hedged` | hedged | null | 0/10 | 0.0% | false 10 |
| `fever_null_hedged:8d1c41e3` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | true 9 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | false 7, true 2 |
| `fever_null_historical:feadcb2c` | `fever_null_historical` | historical | null | 0/8 | 0.0% | true 8 |
| `fever_false:5c2a065d` | `fever_false` | -- | false | 1/30 | 3.3% | false 1, true 6, null 23 |
| `fever_null_hedged:081a5883` | `fever_null_hedged` | hedged | null | 1/16 | 6.2% | false 15, null 1 |
| `fever_null_attribution:1f21724c` | `fever_null_attribution` | attribution | null | 1/13 | 7.7% | true 12, null 1 |
...
| `fever_null_thirdparty:15f5a2bb` | `fever_null_thirdparty` | third_party | null | 1/10 | 10.0% | true 9, null 1 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 2/14 | 14.3% | true 2, null 12 |
| `fever_null_hedged:0de4380d` | `fever_null_hedged` | hedged | null | 3/20 | 15.0% | true 17, null 3 |
| `fever_null_attribution:1eb2016b` | `fever_null_attribution` | attribution | null | 2/12 | 16.7% | false 10, null 2 |
| `fever_false:e8c514ff` | `fever_false` | -- | false | 3/16 | 18.8% | false 3, true 13 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 2/10 | 20.0% | true 2, null 8 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 3/14 | 21.4% | false 1, true 3, null 10 |
| `fever_null_attribution:7830c8db` | `fever_null_attribution` | attribution | null | 2/9 | 22.2% | true 7, null 2 |
| `fever_null_hedged:17a3f60a` | `fever_null_hedged` | hedged | null | 2/9 | 22.2% | true 7, null 2 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 3/13 | 23.1% | true 10, null 3 |
| `fever_null_attribution:9b15a5f9` | `fever_null_attribution` | attribution | null | 3/9 | 33.3% | true 6, null 3 |
| `fever_null_historical:32fb44c1` | `fever_null_historical` | historical | null | 3/9 | 33.3% | true 6, null 3 |
| `fever_true:5ce7adbd` | `fever_true` | -- | true | 3/9 | 33.3% | true 3, null 6 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 7/19 | 36.8% | false 5, true 7, null 7 |
| `fever_true:dd7a11e2` | `fever_true` | -- | true | 4/10 | 40.0% | true 4, null 6 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 6/14 | 42.9% | true 6, null 8 |
| `fever_null_metaphor:4076133d` | `fever_null_metaphor` | metaphor | null | 3/7 | 42.9% | true 4, null 3 |
| `fever_true:01833454` | `fever_true` | -- | true | 7/16 | 43.8% | false 7, true 7, null 2 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 8/16 | 50.0% | false 8, true 8 |
| `fever_true:2ee57e4c` | `fever_true` | -- | true | 5/10 | 50.0% | true 5, null 5 |

*60 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 82.0% | 82.0% | 76.7% | 0.66% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 77.5% | 77.5% | 68.0% | 0.50% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 79.8% | 79.8% | 70.2% | 2.32% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 81.0% | 81.0% | 74.4% | 1.65% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 85.2% | 85.2% | 78.2% | 1.16% |
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 60.4% | 60.4% | 25.6% | 0.00% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 60.0% | 60.0% | 25.0% | 0.08% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 60.4% | 60.4% | 25.1% | 0.00% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 60.6% | 60.6% | 25.5% | 0.00% |
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 85.0% | 85.0% | 79.1% | 0.99% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 78.3% | 78.3% | 69.5% | 1.83% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 81.2% | 81.2% | 74.1% | 3.56% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 80.5% | 80.5% | 73.9% | 4.20% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 84.5% | 84.5% | 78.5% | 1.82% |

### `arm_b_finetune`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.45 | 97.5% | 97.4% | 96.4% | 0.00% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 93.8% | 93.8% | 91.7% | 1.33% |
| 2 | 10000 | 2000 | 2000 | 0.9 | 90.6% | 90.2% | 87.4% | 3.23% |
| 3 | 10000 | 2000 | 2000 | 0.9 | 93.2% | 93.8% | 91.6% | 5.10% |
| 4 | 10000 | 2000 | 2000 | 0.85 | 93.3% | 94.3% | 92.8% | 6.88% |
