...
*Generated 2026-08-19T21:59:04+00:00.*
...
|---|---|---|---|---|---|
| `fever_false` | 2479 | 0.0% | 0.2% | 64.0% | 64.0pp |
| `fever_true` | 1481 | 0.0% | 1.4% | 48.8% | 48.8pp |
| `fever_null_hedged` | 828 | 100.0% | 100.0% | 88.9% | 11.1pp |
| `fever_null_historical` | 511 | 100.0% | 100.0% | 91.2% | 8.8pp |
| `fever_null_thirdparty` | 508 | 100.0% | 100.0% | 91.7% | 8.3pp |
| `fever_null_attribution` | 574 | 100.0% | 99.5% | 93.4% | 6.6pp |
| `fever_null_metaphor` | 641 | 100.0% | 100.0% | 96.3% | 3.7pp |
| `(none)` | 2978 | 100.0% | 100.0% | 99.5% | 0.5pp |
...
|---|---|---|---|---|---|---|
| `fever_false:5a6a9b80` | `fever_false` | false | 40 | 40 | 0 | 40 |
| `fever_false:d0ca84a7` | `fever_false` | false | 37 | 37 | 1 | 36 |
| `fever_false:24e5c247` | `fever_false` | false | 36 | 36 | 10 | 26 |
...
| `fever_false:fc2ae0f2` | `fever_false` | false | 34 | 34 | 8 | 26 |
| `fever_false:5969c6c9` | `fever_false` | false | 33 | 33 | 2 | 31 |
| `fever_false:b9076eff` | `fever_false` | false | 33 | 33 | 12 | 21 |
| `fever_false:b96ed279` | `fever_false` | false | 33 | 33 | 33 | 0 |
| `fever_false:2b944abc` | `fever_false` | false | 32 | 32 | 1 | 31 |
| `fever_false:55bf1913` | `fever_false` | false | 32 | 32 | 0 | 32 |
| `fever_false:a5b671a1` | `fever_false` | false | 32 | 32 | 13 | 19 |
| `fever_false:cdf2609b` | `fever_false` | false | 32 | 32 | 30 | 2 |
| `fever_false:8d02bd9e` | `fever_false` | false | 31 | 31 | 20 | 11 |
| `fever_false:d5ed3ff1` | `fever_false` | false | 31 | 31 | 17 | 14 |
| `fever_false:de0596c4` | `fever_false` | false | 31 | 31 | 16 | 15 |
| `fever_false:e2aff3b8` | `fever_false` | false | 31 | 31 | 9 | 22 |
| `fever_false:f586e96d` | `fever_false` | false | 31 | 31 | 13 | 18 |
| `fever_false:56a45ff1` | `fever_false` | false | 30 | 30 | 4 | 26 |
| `fever_false:5c2a065d` | `fever_false` | false | 30 | 30 | 30 | 0 |
| `fever_false:c747066d` | `fever_false` | false | 30 | 30 | 4 | 26 |
| `fever_false:3a3043ff` | `fever_false` | false | 29 | 29 | 24 | 5 |
| `fever_false:463f8189` | `fever_false` | false | 29 | 29 | 1 | 28 |
| `fever_false:758d5434` | `fever_false` | false | 29 | 29 | 0 | 29 |
| `fever_false:7b64d17a` | `fever_false` | false | 29 | 29 | 21 | 8 |
| `fever_false:a4cda1e2` | `fever_false` | false | 29 | 29 | 3 | 26 |
| `fever_true:18173593` | `fever_true` | true | 29 | 29 | 17 | 12 |
| `fever_true:f3ee0d07` | `fever_true` | true | 29 | 29 | 1 | 28 |
| `fever_false:44cd09fd` | `fever_false` | false | 28 | 28 | 28 | 0 |
| `fever_false:a6c0d44a` | `fever_false` | false | 28 | 28 | 10 | 18 |
| `fever_false:cbf9d7a5` | `fever_false` | false | 28 | 28 | 28 | 0 |
| `fever_false:147d5cf0` | `fever_false` | false | 27 | 27 | 11 | 16 |
| `fever_false:3de7ecac` | `fever_false` | false | 27 | 27 | 27 | 0 |
| `fever_false:43f5b35d` | `fever_false` | false | 27 | 27 | 8 | 19 |
| `fever_false:8599e318` | `fever_false` | false | 27 | 27 | 3 | 24 |
| `fever_false:e70e24b6` | `fever_false` | false | 27 | 27 | 9 | 18 |
| `fever_true:753c7815` | `fever_true` | true | 27 | 27 | 0 | 27 |
| `fever_false:033927e6` | `fever_false` | false | 26 | 26 | 26 | 0 |

*233 further fragments erred on at least one model; the JSON holds them all.*
