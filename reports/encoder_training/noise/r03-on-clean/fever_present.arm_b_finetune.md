...
*Generated 2026-08-31T08:04:03+00:00.*
...
| artefacts | `models/encoder-noise/r03-on-clean/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.5% [91.3%, 95.4%] | 92.9% [90.6%, 95.0%] | 95.4% | 95.4% +/- 3.0% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 95.5% [89.6%, 99.5%] (eff n 43) | 87.3% [78.6%, 95.0%] (eff n 63) | 96.3% [91.5%, 99.7%] (eff n 36) | 99.5% [98.9%, 100.0%] (eff n 47) | 100.0% [100.0%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.5% [91.3%, 95.4%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.0, 0.9, 0.45, 0.0, 0.0. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 95.0% [92.2%, 97.5%] |
...
* `arm_b_finetune`: 457 errors across 59 of 463 decisive fragments. Half of them fall on **14** fragments (an even spread would be 29.5); the worst ten carry 40.5% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2363 | 40 | 76 | 2479 |
| **truth true** | 8 | 1304 | 169 | 1481 |
| **truth null** | 61 | 98 | 5881 | 6040 |
| **total** | 2432 | 1442 | 6126 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2366 | 36 | 77 | 2479 |
| **truth true** | 10 | 1290 | 181 | 1481 |
| **truth null** | 61 | 95 | 5884 | 6040 |
| **total** | 2437 | 1421 | 6142 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2437 | 97.1% | 95.4% | 96.3% |
| `true` | 1481 | 1421 | 90.8% | 87.1% | 88.9% |
| `null` | 6040 | 6142 | 95.8% | 97.4% | 96.6% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 95.4% [91.5%, 98.6%] |
| null_ambiguous | 3062 | **224** | 95.0% [92.2%, 97.5%] |
| null_structural | 2978 | **1** | 99.9% [99.9%, 99.9%] |
| true | 1481 | **96** | 87.1% [80.8%, 92.8%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 95.5% [89.6%, 99.5%] |
| hedged | 828 | **63** | 87.3% [78.6%, 95.0%] |
| historical | 511 | **36** | 96.3% [91.5%, 99.7%] |
...
|---|---|---|---|
| fever_false | 2479 | **98** | 95.4% [91.5%, 98.6%] |
| fever_null_attribution | 574 | **43** | 95.5% [89.6%, 99.5%] |
| fever_null_hedged | 828 | **63** | 87.3% [78.6%, 95.0%] |
| fever_null_historical | 511 | **36** | 96.3% [91.5%, 99.7%] |
| fever_null_metaphor | 641 | **47** | 99.5% [98.9%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 100.0% [100.0%, 100.0%] |
| fever_true | 1481 | **96** | 87.1% [80.8%, 92.8%] |
...
| `fever_null_hedged:0de4380d` | `fever_null_hedged` | hedged | null | 1/20 | 5.0% | true 19, null 1 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 1/13 | 7.7% | true 12, null 1 |
| `fever_true:c7489e90` | `fever_true` | -- | true | 2/19 | 10.5% | true 2, null 17 |
...
| `fever_true:c5d3e4a0` | `fever_true` | -- | true | 4/12 | 33.3% | false 2, true 4, null 6 |
...
| `fever_true:872e3af9` | `fever_true` | -- | true | 5/12 | 41.7% | false 1, true 5, null 6 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 15/29 | 51.7% | false 15, true 14 |
| `fever_null_hedged:bba323b8` | `fever_null_hedged` | hedged | null | 7/13 | 53.8% | true 6, null 7 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 17/27 | 63.0% | false 17, null 10 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 12/19 | 63.2% | true 12, null 7 |
| `fever_null_attribution:b03cf8b0` | `fever_null_attribution` | attribution | null | 8/11 | 72.7% | true 3, null 8 |
| `fever_false:44cd09fd` | `fever_false` | -- | false | 21/28 | 75.0% | false 21, null 7 |
| `fever_true:01833454` | `fever_true` | -- | true | 12/16 | 75.0% | true 12, null 4 |
| `fever_true:db1acb55` | `fever_true` | -- | true | 12/16 | 75.0% | false 4, true 12 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 11/14 | 78.6% | true 11, null 3 |
| `fever_false:ebac5db7` | `fever_false` | -- | false | 19/24 | 79.2% | false 19, null 5 |
...
| 1 | 10000 | 2000 | 2000 | 0.9 | 93.3% | 92.8% | 90.0% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.45 | 91.6% | 91.8% | 89.4% | 2.90% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 96.2% | 96.2% | 94.9% | 1.23% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 98.5% | 98.5% | 97.9% | 1.91% |
