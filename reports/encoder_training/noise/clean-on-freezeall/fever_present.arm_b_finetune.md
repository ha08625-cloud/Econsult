...
*Generated 2026-08-31T09:23:04+00:00.*
...
| test dataset dir | `data/synthetic/generated/noise/fever-r06-freezeall` |
| test dataset noise | `requested_rate 0.06, clean_share 0.25, freeze_signal_vocabulary all, seed 42` |
...
| artefacts | `models/encoder-noise/clean-on-freezeall/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 86.2% [83.3%, 88.9%] | 84.9% [81.6%, 87.8%] | 90.3% | 90.3% +/- 3.8% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 97.2% [93.8%, 99.6%] (eff n 43) | 92.5% [86.2%, 97.3%] (eff n 63) | 97.1% [93.1%, 100.0%] (eff n 36) | 99.7% [99.0%, 100.0%] (eff n 47) | 99.2% [98.0%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 86.2% [83.3%, 88.9%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.55, 0.0, 0.45, 0.1. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 96.8% [95.0%, 98.3%] |
...
* `arm_b_finetune`: 966 errors across 131 of 463 decisive fragments. Half of them fall on **28** fragments (an even spread would be 65.5); the worst ten carry 23.6% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2072 | 61 | 346 | 2479 |
| **truth true** | 14 | 1030 | 437 | 1481 |
| **truth null** | 34 | 71 | 5935 | 6040 |
| **total** | 2120 | 1162 | 6718 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2075 | 58 | 346 | 2479 |
| **truth true** | 14 | 1018 | 449 | 1481 |
| **truth null** | 34 | 66 | 5940 | 6040 |
| **total** | 2123 | 1142 | 6735 | 10000 |

`null -> true`: 66 of 6040 truly-null examples (1.09%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2123 | 97.7% | 83.7% | 90.2% |
| `true` | 1481 | 1142 | 89.1% | 68.7% | 77.6% |
| `null` | 6040 | 6735 | 88.2% | 98.3% | 93.0% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 83.7% [78.0%, 88.7%] |
| null_ambiguous | 3062 | **224** | 96.8% [95.0%, 98.3%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **96** | 68.7% [61.1%, 76.1%] |
...
| hedged | 828 | **63** | 92.5% [86.2%, 97.3%] |
| historical | 511 | **36** | 97.1% [93.1%, 100.0%] |
...
|---|---|---|---|
| fever_false | 2479 | **98** | 83.7% [78.0%, 88.7%] |
| fever_null_attribution | 574 | **43** | 97.2% [93.8%, 99.6%] |
| fever_null_hedged | 828 | **63** | 92.5% [86.2%, 97.3%] |
| fever_null_historical | 511 | **36** | 97.1% [93.1%, 100.0%] |
| fever_null_metaphor | 641 | **47** | 99.7% [99.0%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 99.2% [98.0%, 100.0%] |
| fever_true | 1481 | **96** | 68.7% [61.1%, 76.1%] |
...
131 of 463 decisive fragments were got wrong at least once.
...
| `fever_true:b2d63b07` | `fever_true` | -- | true | 1/7 | 14.3% | true 1, null 6 |
...
| `fever_true:dd6bbec4` | `fever_true` | -- | true | 6/24 | 25.0% | true 6, null 18 |
...
*91 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.55 | 96.2% | 96.0% | 95.2% | 0.99% |
| 1 | 10000 | 2000 | 2000 | 0.55 | 89.7% | 89.8% | 86.4% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 89.9% | 89.9% | 86.0% | 1.90% |
| 3 | 10000 | 2000 | 2000 | 0.45 | 85.3% | 85.2% | 78.9% | 1.15% |
| 4 | 10000 | 2000 | 2000 | 0.1 | 90.8% | 90.8% | 86.5% | 0.25% |
