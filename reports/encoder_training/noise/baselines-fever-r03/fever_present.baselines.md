...
*Generated 2026-08-19T21:57:42+00:00.*
...
|---|---|---|---|---|---|
| `fever_false` | 2479 | 0.0% | 0.2% | 64.3% | 64.3pp |
| `fever_true` | 1481 | 0.0% | 1.4% | 49.3% | 49.3pp |
| `fever_null_hedged` | 828 | 100.0% | 100.0% | 88.3% | 11.7pp |
| `fever_null_historical` | 511 | 100.0% | 100.0% | 91.2% | 8.8pp |
| `fever_null_thirdparty` | 508 | 100.0% | 100.0% | 92.9% | 7.1pp |
| `fever_null_attribution` | 574 | 100.0% | 99.5% | 94.4% | 5.6pp |
| `fever_null_metaphor` | 641 | 100.0% | 100.0% | 97.0% | 3.0pp |
| `(none)` | 2978 | 100.0% | 100.0% | 99.3% | 0.7pp |
...
| `fever_false:0429068c` | `fever_false` | false | 34 | 34 | 19 | 15 |
| `fever_false:17f6c637` | `fever_false` | false | 34 | 34 | 0 | 34 |
| `fever_false:9f46e710` | `fever_false` | false | 34 | 34 | 0 | 34 |
| `fever_false:fc2ae0f2` | `fever_false` | false | 34 | 34 | 7 | 27 |
| `fever_false:5969c6c9` | `fever_false` | false | 33 | 33 | 1 | 32 |
| `fever_false:b9076eff` | `fever_false` | false | 33 | 33 | 13 | 20 |
| `fever_false:b96ed279` | `fever_false` | false | 33 | 33 | 33 | 0 |
| `fever_false:2b944abc` | `fever_false` | false | 32 | 32 | 0 | 32 |
| `fever_false:55bf1913` | `fever_false` | false | 32 | 32 | 0 | 32 |
| `fever_false:a5b671a1` | `fever_false` | false | 32 | 32 | 14 | 18 |
| `fever_false:cdf2609b` | `fever_false` | false | 32 | 32 | 29 | 3 |
| `fever_false:8d02bd9e` | `fever_false` | false | 31 | 31 | 21 | 10 |
| `fever_false:d5ed3ff1` | `fever_false` | false | 31 | 31 | 18 | 13 |
| `fever_false:de0596c4` | `fever_false` | false | 31 | 31 | 16 | 15 |
| `fever_false:e2aff3b8` | `fever_false` | false | 31 | 31 | 9 | 22 |
| `fever_false:f586e96d` | `fever_false` | false | 31 | 31 | 11 | 20 |
| `fever_false:56a45ff1` | `fever_false` | false | 30 | 30 | 5 | 25 |
| `fever_false:5c2a065d` | `fever_false` | false | 30 | 30 | 30 | 0 |
| `fever_false:c747066d` | `fever_false` | false | 30 | 30 | 0 | 30 |
| `fever_false:3a3043ff` | `fever_false` | false | 29 | 29 | 27 | 2 |
| `fever_false:463f8189` | `fever_false` | false | 29 | 29 | 0 | 29 |
| `fever_false:758d5434` | `fever_false` | false | 29 | 29 | 0 | 29 |
| `fever_false:7b64d17a` | `fever_false` | false | 29 | 29 | 23 | 6 |
| `fever_false:a4cda1e2` | `fever_false` | false | 29 | 29 | 0 | 29 |
| `fever_true:18173593` | `fever_true` | true | 29 | 29 | 16 | 13 |
...
| `fever_false:147d5cf0` | `fever_false` | false | 27 | 27 | 13 | 14 |
| `fever_false:3de7ecac` | `fever_false` | false | 27 | 27 | 27 | 0 |
| `fever_false:43f5b35d` | `fever_false` | false | 27 | 27 | 3 | 24 |
| `fever_false:8599e318` | `fever_false` | false | 27 | 27 | 2 | 25 |
| `fever_false:e70e24b6` | `fever_false` | false | 27 | 27 | 7 | 20 |
| `fever_true:753c7815` | `fever_true` | true | 27 | 27 | 0 | 27 |
| `fever_false:033927e6` | `fever_false` | false | 26 | 26 | 26 | 0 |

*229 further fragments erred on at least one model; the JSON holds them all.*
