...
*Generated 2026-08-19T21:56:26+00:00.*
...
| `fever_true` | 1481 | 0.0% | 1.4% | 48.2% | 48.2pp |
| `fever_null_hedged` | 828 | 100.0% | 100.0% | 89.0% | 11.0pp |
| `fever_null_thirdparty` | 508 | 100.0% | 100.0% | 92.5% | 7.5pp |
| `fever_null_historical` | 511 | 100.0% | 100.0% | 93.0% | 7.0pp |
| `fever_null_attribution` | 574 | 100.0% | 99.5% | 94.3% | 5.7pp |
| `fever_null_metaphor` | 641 | 100.0% | 100.0% | 97.7% | 2.3pp |
| `(none)` | 2978 | 100.0% | 100.0% | 99.6% | 0.4pp |
...
| `fever_false:0429068c` | `fever_false` | false | 34 | 34 | 21 | 13 |
| `fever_false:17f6c637` | `fever_false` | false | 34 | 34 | 0 | 34 |
| `fever_false:9f46e710` | `fever_false` | false | 34 | 34 | 0 | 34 |
| `fever_false:fc2ae0f2` | `fever_false` | false | 34 | 34 | 5 | 29 |
...
| `fever_false:a5b671a1` | `fever_false` | false | 32 | 32 | 16 | 16 |
...
| `fever_false:de0596c4` | `fever_false` | false | 31 | 31 | 18 | 13 |
| `fever_false:e2aff3b8` | `fever_false` | false | 31 | 31 | 10 | 21 |
| `fever_false:f586e96d` | `fever_false` | false | 31 | 31 | 10 | 21 |
...
| `fever_false:147d5cf0` | `fever_false` | false | 27 | 27 | 14 | 13 |
| `fever_false:3de7ecac` | `fever_false` | false | 27 | 27 | 27 | 0 |
| `fever_false:43f5b35d` | `fever_false` | false | 27 | 27 | 2 | 25 |
| `fever_false:8599e318` | `fever_false` | false | 27 | 27 | 0 | 27 |
...
*222 further fragments erred on at least one model; the JSON holds them all.*
