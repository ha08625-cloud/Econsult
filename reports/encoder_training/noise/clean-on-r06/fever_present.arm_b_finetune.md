...
*Generated 2026-08-31T08:15:03+00:00.*
...
| test dataset dir | `data/synthetic/generated/noise/fever-r06` |
| test dataset noise | `requested_rate 0.06, clean_share 0.25, freeze_signal_vocabulary short, seed 42` |
...
| artefacts | `models/encoder-noise/clean-on-r06/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 86.0% [83.1%, 88.7%] | 84.6% [81.3%, 87.5%] | 90.1% | 90.1% +/- 3.7% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 97.2% [93.8%, 99.6%] (eff n 43) | 92.6% [86.6%, 97.3%] (eff n 63) | 97.3% [93.6%, 100.0%] (eff n 36) | 99.7% [99.0%, 100.0%] (eff n 47) | 99.2% [98.0%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 86.0% [83.1%, 88.7%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.55, 0.0, 0.45, 0.1. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 96.8% [95.0%, 98.4%] |
...
* `arm_b_finetune`: 986 errors across 139 of 463 decisive fragments. Half of them fall on **28** fragments (an even spread would be 69.5); the worst ten carry 23.1% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2060 | 60 | 359 | 2479 |
| **truth true** | 16 | 1019 | 446 | 1481 |
| **truth null** | 34 | 69 | 5937 | 6040 |
| **total** | 2110 | 1148 | 6742 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2063 | 57 | 359 | 2479 |
| **truth true** | 16 | 1008 | 457 | 1481 |
| **truth null** | 34 | 64 | 5942 | 6040 |
| **total** | 2113 | 1129 | 6758 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2113 | 97.6% | 83.2% | 89.9% |
| `true` | 1481 | 1129 | 89.3% | 68.1% | 77.2% |
| `null` | 6040 | 6758 | 87.9% | 98.4% | 92.9% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 83.2% [77.7%, 88.3%] |
| null_ambiguous | 3062 | **224** | 96.8% [95.0%, 98.4%] |
| null_structural | 2978 | **1** | 100.0% [100.0%, 100.0%] |
| true | 1481 | **96** | 68.1% [60.5%, 75.4%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 97.2% [93.8%, 99.6%] |
| hedged | 828 | **63** | 92.6% [86.6%, 97.3%] |
| historical | 511 | **36** | 97.3% [93.6%, 100.0%] |
| metaphor | 641 | **47** | 99.7% [99.0%, 100.0%] |
| third_party | 508 | **35** | 99.2% [98.0%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 83.2% [77.7%, 88.3%] |
| fever_null_attribution | 574 | **43** | 97.2% [93.8%, 99.6%] |
| fever_null_hedged | 828 | **63** | 92.6% [86.6%, 97.3%] |
| fever_null_historical | 511 | **36** | 97.3% [93.6%, 100.0%] |
| fever_null_metaphor | 641 | **47** | 99.7% [99.0%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 99.2% [98.0%, 100.0%] |
| fever_true | 1481 | **96** | 68.1% [60.5%, 75.4%] |
...
139 of 463 decisive fragments were got wrong at least once.
...
| `fever_true:cccc5a01` | `fever_true` | -- | true | 0/12 | 0.0% | null 12 |
...
| `fever_false:e8c514ff` | `fever_false` | -- | false | 1/16 | 6.2% | false 1, true 3, null 12 |
...
| `fever_true:c04381bc` | `fever_true` | -- | true | 1/11 | 9.1% | true 1, null 10 |
| `fever_null_historical:1b314733` | `fever_null_historical` | historical | null | 1/8 | 12.5% | true 7, null 1 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 4/29 | 13.8% | false 4, true 23, null 2 |
...
| `fever_false:f6985a04` | `fever_false` | -- | false | 4/22 | 18.2% | false 4, null 18 |
| `fever_true:b950a4fc` | `fever_true` | -- | true | 2/11 | 18.2% | true 2, null 9 |
| `fever_true:eefafcd3` | `fever_true` | -- | true | 3/16 | 18.8% | true 3, null 13 |
| `fever_false:f7d03fcb` | `fever_false` | -- | false | 4/21 | 19.0% | false 4, null 17 |
| `fever_true:f3ee0d07` | `fever_true` | -- | true | 6/29 | 20.7% | true 6, null 23 |
| `fever_true:15a05d92` | `fever_true` | -- | true | 5/24 | 20.8% | true 5, null 19 |
| `fever_true:dd6bbec4` | `fever_true` | -- | true | 5/24 | 20.8% | true 5, null 19 |
| `fever_false:a6c0d44a` | `fever_false` | -- | false | 6/28 | 21.4% | false 6, null 22 |
| `fever_false:8f64f673` | `fever_false` | -- | false | 4/18 | 22.2% | false 4, null 14 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 2/9 | 22.2% | false 7, null 2 |
| `fever_null_hedged:cf95d564` | `fever_null_hedged` | hedged | null | 3/13 | 23.1% | true 10, null 3 |
| `fever_true:f885b3cb` | `fever_true` | -- | true | 3/13 | 23.1% | true 3, null 10 |
| `fever_true:3d00c372` | `fever_true` | -- | true | 6/25 | 24.0% | true 6, null 19 |
| `fever_true:76170ee2` | `fever_true` | -- | true | 6/25 | 24.0% | true 6, null 19 |
| `fever_true:01833454` | `fever_true` | -- | true | 4/16 | 25.0% | false 2, true 4, null 10 |
| `fever_true:74ccf7bd` | `fever_true` | -- | true | 3/12 | 25.0% | true 3, null 9 |
| `fever_true:3ccb7c24` | `fever_true` | -- | true | 4/15 | 26.7% | true 4, null 11 |
| `fever_true:5441ccb2` | `fever_true` | -- | true | 4/15 | 26.7% | true 4, null 11 |
| `fever_false:b9076eff` | `fever_false` | -- | false | 9/33 | 27.3% | false 9, null 24 |
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 3/11 | 27.3% | false 7, true 1, null 3 |
| `fever_false:90623989` | `fever_false` | -- | false | 5/18 | 27.8% | false 5, true 1, null 12 |
| `fever_true:b2d63b07` | `fever_true` | -- | true | 2/7 | 28.6% | true 2, null 5 |

*99 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.55 | 95.8% | 95.5% | 94.8% | 0.99% |
| 1 | 10000 | 2000 | 2000 | 0.55 | 89.8% | 89.8% | 86.4% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 89.6% | 89.6% | 85.6% | 1.99% |
| 3 | 10000 | 2000 | 2000 | 0.45 | 85.0% | 85.0% | 78.6% | 0.91% |
| 4 | 10000 | 2000 | 2000 | 0.1 | 90.6% | 90.6% | 86.3% | 0.25% |
