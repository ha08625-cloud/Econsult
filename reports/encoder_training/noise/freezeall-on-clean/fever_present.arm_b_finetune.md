...
*Generated 2026-08-31T09:34:09+00:00.*
...
| artefacts | `models/encoder-noise/freezeall-on-clean/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.0% [90.9%, 94.9%] | 92.2% [89.8%, 94.2%] | 95.0% | 95.0% +/- 2.1% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 89.0% [81.0%, 95.7%] (eff n 43) | 83.3% [74.3%, 91.5%] (eff n 63) | 96.5% [92.3%, 99.2%] (eff n 36) | 99.1% [97.9%, 100.0%] (eff n 47) | 96.7% [92.8%, 99.8%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.0% [90.9%, 94.9%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.45, 0.0, 0.9, 0.9, 0.85. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 92.1% [88.9%, 95.0%] |
...
* `arm_b_finetune`: 493 errors across 73 of 463 decisive fragments. Half of them fall on **18** fragments (an even spread would be 36.5); the worst ten carry 33.7% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2414 | 32 | 33 | 2479 |
| **truth true** | 19 | 1308 | 154 | 1481 |
| **truth null** | 89 | 215 | 5736 | 6040 |
| **total** | 2522 | 1555 | 5923 | 10000 |

`null -> true`: 215 of 6040 truly-null examples (3.56%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2427 | 19 | 33 | 2479 |
| **truth true** | 28 | 1282 | 171 | 1481 |
| **truth null** | 92 | 162 | 5786 | 6040 |
| **total** | 2547 | 1463 | 5990 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2547 | 95.3% | 97.9% | 96.6% |
| `true` | 1481 | 1463 | 87.6% | 86.6% | 87.1% |
| `null` | 6040 | 5990 | 96.6% | 95.8% | 96.2% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 97.9% [95.0%, 99.8%] |
| null_ambiguous | 3062 | **224** | 92.1% [88.9%, 95.0%] |
| null_structural | 2978 | **1** | 99.6% [99.6%, 99.6%] |
| true | 1481 | **96** | 86.6% [80.3%, 92.2%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 89.0% [81.0%, 95.7%] |
| hedged | 828 | **63** | 83.3% [74.3%, 91.5%] |
| historical | 511 | **36** | 96.5% [92.3%, 99.2%] |
| metaphor | 641 | **47** | 99.1% [97.9%, 100.0%] |
| third_party | 508 | **35** | 96.7% [92.8%, 99.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 97.9% [95.0%, 99.8%] |
| fever_null_attribution | 574 | **43** | 89.0% [81.0%, 95.7%] |
| fever_null_hedged | 828 | **63** | 83.3% [74.3%, 91.5%] |
| fever_null_historical | 511 | **36** | 96.5% [92.3%, 99.2%] |
| fever_null_metaphor | 641 | **47** | 99.1% [97.9%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 96.7% [92.8%, 99.8%] |
| fever_true | 1481 | **96** | 86.6% [80.3%, 92.2%] |
...
73 of 463 decisive fragments were got wrong at least once.

`arm_b_finetune`: 493 errors across 73 of 463 decisive fragments. Half of them fall on **18** fragments (an even spread would be 36.5); the worst ten carry 33.7% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/30 | 0.0% | true 3, null 27 |
...
| `fever_null_attribution:1eb2016b` | `fever_null_attribution` | attribution | null | 1/12 | 8.3% | false 11, null 1 |
...
| `fever_null_attribution:7830c8db` | `fever_null_attribution` | attribution | null | 1/9 | 11.1% | true 8, null 1 |
...
| `fever_true:97087dd7` | `fever_true` | -- | true | 3/14 | 21.4% | true 3, null 11 |
| `fever_true:dd7a11e2` | `fever_true` | -- | true | 3/10 | 30.0% | true 3, null 7 |
| `fever_false:e8c514ff` | `fever_false` | -- | false | 5/16 | 31.2% | false 5, true 11 |
| `fever_true:01833454` | `fever_true` | -- | true | 5/16 | 31.2% | false 9, true 5, null 2 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 5/14 | 35.7% | false 1, true 5, null 8 |
| `fever_null_attribution:d52abc40` | `fever_null_attribution` | attribution | null | 4/10 | 40.0% | false 6, null 4 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 4/10 | 40.0% | true 4, null 6 |
| `fever_null_hedged:917d0e09` | `fever_null_hedged` | hedged | null | 5/12 | 41.7% | true 7, null 5 |
| `fever_null_hedged:bba323b8` | `fever_null_hedged` | hedged | null | 6/13 | 46.2% | true 7, null 6 |
| `fever_true:c7489e90` | `fever_true` | -- | true | 10/19 | 52.6% | true 10, null 9 |
| `fever_true:34ea6a85` | `fever_true` | -- | true | 7/13 | 53.8% | false 6, true 7 |
| `fever_null_historical:32fb44c1` | `fever_null_historical` | historical | null | 5/9 | 55.6% | true 4, null 5 |
| `fever_true:2ee57e4c` | `fever_true` | -- | true | 6/10 | 60.0% | true 6, null 4 |
| `fever_null_attribution:1f21724c` | `fever_null_attribution` | attribution | null | 8/13 | 61.5% | true 5, null 8 |
| `fever_null_attribution:eb9e8ecd` | `fever_null_attribution` | attribution | null | 7/11 | 63.6% | false 4, null 7 |

*33 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.45 | 98.0% | 98.0% | 97.1% | 0.00% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 94.2% | 94.2% | 92.1% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.9 | 92.2% | 92.4% | 90.4% | 2.40% |
| 3 | 10000 | 2000 | 2000 | 0.9 | 93.8% | 94.5% | 92.5% | 4.53% |
| 4 | 10000 | 2000 | 2000 | 0.85 | 94.8% | 95.8% | 94.3% | 5.31% |
