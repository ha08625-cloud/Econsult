...
*Generated 2026-08-31T08:37:08+00:00.*
...
| test dataset dir | `data/synthetic/generated/noise/fever-r12` |
| test dataset noise | `requested_rate 0.12, clean_share 0.25, freeze_signal_vocabulary short, seed 42` |
...
| artefacts | `models/encoder-noise/clean-on-r12/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 84.8% [81.8%, 87.5%] | 83.2% [80.0%, 86.3%] | 89.3% | 89.3% +/- 3.6% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 97.4% [93.8%, 99.8%] (eff n 43) | 93.2% [87.8%, 97.4%] (eff n 63) | 97.3% [93.5%, 100.0%] (eff n 36) | 99.1% [97.5%, 100.0%] (eff n 47) | 99.0% [97.5%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 84.8% [81.8%, 87.5%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.55, 0.55, 0.0, 0.45, 0.1. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 96.9% [95.2%, 98.3%] |
...
* `arm_b_finetune`: 1070 errors across 153 of 463 decisive fragments. Half of them fall on **31** fragments (an even spread would be 76.5); the worst ten carry 20.7% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2018 | 54 | 407 | 2479 |
| **truth true** | 21 | 975 | 485 | 1481 |
| **truth null** | 29 | 70 | 5941 | 6040 |
| **total** | 2068 | 1099 | 6833 | 10000 |
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2019 | 53 | 407 | 2479 |
| **truth true** | 21 | 967 | 493 | 1481 |
| **truth null** | 29 | 69 | 5942 | 6040 |
| **total** | 2069 | 1089 | 6842 | 10000 |
...
|---|---|---|---|---|---|
| `false` | 2479 | 2069 | 97.6% | 81.4% | 88.8% |
| `true` | 1481 | 1089 | 88.8% | 65.3% | 75.3% |
| `null` | 6040 | 6842 | 86.8% | 98.4% | 92.3% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 81.4% [76.1%, 86.4%] |
| null_ambiguous | 3062 | **224** | 96.9% [95.2%, 98.3%] |
| null_structural | 2978 | **1** | 99.9% [99.9%, 99.9%] |
| true | 1481 | **96** | 65.3% [57.9%, 72.6%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 97.4% [93.8%, 99.8%] |
| hedged | 828 | **63** | 93.2% [87.8%, 97.4%] |
| historical | 511 | **36** | 97.3% [93.5%, 100.0%] |
| metaphor | 641 | **47** | 99.1% [97.5%, 100.0%] |
| third_party | 508 | **35** | 99.0% [97.5%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 81.4% [76.1%, 86.4%] |
| fever_null_attribution | 574 | **43** | 97.4% [93.8%, 99.8%] |
| fever_null_hedged | 828 | **63** | 93.2% [87.8%, 97.4%] |
| fever_null_historical | 511 | **36** | 97.3% [93.5%, 100.0%] |
| fever_null_metaphor | 641 | **47** | 99.1% [97.5%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 99.0% [97.5%, 100.0%] |
| fever_true | 1481 | **96** | 65.3% [57.9%, 72.6%] |
...
153 of 463 decisive fragments were got wrong at least once.
...
| `fever_true:3ccb7c24` | `fever_true` | -- | true | 1/15 | 6.7% | true 1, null 14 |
...
| `fever_false:ebac5db7` | `fever_false` | -- | false | 4/24 | 16.7% | false 4, null 20 |
| `fever_true:15a05d92` | `fever_true` | -- | true | 4/24 | 16.7% | true 4, null 20 |
...
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 2/11 | 18.2% | false 7, true 2, null 2 |
...
| `fever_null_hedged:5bf1b63f` | `fever_null_hedged` | hedged | null | 3/14 | 21.4% | true 11, null 3 |
| `fever_false:de0596c4` | `fever_false` | -- | false | 7/31 | 22.6% | false 7, null 24 |
...
| `fever_true:f3ee0d07` | `fever_true` | -- | true | 7/29 | 24.1% | true 7, null 22 |
...
| `fever_false:e70e24b6` | `fever_false` | -- | false | 7/27 | 25.9% | false 7, true 18, null 2 |
| `fever_true:c7489e90` | `fever_true` | -- | true | 5/19 | 26.3% | true 5, null 14 |
| `fever_true:1c3df822` | `fever_true` | -- | true | 7/26 | 26.9% | true 7, null 19 |
| `fever_false:b9076eff` | `fever_false` | -- | false | 9/33 | 27.3% | false 9, null 24 |
| `fever_false:f6985a04` | `fever_false` | -- | false | 6/22 | 27.3% | false 6, null 16 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 8/29 | 27.6% | false 8, true 17, null 4 |
| `fever_false:8f64f673` | `fever_false` | -- | false | 5/18 | 27.8% | false 5, null 13 |

*113 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.55 | 94.6% | 94.5% | 93.3% | 1.16% |
| 1 | 10000 | 2000 | 2000 | 0.55 | 89.0% | 89.0% | 85.1% | 1.16% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 88.6% | 88.6% | 84.2% | 2.07% |
| 3 | 10000 | 2000 | 2000 | 0.45 | 84.7% | 84.5% | 78.0% | 1.15% |
| 4 | 10000 | 2000 | 2000 | 0.1 | 89.8% | 89.8% | 85.1% | 0.17% |
