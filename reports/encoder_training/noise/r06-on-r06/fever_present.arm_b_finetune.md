...
*Generated 2026-08-31T07:18:04+00:00.*
...
| split salt | `0` |
| dataset dir | `data/synthetic/generated/noise/fever-r06` |
...
| artefacts | `models/encoder-noise/r06-on-r06/fever_present/arm_b_finetune` |
| weights | `models/encoder-noise/r06-on-r06/fever_present/arm_b_finetune/weights -- ~440MB per fold, not committed` |
...
| `tfidf_logreg` | baseline | 7022 | **418** | 73.1% [69.6%, 76.5%] | 70.2% [66.3%, 73.9%] | 80.9% | 80.9% +/- 2.7% |
| `length_only__shuffled` | negative control | 7022 | **418** | 43.6% [38.6%, 48.8%] | 20.2% [18.6%, 21.9%] | 60.4% | 60.4% +/- 0.2% |
| `tfidf_logreg__shuffled` | negative control | 7022 | **418** | 43.5% [38.5%, 48.7%] | 20.5% [18.8%, 22.2%] | 60.2% | 60.2% +/- 0.4% |
| `arm_a_probe` | probe | 7022 | **418** | 74.7% [71.7%, 77.7%] | 72.0% [68.7%, 75.2%] | 81.8% | 81.8% +/- 2.4% |
| `arm_b_finetune` | finetune | 7022 | **418** | 92.8% [90.7%, 94.8%] | 92.1% [89.7%, 94.2%] | 94.7% | 94.7% +/- 2.3% |
...
| `tfidf_logreg` | -- | 93.4% [89.4%, 96.8%] (eff n 43) | 88.9% [82.0%, 94.6%] (eff n 63) | 91.2% [85.9%, 95.5%] (eff n 36) | 96.3% [93.5%, 98.4%] (eff n 47) | 91.7% [86.6%, 96.3%] (eff n 35) |
...
| `tfidf_logreg__shuffled` | -- | 99.3% [98.4%, 100.0%] (eff n 43) | 99.9% [99.6%, 100.0%] (eff n 63) | 99.0% [98.2%, 99.8%] (eff n 36) | 99.1% [98.3%, 99.7%] (eff n 47) | 99.4% [98.7%, 100.0%] (eff n 35) |
| `arm_a_probe` | -- | 87.1% [81.1%, 92.5%] (eff n 43) | 75.6% [69.2%, 81.6%] (eff n 63) | 87.5% [82.8%, 91.7%] (eff n 36) | 95.8% [93.3%, 97.9%] (eff n 47) | 93.3% [90.0%, 96.5%] (eff n 35) |
| `arm_b_finetune` | -- | 92.5% [86.7%, 97.3%] (eff n 43) | 83.2% [73.6%, 91.8%] (eff n 63) | 95.9% [91.5%, 99.0%] (eff n 36) | 98.1% [96.0%, 99.7%] (eff n 47) | 98.4% [96.6%, 99.8%] (eff n 35) |
...
|---|---|---|
| `fever_present` | 49 | 25.3% |

### `arm_b_finetune`

Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 92.8% [90.7%, 94.8%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.2, 0.1, 0.9, 0.75, 0.25. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.

| signal | true/false/null | omitted | decisive n | decisive acc (mean +/- sd) | worst-case half-width | all n | all acc (mean +/- sd) | null recall |
|---|---|---|---|---|---|---|---|---|
| `fever_present` | 9/9/49 | 0 | 18 | 78.9% +/- 9.9% | +/-23.1% | 67 | 72.8% +/- 14.9% | 70.6% +/- 22.1% |

`null -> true` on real text, per fold: `fever_present` 7, 25, 2, 3, 25 of 49. This is the cell that invents a symptom into a patient's pre-filled form, counted here on submissions rather than on recombinations.
...
| `tfidf_logreg` | baseline | 3062 | **224** | 92.1% [89.7%, 94.2%] |
| `arm_a_probe` | probe | 3062 | **224** | 86.9% [84.4%, 89.3%] |
| `arm_b_finetune` | finetune | 3062 | **224** | 92.7% [89.5%, 95.5%] |
...
| `majority_class` vs `tfidf_logreg` | 3062 | 241 | 0 | 5.66e-73 |
| `majority_class` vs `arm_a_probe` | 3062 | 401 | 0 | 3.87e-121 |
| `majority_class` vs `arm_b_finetune` | 3062 | 236 | 0 | 1.81e-71 |
| `length_only` vs `tfidf_logreg` | 3062 | 240 | 2 | 8.32e-69 |
| `length_only` vs `arm_a_probe` | 3062 | 399 | 1 | 3.11e-118 |
| `length_only` vs `arm_b_finetune` | 3062 | 235 | 2 | 2.55e-67 |
| `tfidf_logreg` vs `arm_a_probe` | 3062 | 309 | 149 | 6.08e-14 |
| `tfidf_logreg` vs `arm_b_finetune` | 3062 | 157 | 162 | 0.823 |
| `arm_a_probe` vs `arm_b_finetune` | 3062 | 143 | 308 | 5.7e-15 |
...
* `tfidf_logreg`: 1891 errors across 233 of 463 decisive fragments. Half of them fall on **48** fragments (an even spread would be 116.5); the worst ten carry 14.5% of all errors.
* `arm_a_probe`: 1779 errors across 295 of 463 decisive fragments. Half of them fall on **57** fragments (an even spread would be 147.5); the worst ten carry 13.0% of all errors.
* `arm_b_finetune`: 505 errors across 95 of 463 decisive fragments. Half of them fall on **16** fragments (an even spread would be 47.5); the worst ten carry 35.8% of all errors.
...
| `tfidf_logreg__shuffled` | 60.2% [39.9%, 76.1%] | 25.4% [19.3%, 29.2%] |
...
| `majority_class` vs `tfidf_logreg` | overall | 10000 | 257 | 2310 | 0 |
| `majority_class` vs `tfidf_logreg` | null_ambiguous | 3062 | 241 | 0 | 5.66e-73 |
| `majority_class` vs `arm_a_probe` | overall | 10000 | 441 | 2582 | 0 |
| `majority_class` vs `arm_a_probe` | null_ambiguous | 3062 | 401 | 0 | 3.87e-121 |
| `majority_class` vs `arm_b_finetune` | overall | 10000 | 262 | 3685 | 0 |
| `majority_class` vs `arm_b_finetune` | null_ambiguous | 3062 | 236 | 0 | 1.81e-71 |
| `length_only` vs `tfidf_logreg` | overall | 10000 | 256 | 2288 | 0 |
| `length_only` vs `tfidf_logreg` | null_ambiguous | 3062 | 240 | 2 | 8.32e-69 |
| `length_only` vs `arm_a_probe` | overall | 10000 | 456 | 2576 | 0 |
| `length_only` vs `arm_a_probe` | null_ambiguous | 3062 | 399 | 1 | 3.11e-118 |
| `length_only` vs `arm_b_finetune` | overall | 10000 | 261 | 3663 | 0 |
| `length_only` vs `arm_b_finetune` | null_ambiguous | 3062 | 235 | 2 | 2.55e-67 |
| `tfidf_logreg` vs `arm_a_probe` | overall | 10000 | 810 | 898 | 0.0353 |
| `tfidf_logreg` vs `arm_a_probe` | null_ambiguous | 3062 | 309 | 149 | 6.08e-14 |
| `tfidf_logreg` vs `arm_b_finetune` | overall | 10000 | 220 | 1590 | 6.35e-256 |
| `tfidf_logreg` vs `arm_b_finetune` | null_ambiguous | 3062 | 157 | 162 | 0.823 |
| `arm_a_probe` vs `arm_b_finetune` | overall | 10000 | 235 | 1517 | 2.15e-229 |
| `arm_a_probe` vs `arm_b_finetune` | null_ambiguous | 3062 | 143 | 308 | 5.7e-15 |
...
|---|---|---|---|---|---|---|---|
| `fever_false` | 2479 | 0.0% | 0.2% | 64.0% | 73.0% | 94.6% | 94.6pp |
| `fever_true` | 1481 | 0.0% | 1.4% | 48.8% | 52.2% | 89.9% | 89.9pp |
| `fever_null_hedged` | 828 | 100.0% | 100.0% | 88.9% | 75.6% | 83.2% | 24.4pp |
| `fever_null_attribution` | 574 | 100.0% | 99.5% | 93.4% | 87.1% | 92.5% | 12.9pp |
| `fever_null_historical` | 511 | 100.0% | 100.0% | 91.2% | 87.5% | 95.9% | 12.5pp |
| `fever_null_thirdparty` | 508 | 100.0% | 100.0% | 91.7% | 93.3% | 98.4% | 8.3pp |
| `fever_null_metaphor` | 641 | 100.0% | 100.0% | 96.3% | 95.8% | 98.1% | 4.2pp |
| `(none)` | 2978 | 100.0% | 100.0% | 99.5% | 98.7% | 99.2% | 1.3pp |
...
|---|---|---|---|---|---|---|---|---|
| `fever_false:5a6a9b80` | `fever_false` | false | 40 | 40 | 0 | 4 | 0 | 40 |
| `fever_false:d0ca84a7` | `fever_false` | false | 37 | 37 | 1 | 1 | 0 | 37 |
| `fever_false:24e5c247` | `fever_false` | false | 36 | 36 | 10 | 9 | 2 | 34 |
...
| `fever_false:9f46e710` | `fever_false` | false | 34 | 34 | 1 | 4 | 0 | 34 |
| `fever_false:fc2ae0f2` | `fever_false` | false | 34 | 34 | 8 | 7 | 0 | 34 |
| `fever_false:5969c6c9` | `fever_false` | false | 33 | 33 | 2 | 10 | 1 | 32 |
| `fever_false:b9076eff` | `fever_false` | false | 33 | 33 | 12 | 22 | 4 | 29 |
| `fever_false:b96ed279` | `fever_false` | false | 33 | 33 | 33 | 16 | 0 | 33 |
| `fever_false:2b944abc` | `fever_false` | false | 32 | 32 | 1 | 1 | 0 | 32 |
| `fever_false:55bf1913` | `fever_false` | false | 32 | 32 | 0 | 0 | 0 | 32 |
| `fever_false:a5b671a1` | `fever_false` | false | 32 | 32 | 13 | 28 | 0 | 32 |
| `fever_false:cdf2609b` | `fever_false` | false | 32 | 32 | 30 | 8 | 1 | 31 |
| `fever_false:8d02bd9e` | `fever_false` | false | 31 | 31 | 20 | 8 | 0 | 31 |
| `fever_false:d5ed3ff1` | `fever_false` | false | 31 | 31 | 17 | 10 | 0 | 31 |
| `fever_false:de0596c4` | `fever_false` | false | 31 | 31 | 16 | 11 | 4 | 27 |
| `fever_false:e2aff3b8` | `fever_false` | false | 31 | 31 | 9 | 3 | 2 | 29 |
| `fever_false:f586e96d` | `fever_false` | false | 31 | 31 | 13 | 18 | 0 | 31 |
| `fever_false:56a45ff1` | `fever_false` | false | 30 | 30 | 4 | 7 | 0 | 30 |
| `fever_false:5c2a065d` | `fever_false` | false | 30 | 30 | 30 | 6 | 30 | 24 |
| `fever_false:c747066d` | `fever_false` | false | 30 | 30 | 4 | 2 | 0 | 30 |
| `fever_false:3a3043ff` | `fever_false` | false | 29 | 29 | 24 | 25 | 21 | 8 |
| `fever_false:463f8189` | `fever_false` | false | 29 | 29 | 1 | 8 | 0 | 29 |
| `fever_false:758d5434` | `fever_false` | false | 29 | 29 | 0 | 0 | 0 | 29 |
| `fever_false:7b64d17a` | `fever_false` | false | 29 | 29 | 21 | 8 | 0 | 29 |
| `fever_false:a4cda1e2` | `fever_false` | false | 29 | 29 | 3 | 0 | 0 | 29 |
| `fever_true:18173593` | `fever_true` | true | 29 | 29 | 17 | 22 | 0 | 29 |
| `fever_true:f3ee0d07` | `fever_true` | true | 29 | 29 | 1 | 0 | 0 | 29 |
| `fever_false:44cd09fd` | `fever_false` | false | 28 | 28 | 28 | 8 | 10 | 20 |
| `fever_false:a6c0d44a` | `fever_false` | false | 28 | 28 | 10 | 0 | 0 | 28 |
| `fever_false:cbf9d7a5` | `fever_false` | false | 28 | 28 | 28 | 23 | 0 | 28 |
| `fever_false:147d5cf0` | `fever_false` | false | 27 | 27 | 11 | 1 | 0 | 27 |
| `fever_false:3de7ecac` | `fever_false` | false | 27 | 27 | 27 | 16 | 0 | 27 |
| `fever_false:43f5b35d` | `fever_false` | false | 27 | 27 | 8 | 0 | 0 | 27 |
| `fever_false:8599e318` | `fever_false` | false | 27 | 27 | 3 | 2 | 0 | 27 |
| `fever_false:e70e24b6` | `fever_false` | false | 27 | 27 | 9 | 21 | 1 | 26 |
| `fever_true:753c7815` | `fever_true` | true | 27 | 27 | 0 | 0 | 0 | 27 |
| `fever_false:033927e6` | `fever_false` | false | 26 | 26 | 26 | 24 | 0 | 26 |

*329 further fragments erred on at least one model; the JSON holds them all.*
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1587 | 109 | 783 | 2479 |
| **truth true** | 124 | 723 | 634 | 1481 |
| **truth null** | 177 | 80 | 5783 | 6040 |
| **total** | 1888 | 912 | 7200 | 10000 |

`null -> true`: 80 of 6040 truly-null examples (1.32%).
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 1888 | 84.1% | 64.0% | 72.7% |
| `true` | 1481 | 912 | 79.3% | 48.8% | 60.4% |
| `null` | 6040 | 7200 | 80.3% | 95.7% | 87.4% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 64.0% [57.1%, 70.7%] |
| null_ambiguous | 3062 | **224** | 92.1% [89.7%, 94.2%] |
| null_structural | 2978 | **1** | 99.5% [99.5%, 99.5%] |
| true | 1481 | **96** | 48.8% [40.5%, 57.4%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 93.4% [89.4%, 96.8%] |
| hedged | 828 | **63** | 88.9% [82.0%, 94.6%] |
| historical | 511 | **36** | 91.2% [85.9%, 95.5%] |
| metaphor | 641 | **47** | 96.3% [93.5%, 98.4%] |
| third_party | 508 | **35** | 91.7% [86.6%, 96.3%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 64.0% [57.1%, 70.7%] |
| fever_null_attribution | 574 | **43** | 93.4% [89.4%, 96.8%] |
| fever_null_hedged | 828 | **63** | 88.9% [82.0%, 94.6%] |
| fever_null_historical | 511 | **36** | 91.2% [85.9%, 95.5%] |
| fever_null_metaphor | 641 | **47** | 96.3% [93.5%, 98.4%] |
| fever_null_thirdparty | 508 | **35** | 91.7% [86.6%, 96.3%] |
| fever_true | 1481 | **96** | 48.8% [40.5%, 57.4%] |
...
233 of 463 decisive fragments were got wrong at least once.
...
| `fever_false:44cd09fd` | `fever_false` | -- | false | 0/28 | 0.0% | null 28 |
| `fever_false:cbf9d7a5` | `fever_false` | -- | false | 0/28 | 0.0% | true 1, null 27 |
| `fever_false:3de7ecac` | `fever_false` | -- | false | 0/27 | 0.0% | null 27 |
| `fever_false:033927e6` | `fever_false` | -- | false | 0/26 | 0.0% | null 26 |
...
| `fever_true:3d00c372` | `fever_true` | -- | true | 1/25 | 4.0% | true 1, null 24 |
| `fever_false:afdc7129` | `fever_false` | -- | false | 1/22 | 4.5% | false 1, null 21 |
| `fever_false:f6985a04` | `fever_false` | -- | false | 1/22 | 4.5% | false 1, true 6, null 15 |
| `fever_true:cbfe17b6` | `fever_true` | -- | true | 1/20 | 5.0% | true 1, null 19 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 1/19 | 5.3% | true 1, null 18 |
| `fever_false:6b3816ec` | `fever_false` | -- | false | 1/18 | 5.6% | false 1, null 17 |
| `fever_false:cdf2609b` | `fever_false` | -- | false | 2/32 | 6.2% | false 2, null 30 |
| `fever_true:054f1309` | `fever_true` | -- | true | 1/16 | 6.2% | true 1, null 15 |
...
*193 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 12 | 0 | 2467 | 2479 |
| **truth true** | 9 | 0 | 1472 | 1481 |
| **truth null** | 35 | 1 | 6004 | 6040 |
| **total** | 56 | 1 | 9943 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 56 | 21.4% | 0.5% | 0.9% |
| `true` | 1481 | 1 | 0.0% | 0.0% | 0.0% |
| `null` | 6040 | 9943 | 60.4% | 99.4% | 75.1% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 0.5% [0.1%, 1.0%] |
| null_ambiguous | 3062 | **224** | 99.4% [99.1%, 99.6%] |
...
| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 99.3% [98.4%, 100.0%] |
| hedged | 828 | **63** | 99.9% [99.6%, 100.0%] |
| historical | 511 | **36** | 99.0% [98.2%, 99.8%] |
| metaphor | 641 | **47** | 99.1% [98.3%, 99.7%] |
| third_party | 508 | **35** | 99.4% [98.7%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 0.5% [0.1%, 1.0%] |
| fever_null_attribution | 574 | **43** | 99.3% [98.4%, 100.0%] |
| fever_null_hedged | 828 | **63** | 99.9% [99.6%, 100.0%] |
| fever_null_historical | 511 | **36** | 99.0% [98.2%, 99.8%] |
| fever_null_metaphor | 641 | **47** | 99.1% [98.3%, 99.7%] |
| fever_null_thirdparty | 508 | **35** | 99.4% [98.7%, 100.0%] |
| fever_true | 1481 | **96** | 0.0% [0.0%, 0.0%] |
...
`tfidf_logreg__shuffled`: 3967 errors across 212 of 463 decisive fragments. Half of them fall on **71** fragments (an even spread would be 106.0); the worst ten carry 8.8% of all errors.
...
|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 1809 | 151 | 519 | 2479 |
| **truth true** | 129 | 773 | 579 | 1481 |
| **truth null** | 288 | 153 | 5599 | 6040 |
| **total** | 2226 | 1077 | 6697 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2226 | 81.3% | 73.0% | 76.9% |
| `true` | 1481 | 1077 | 71.8% | 52.2% | 60.4% |
| `null` | 6040 | 6697 | 83.6% | 92.7% | 87.9% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 73.0% [67.6%, 78.3%] |
| null_ambiguous | 3062 | **224** | 86.9% [84.4%, 89.3%] |
| null_structural | 2978 | **1** | 98.7% [98.7%, 98.7%] |
| true | 1481 | **96** | 52.2% [44.8%, 59.8%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 87.1% [81.1%, 92.5%] |
| hedged | 828 | **63** | 75.6% [69.2%, 81.6%] |
| historical | 511 | **36** | 87.5% [82.8%, 91.7%] |
| metaphor | 641 | **47** | 95.8% [93.3%, 97.9%] |
| third_party | 508 | **35** | 93.3% [90.0%, 96.5%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 73.0% [67.6%, 78.3%] |
| fever_null_attribution | 574 | **43** | 87.1% [81.1%, 92.5%] |
| fever_null_hedged | 828 | **63** | 75.6% [69.2%, 81.6%] |
| fever_null_historical | 511 | **36** | 87.5% [82.8%, 91.7%] |
| fever_null_metaphor | 641 | **47** | 95.8% [93.3%, 97.9%] |
| fever_null_thirdparty | 508 | **35** | 93.3% [90.0%, 96.5%] |
| fever_true | 1481 | **96** | 52.2% [44.8%, 59.8%] |
...
295 of 463 decisive fragments were got wrong at least once.
...
| `fever_true:f0038e34` | `fever_true` | -- | true | 0/21 | 0.0% | null 21 |
...
| `fever_true:872e3af9` | `fever_true` | -- | true | 0/12 | 0.0% | false 2, null 10 |
| `fever_true:ed36ef0f` | `fever_true` | -- | true | 0/12 | 0.0% | null 12 |
| `fever_null_hedged:17a3f60a` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | true 9 |
| `fever_true:15a05d92` | `fever_true` | -- | true | 1/24 | 4.2% | false 3, true 1, null 20 |
| `fever_true:c7489e90` | `fever_true` | -- | true | 1/19 | 5.3% | false 3, true 1, null 15 |
| `fever_true:391fb2ce` | `fever_true` | -- | true | 1/18 | 5.6% | false 3, true 1, null 14 |
| `fever_true:a92fcdc7` | `fever_true` | -- | true | 1/17 | 5.9% | true 1, null 16 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 1/14 | 7.1% | false 3, true 1, null 10 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 1/14 | 7.1% | true 1, null 13 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 1/14 | 7.1% | true 1, null 13 |
| `fever_false:033927e6` | `fever_false` | -- | false | 2/26 | 7.7% | false 2, null 24 |
| `fever_true:f885b3cb` | `fever_true` | -- | true | 1/13 | 7.7% | true 1, null 12 |
...
| `fever_false:a5b671a1` | `fever_false` | -- | false | 4/32 | 12.5% | false 4, true 28 |
| `fever_true:0ddb8a11` | `fever_true` | -- | true | 2/15 | 13.3% | false 1, true 2, null 12 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 4/29 | 13.8% | false 4, true 9, null 16 |
| `fever_false:e0897296` | `fever_false` | -- | false | 3/21 | 14.3% | false 3, true 1, null 17 |
...
| `fever_true:dd6bbec4` | `fever_true` | -- | true | 4/24 | 16.7% | false 5, true 4, null 15 |
| `fever_true:c3a107bf` | `fever_true` | -- | true | 1/6 | 16.7% | true 1, null 5 |
| `fever_false:0cc191ec` | `fever_false` | -- | false | 4/23 | 17.4% | false 4, true 2, null 17 |
| `fever_false:cbf9d7a5` | `fever_false` | -- | false | 5/28 | 17.9% | false 5, true 19, null 4 |
| `fever_false:afdc7129` | `fever_false` | -- | false | 4/22 | 18.2% | false 4, null 18 |
| `fever_true:781b30e3` | `fever_true` | -- | true | 2/11 | 18.2% | true 2, null 9 |
| `fever_true:01833454` | `fever_true` | -- | true | 3/16 | 18.8% | false 12, true 3, null 1 |
...
| `fever_false:e70e24b6` | `fever_false` | -- | false | 6/27 | 22.2% | false 6, true 17, null 4 |
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 2/9 | 22.2% | false 2, true 5, null 2 |
| `fever_null_attribution:d906783e` | `fever_null_attribution` | attribution | null | 3/13 | 23.1% | false 7, true 3, null 3 |
| `fever_true:65e4286c` | `fever_true` | -- | true | 4/17 | 23.5% | false 1, true 4, null 12 |
| `fever_true:18173593` | `fever_true` | -- | true | 7/29 | 24.1% | false 7, true 7, null 15 |

*255 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
Decision-rule margins selected per fold (on each fold's own validation split): 0.1, 0.2, 0.25, 0.75, 0.9.

*Confusion matrix, raw argmax*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2337 | 71 | 71 | 2479 |
| **truth true** | 5 | 1348 | 128 | 1481 |
| **truth null** | 60 | 202 | 5778 | 6040 |
| **total** | 2402 | 1621 | 5977 | 10000 |

`null -> true`: 202 of 6040 truly-null examples (3.34%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2346 | 62 | 71 | 2479 |
| **truth true** | 7 | 1332 | 142 | 1481 |
| **truth null** | 62 | 184 | 5794 | 6040 |
| **total** | 2415 | 1578 | 6007 | 10000 |
...
| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2415 | 97.1% | 94.6% | 95.9% |
| `true` | 1481 | 1578 | 84.4% | 89.9% | 87.1% |
| `null` | 6040 | 6007 | 96.5% | 95.9% | 96.2% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 94.6% [90.8%, 97.8%] |
| null_ambiguous | 3062 | **224** | 92.7% [89.5%, 95.5%] |
| null_structural | 2978 | **1** | 99.2% [99.2%, 99.2%] |
| true | 1481 | **96** | 89.9% [84.7%, 94.7%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 92.5% [86.7%, 97.3%] |
| hedged | 828 | **63** | 83.2% [73.6%, 91.8%] |
| historical | 511 | **36** | 95.9% [91.5%, 99.0%] |
| metaphor | 641 | **47** | 98.1% [96.0%, 99.7%] |
| third_party | 508 | **35** | 98.4% [96.6%, 99.8%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 94.6% [90.8%, 97.8%] |
| fever_null_attribution | 574 | **43** | 92.5% [86.7%, 97.3%] |
| fever_null_hedged | 828 | **63** | 83.2% [73.6%, 91.8%] |
| fever_null_historical | 511 | **36** | 95.9% [91.5%, 99.0%] |
| fever_null_metaphor | 641 | **47** | 98.1% [96.0%, 99.7%] |
| fever_null_thirdparty | 508 | **35** | 98.4% [96.6%, 99.8%] |
| fever_true | 1481 | **96** | 89.9% [84.7%, 94.7%] |
...
95 of 463 decisive fragments were got wrong at least once.

`arm_b_finetune`: 505 errors across 95 of 463 decisive fragments. Half of them fall on **16** fragments (an even spread would be 47.5); the worst ten carry 35.8% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/30 | 0.0% | true 24, null 6 |
| `fever_null_hedged:0de4380d` | `fever_null_hedged` | hedged | null | 0/20 | 0.0% | true 20 |
| `fever_true:7844c66b` | `fever_true` | -- | true | 0/18 | 0.0% | null 18 |
| `fever_true:0ddb8a11` | `fever_true` | -- | true | 0/15 | 0.0% | null 15 |
...
| `fever_null_hedged:42486de4` | `fever_null_hedged` | hedged | null | 0/11 | 0.0% | false 3, true 8 |
...
| `fever_null_hedged:965c4a64` | `fever_null_hedged` | hedged | null | 0/9 | 0.0% | false 5, true 4 |
...
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 1/13 | 7.7% | true 12, null 1 |
...
| `fever_null_hedged:081a5883` | `fever_null_hedged` | hedged | null | 2/16 | 12.5% | false 14, null 2 |
| `fever_false:afdc7129` | `fever_false` | -- | false | 4/22 | 18.2% | false 4, null 18 |
| `fever_false:e8c514ff` | `fever_false` | -- | false | 3/16 | 18.8% | false 3, true 13 |
| `fever_null_historical:1b314733` | `fever_null_historical` | historical | null | 2/8 | 25.0% | true 6, null 2 |
| `fever_false:3a3043ff` | `fever_false` | -- | false | 8/29 | 27.6% | false 8, true 21 |
| `fever_true:74ccf7bd` | `fever_true` | -- | true | 4/12 | 33.3% | true 4, null 8 |
| `fever_null_attribution:b03cf8b0` | `fever_null_attribution` | attribution | null | 4/11 | 36.4% | true 7, null 4 |
| `fever_null_attribution:dba8c443` | `fever_null_attribution` | attribution | null | 4/11 | 36.4% | false 7, null 4 |
| `fever_null_attribution:4f8cb0ab` | `fever_null_attribution` | attribution | null | 4/10 | 40.0% | true 6, null 4 |
| `fever_true:dd7a11e2` | `fever_true` | -- | true | 4/10 | 40.0% | true 4, null 6 |
| `fever_null_hedged:edb9b1eb` | `fever_null_hedged` | hedged | null | 5/12 | 41.7% | true 7, null 5 |
| `fever_false:93390aea` | `fever_false` | -- | false | 12/26 | 46.2% | false 12, null 14 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 5/10 | 50.0% | true 5, null 5 |
| `fever_null_hedged:60bffa1a` | `fever_null_hedged` | hedged | null | 4/8 | 50.0% | true 4, null 4 |
| `fever_true:b950a4fc` | `fever_true` | -- | true | 6/11 | 54.5% | true 6, null 5 |
| `fever_true:d00c307b` | `fever_true` | -- | true | 8/14 | 57.1% | true 8, null 6 |
| `fever_true:ed3c8c83` | `fever_true` | -- | true | 11/19 | 57.9% | false 1, true 11, null 7 |
| `fever_null_hedged:9e333f46` | `fever_null_hedged` | hedged | null | 6/10 | 60.0% | false 3, true 1, null 6 |
| `fever_null_metaphor:8b02c60b` | `fever_null_metaphor` | metaphor | null | 8/13 | 61.5% | true 5, null 8 |
| `fever_false:44cd09fd` | `fever_false` | -- | false | 18/28 | 64.3% | false 18, null 10 |
| `fever_null_hedged:18ebc3eb` | `fever_null_hedged` | hedged | null | 9/14 | 64.3% | true 5, null 9 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 9/14 | 64.3% | true 9, null 5 |
| `fever_true:ed36ef0f` | `fever_true` | -- | true | 8/12 | 66.7% | true 8, null 4 |
| `fever_true:5ce7adbd` | `fever_true` | -- | true | 6/9 | 66.7% | true 6, null 3 |
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 81.6% | 81.6% | 76.2% | 0.66% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 77.8% | 77.8% | 68.8% | 0.50% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 79.3% | 79.3% | 69.7% | 2.40% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 81.0% | 81.0% | 74.5% | 1.81% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 85.0% | 85.0% | 77.5% | 1.24% |
...
| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 60.2% | 60.2% | 25.9% | 0.00% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 60.0% | 60.0% | 25.1% | 0.08% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 60.4% | 60.4% | 25.3% | 0.00% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 60.6% | 60.6% | 25.4% | 0.00% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 59.7% | 59.7% | 25.0% | 0.00% |

### `arm_a_probe`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.0 | 84.1% | 84.1% | 78.2% | 1.16% |
| 1 | 10000 | 2000 | 2000 | 0.0 | 78.3% | 78.3% | 69.5% | 1.66% |
| 2 | 10000 | 2000 | 2000 | 0.0 | 81.2% | 81.2% | 74.2% | 3.56% |
| 3 | 10000 | 2000 | 2000 | 0.0 | 81.2% | 81.2% | 75.3% | 3.79% |
| 4 | 10000 | 2000 | 2000 | 0.0 | 84.1% | 84.1% | 78.2% | 2.49% |

### `arm_b_finetune`

| fold | train n | val n | test n | margin | acc (raw) | acc (ruled) | macro-F1 | null->true |
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.2 | 96.9% | 96.8% | 96.4% | 0.50% |
| 1 | 10000 | 2000 | 2000 | 0.1 | 94.1% | 94.1% | 91.7% | 2.08% |
| 2 | 10000 | 2000 | 2000 | 0.9 | 90.6% | 91.0% | 88.3% | 4.30% |
| 3 | 10000 | 2000 | 2000 | 0.75 | 95.8% | 95.9% | 94.2% | 2.96% |
| 4 | 10000 | 2000 | 2000 | 0.25 | 95.7% | 95.9% | 94.7% | 5.39% |
