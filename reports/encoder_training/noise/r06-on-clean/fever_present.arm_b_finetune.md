...
*Generated 2026-08-31T08:26:08+00:00.*
...
| test dataset dir | `data/synthetic/generated/noise/fever-clean` |
...
| artefacts | `models/encoder-noise/r06-on-clean/fever_present/arm_b_finetune` |
...
|---|---|---|---|---|---|---|---|
| `arm_b_finetune` | finetune | 7022 | **418** | 93.8% [91.7%, 95.7%] | 93.1% [90.8%, 95.2%] | 95.5% | 95.5% +/- 2.2% |
...
|---|---|---|---|---|---|---|
| `arm_b_finetune` | -- | 94.3% [88.9%, 98.6%] (eff n 43) | 84.1% [74.4%, 92.8%] (eff n 63) | 96.1% [91.4%, 99.4%] (eff n 36) | 99.2% [97.8%, 100.0%] (eff n 47) | 99.2% [97.9%, 100.0%] (eff n 35) |
...
Recombination test slice: **n 7022**, **eff n 418** clusters, accuracy 93.8% [91.7%, 95.7%]. Holdout: **n 67** submissions, one observation each, scored by 5 fold models at margins 0.2, 0.1, 0.9, 0.75, 0.25. The two `n`s are printed together because they are not the same kind of number and the second is far the smaller.
...
|---|---|---|---|---|
| `arm_b_finetune` | finetune | 3062 | **224** | 93.7% [90.5%, 96.4%] |
...
* `arm_b_finetune`: 437 errors across 61 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 30.5); the worst ten carry 42.6% of all errors.
...
|---|---|---|---|---|
| **truth false** | 2355 | 69 | 55 | 2479 |
| **truth true** | 6 | 1374 | 101 | 1481 |
| **truth null** | 40 | 191 | 5809 | 6040 |
| **total** | 2401 | 1634 | 5965 | 10000 |

`null -> true`: 191 of 6040 truly-null examples (3.16%).

*Confusion matrix, after the decision rule*

|  | pred false | pred true | pred null | total |
|---|---|---|---|---|
| **truth false** | 2366 | 57 | 56 | 2479 |
| **truth true** | 7 | 1351 | 123 | 1481 |
| **truth null** | 42 | 170 | 5828 | 6040 |
| **total** | 2415 | 1578 | 6007 | 10000 |

`null -> true`: 170 of 6040 truly-null examples (2.81%).

### Per class, after the decision rule

| class | support | predicted | precision | recall | F1 |
|---|---|---|---|---|---|
| `false` | 2479 | 2415 | 98.0% | 95.4% | 96.7% |
| `true` | 1481 | 1578 | 85.6% | 91.2% | 88.3% |
| `null` | 6040 | 6007 | 97.0% | 96.5% | 96.8% |

### By label mode

| label mode | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| false | 2479 | **98** | 95.4% [91.4%, 98.7%] |
| null_ambiguous | 3062 | **224** | 93.7% [90.5%, 96.4%] |
| null_structural | 2978 | **1** | 99.4% [99.4%, 99.4%] |
| true | 1481 | **96** | 91.2% [86.2%, 95.6%] |

### By null sub-class

| sub-class | n | eff n | null recall [95% CI] |
|---|---|---|---|
| attribution | 574 | **43** | 94.3% [88.9%, 98.6%] |
| hedged | 828 | **63** | 84.1% [74.4%, 92.8%] |
| historical | 511 | **36** | 96.1% [91.4%, 99.4%] |
| metaphor | 641 | **47** | 99.2% [97.8%, 100.0%] |
| third_party | 508 | **35** | 99.2% [97.9%, 100.0%] |

### By fragment library

| library | n | eff n | accuracy [95% CI] |
|---|---|---|---|
| fever_false | 2479 | **98** | 95.4% [91.4%, 98.7%] |
| fever_null_attribution | 574 | **43** | 94.3% [88.9%, 98.6%] |
| fever_null_hedged | 828 | **63** | 84.1% [74.4%, 92.8%] |
| fever_null_historical | 511 | **36** | 96.1% [91.4%, 99.4%] |
| fever_null_metaphor | 641 | **47** | 99.2% [97.8%, 100.0%] |
| fever_null_thirdparty | 508 | **35** | 99.2% [97.9%, 100.0%] |
| fever_true | 1481 | **96** | 91.2% [86.2%, 95.6%] |
...
61 of 463 decisive fragments were got wrong at least once.

`arm_b_finetune`: 437 errors across 61 of 463 decisive fragments. Half of them fall on **13** fragments (an even spread would be 30.5); the worst ten carry 42.6% of all errors.

| fragment | library | sub-class | truth | correct | accuracy | predicted as |
|---|---|---|---|---|---|---|
| `fever_false:5c2a065d` | `fever_false` | -- | false | 0/30 | 0.0% | true 23, null 7 |
...
| `fever_null_attribution:4f8cb0ab` | `fever_null_attribution` | attribution | null | 0/10 | 0.0% | true 10 |
...
| `fever_false:e8c514ff` | `fever_false` | -- | false | 1/16 | 6.2% | false 1, true 15 |
| `fever_true:97087dd7` | `fever_true` | -- | true | 1/14 | 7.1% | true 1, null 13 |
| `fever_null_historical:1b314733` | `fever_null_historical` | historical | null | 1/8 | 12.5% | true 7, null 1 |
...
| `fever_false:3a3043ff` | `fever_false` | -- | false | 11/29 | 37.9% | false 11, true 18 |
| `fever_null_attribution:17b7ab2a` | `fever_null_attribution` | attribution | null | 5/13 | 38.5% | true 8, null 5 |
| `fever_true:5e4f1da7` | `fever_true` | -- | true | 4/10 | 40.0% | true 4, null 6 |
...
| `fever_true:01833454` | `fever_true` | -- | true | 8/16 | 50.0% | false 7, true 8, null 1 |
...
| `fever_false:44cd09fd` | `fever_false` | -- | false | 16/28 | 57.1% | false 16, null 12 |
| `fever_null_hedged:60bffa1a` | `fever_null_hedged` | hedged | null | 5/8 | 62.5% | true 3, null 5 |
| `fever_null_metaphor:8b02c60b` | `fever_null_metaphor` | metaphor | null | 9/13 | 69.2% | true 4, null 9 |
| `fever_null_hedged:9e333f46` | `fever_null_hedged` | hedged | null | 7/10 | 70.0% | false 2, true 1, null 7 |
| `fever_null_hedged:18ebc3eb` | `fever_null_hedged` | hedged | null | 10/14 | 71.4% | true 4, null 10 |
| `fever_true:dd079c14` | `fever_true` | -- | true | 10/14 | 71.4% | true 10, null 4 |
| `fever_true:ed36ef0f` | `fever_true` | -- | true | 9/12 | 75.0% | true 9, null 3 |
| `fever_null_hedged:771b9894` | `fever_null_hedged` | hedged | null | 6/8 | 75.0% | false 2, null 6 |
| `fever_true:5ce7adbd` | `fever_true` | -- | true | 7/9 | 77.8% | true 7, null 2 |

*21 further fragments with at least one error are in the JSON sidecar; every fragment is there regardless of score.*
...
|---|---|---|---|---|---|---|---|---|
| 0 | 10000 | 2000 | 2000 | 0.2 | 97.4% | 97.2% | 97.0% | 0.66% |
| 1 | 10000 | 2000 | 2000 | 0.1 | 94.5% | 94.5% | 92.2% | 2.25% |
| 2 | 10000 | 2000 | 2000 | 0.9 | 91.6% | 92.0% | 89.7% | 3.81% |
| 3 | 10000 | 2000 | 2000 | 0.75 | 96.9% | 96.8% | 95.4% | 2.47% |
| 4 | 10000 | 2000 | 2000 | 0.25 | 96.5% | 96.7% | 95.4% | 4.89% |
